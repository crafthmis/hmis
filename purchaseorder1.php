...
$query91 = "select count(auto_number) as masterscount from settings_purchaseorder where companyanum = '$companyanum'";
...
if ($res91count == 0)
{
	header ("location:settingspurchaseorder1.php?svccount=firstentry");
	exit;
}
...
$query88 = "select count(auto_number) as cntanum from master_purchaseorder where lastupdate like '$thismonth%'";
...
if ($frm1submit1 == 'frm1submit1')
{
	...
	{
		$query19 = "select auto_number,lastupdate from master_purchaseorder where auto_number = '$delbillautonumber' and billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'DELETED'";
		...
		while ($res19 = mysql_fetch_array($exec19))
		{
			...
			$query15 = "update master_purchaseorder set recordstatus = 'DELETED' where auto_number = '$res19anum' and companyanum = '$companyanum'";
			$exec15 = mysql_query($query15) or die ("Error in Query15".mysql_error());
		
			$query16 = "update purchaseorder_details set recordstatus = 'DELETED' where bill_autonumber = '$res19anum' and companyanum = '$companyanum'";
			$exec16 = mysql_query($query16) or die ("Error in Query16".mysql_error());
		
			$query17 = "update purchaseorder_tax set recordstatus = 'DELETED' where bill_autonumber = '$res19anum' and companyanum = '$companyanum'";
			...
			//$query20="update master_stock set recordstatus='DELETED' where transactionmodule = 'PURCHASEORDER' and billnumber = '$delbillnumber' and companyanum = '$companyanum'";
...
include ("purchaseorder1include1.php"); //handles all the purchaseorder insert operations
...
<script type="text/javascript" src="js/purchaseordernovalidation1.js"></script>
...
function loadprintpage1(varPaperSizeCatch)
{
	...
	var varPrintHeader = "PURCHASE ORDER";
...
function funcDefaultTax1() //Function to CST Taxes if required.
{
	...
	if (varDefaultTax != "")
	{
		...
		{
		?>
		window.location="purchaseorder1.php?defaulttax="+varDefaultTax+"&&delbillst=<?php echo $delBillSt; ?>&&delbillautonumber="+<?php echo $delBillAutonumber; ?>+"&&delbillnumber="+<?php echo $delBillNumber; ?>+"";
		<?php
		}
		else
		{
		?>
		window.location="purchaseorder1.php?defaulttax="+varDefaultTax+"";
		<?php
		}
		?>
	}
	...
	{
		window.location="purchaseorder1.php";
	}
	//return false;
...
<form name="frmpurchaseorder" id="frmpurchaseorder" method="post" action="purchaseorder1.php" onKeyDown="return disableEnterKey(event)">
    ...
    <td width="99%" valign="top"><table width="950" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="100%"><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
                <td bgcolor="#CCCCCC" class="bodytext3"><strong>Purchase Order Bill   </strong></td>
			  ...
			  <tr>
				...
				<input name="supplier" id="supplier" value="<?php echo $res41suppliername; ?>" style="border: 1px solid #001E6A; text-transform:uppercase" size="40" autocomplete="off"/>
		...
		<table id="newtable" style="BORDER-COLLAPSE: collapse" 
            ...
            <tbody id="tblrowinsert">
              <tr>
				...
				include ('purchaseorder_edit1listing1.php');
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
            ...
            <tr>
			  ...
			  <input onKeyDown="return itemcodekeypress1(event)" name="itemcode" id="itemcode" style="border: 1px solid #001E6A; text-align:left;text-transform: uppercase;" value="" size="10" /></td>
			  ...
			  <input type="button" name="itemsearch2" onClick="javascript:itemsearch1('purchase')" value="Alt+S" accesskey="s" style="border: 1px solid #001E6A"></td>
              <td width="6%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
			  <input onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemmrp" value="0.00" id="itemmrp" style="border: 1px solid #001E6A; text-align:right" size="6" /></td>
              <td width="4%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
			  <input onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemquantity" value="1" id="itemquantity" style="border: 1px solid #001E6A; text-align:right" size="4" /></td>
              <td width="6%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
			  <input onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemdiscountpercent" value="0.00" id="itemdiscountpercent" style="border: 1px solid #001E6A; text-align:right" size="2" /></td>
              <td width="6%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
			  <input onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemdiscountrupees" value="0.00" id="itemdiscountrupees" style="border: 1px solid #001E6A; text-align:right" size="3" /></td>
              ...
              <td width="6%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
			  <input name="itemtotalamount" value="0.00" id="itemtotalamount" onBlur="return funcTaxReverseCalc1()" style="border: 1px solid #001E6A; text-align:right" size="8" /></td>
              ...
              <td width="18%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><span class="bodytext311">
                <input name="itemreversetax" value="0.00" id="itemreversetax" onFocus="javascript:this.select()" onBlur="return funcTaxReverseCalc2()" style="border: 1px solid #001E6A; text-align:right" size="8" />
              </span></td>
            </tr>
            <tr>
...
-->
                ...
                bgcolor="#F3F3F3" class="bodytext31"><span class="bodytext311">
                    ...
                    <td width="35%"><span class="bodytext312">
...
bgcolor="#F3F3F3" class="bodytext31">&nbsp;</td>
				...
				<select name="billtype" id="billtype" onChange="return paymentinfo1PO()">
              ...
              <tr>
                ...
                bgcolor="#CCCCCC" class="bodytext31"><div align="right"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
                  ...
                  <input name="delbillnumber" id="delbillnumber" type="hidden" value="<?php echo $delbillnumber;?>">
					<input name="pageidentificationcontrol" id="pageidentificationcontrol" type="hidden" value="purchaseorderentry">
            ...
            <tr>
              ...
              <td width="46%" align="left" valign="top" ><div align="right"><span class="bodytext31">
                ...
                <input name="print4inch2" type="button" class="button" id="print4inch2" style="border: 1px solid #001E6A" 
				  onClick="return quickprintbill1purchaseorder()" value="Print 40" accesskey="p"/>
				  ...
				  onClick="return quickprintbill2purchaseorder()" value="View 40" accesskey="p"/>

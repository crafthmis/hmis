...
$query88 = "select count(auto_number) as cntanum from master_dcsupplier where lastupdate like '$thismonth%'";
...
if ($frm1submit1 == 'frm1submit1')
{
	...
	{
		$query19 = "select auto_number,lastupdate from master_dcsupplier where auto_number = '$delbillautonumber' and billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'DELETED'";
		...
		while ($res19 = mysql_fetch_array($exec19))
		{
			...
			$query15 = "update master_dcsupplier set recordstatus = 'DELETED' where auto_number = '$res19anum' and companyanum = '$companyanum'";
			$exec15 = mysql_query($query15) or die ("Error in Query15".mysql_error());
		
			$query16 = "update dcsupplier_details set recordstatus = 'DELETED' where bill_autonumber = '$res19anum' and companyanum = '$companyanum'";
			$exec16 = mysql_query($query16) or die ("Error in Query16".mysql_error());
		
			$query17 = "update dcsupplier_tax set recordstatus = 'DELETED' where bill_autonumber = '$res19anum' and companyanum = '$companyanum'";
...
include ("deliverychallansupplier1include1.php"); //handles all the purchase insert operations
...
{
	$query41 = "select * from master_dcsupplier where billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'deleted'";
...
<script type="text/javascript" src="js/dcsuppliernovalidation1.js"></script>
...
<form name="frmpurchase" id="frmpurchase" method="post" action="deliverychallansupplier1.php" onKeyDown="return disableEnterKey(event)">
    ...
    <td width="99%" valign="top"><table width="950" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="100%"><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
                <td bgcolor="#CCCCCC" class="bodytext3"><strong>DC Supplier  </strong></td>
                ...
                <td width="12%" bgcolor="#CCCCCC" class="bodytext3">
		...
		<table id="newtable" style="BORDER-COLLAPSE: collapse" 
            ...
            <tbody id="tblrowinsert">
              <tr>
				...
				include ('deliverychallansupplier_edit1listing1.php');
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
            ...
            <tr>
              ...
              <input type="hidden" onKeyDown="return itemquantitykeypress1()" onBlur="return itemtotalamountupdate1()" name="itemtaxpercent" value="0.00" id="itemtaxpercent" readonly="readonly" style="border: 1px solid #001E6A; text-align:right" size="2" />
...
bgcolor="#F3F3F3" class="bodytext31">&nbsp;</td>
                ...
                <td align="left" valign="middle" ><select name="billtype" id="billtype" onChange="return paymentinfo()">
                  <option value="">SELECT DC TYPE</option>
                  <option value="DC">DC SUPPLIER</option>
            ...
            <tr>
              ...
              <td width="46%" align="left" valign="top" ><div align="right"><span class="bodytext31">
                ...
                <!--<input name="print4inch2" type="button" class="button" id="print4inch2" style="border: 1px solid #001E6A" 
				  onClick="return quickprintbill1dcsupplier()" value="Print 40" accesskey="p"/>-->
				  ...
				  onClick="return quickprintbill2dcsupplier()" value="View 40" accesskey="p"/>-->

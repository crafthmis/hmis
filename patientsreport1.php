    ...
    <td width="99%" valign="top"><table width="1700" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="822" 
            align="left" border="1">
          <tbody>
            <tr>
			...
			$query2 = "select * from master_patient where dateposted between '$quotedatefrom' and '$quotedateto'  order by dateposted desc";
			$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
			while ($res2 = mysql_fetch_array($exec2))
			{
			$patientcode=$res2['patientcode'];
			$customername = $res2['patientname'];
			$city = $res2['city'];
			...
			//$billnumber1 = $res2['billnumberprefix'];
			//$billnumber2 = $res2['billnumber'];
			//$billnumber3 = $res2['billnumber'];
			///if ($billnumber1 != '') $billnumber2 = $billnumber1.'-'.$billnumber2;
			//$billdate = $res2['updatedate'];
           ...
           <tr <? echo $colorcode; ?>>
			  ...
			  <!--<td class="bodytext31" valign="center" bordercolor="#f3f3f3" align="left">
			  <a href="pdfdump/bill_pdfexport1.php?billautonumber=<? echo $res2anum; ?>&&companyanum=<? echo $companyanum; ?>&&randomnumbervar=<? echo rand(5, 1000000); ?>"><span class="bodytext3">PDF</span></a></td>
              <td class="bodytext31" valign="center" bordercolor="#f3f3f3" align="left">
			  <a href="javascript:loadpdfpage1(<? echo $res2anum; ?>)"><span class="bodytext3">Email</span></a></td>-->
			...
			?></div></td>
              ...
              <td class="bodytext31" valign="center" bordercolor="#f3f3f3" align="left">
			  <? echo $date1; ?></td>
			   <td width="15%" bordercolor="#f3f3f3" class="bodytext31"><a href="editpatient1.php?patientcode=<? echo $patientcode;?>"><font color="#000000">Edit</font></a></td>
            </tr>
			<?
			}
			?>

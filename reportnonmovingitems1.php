    ...
    <td valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
			...
			<form name="stockinward" action="reportnonmovingitems1.php" method="post" onKeyDown="return disableEnterKey()">
	<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="800" 
            align="left" border="0">
      <tbody id="foo">
        <tr>
          <td colspan="5" bgcolor="#cccccc" class="bodytext31"><strong>Stock - Report By Non Moving Items</strong></td>
          </tr>
        <tr>
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
			...
			$query2 = "select * from master_itempharmacy where itemcode like '%$itemcode%' and categoryname like '%$categoryname%' and status <> 'DELETED'";// limit 0, 300";// and companyanum = '$companyanum'";// and cstid='$custid' and cstname='$custname'";
			...
			$query3 = "select sum(quantity) as sumquantity from pharmacysales_details where itemcode = '$itemcode' and recordstatus <> 'DELETED' and companyanum = '$companyanum'";
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td  align="left" valign="center" class="bodytext31"><div class="bodytext31">
			   ...
			   <td  align="left" valign="center" class="bodytext31"><div class="bodytext31">
                  <div align="left"><?php echo $res3sumquantity ; ?>&nbsp;</div>
              </div></td>
              <td class="bodytext31" valign="center"  align="left">

          ...
          <tbody>
            ...
            <tr>
              ...
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31">&nbsp;</td>
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Pack X Unit </strong></div></td>
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="right"></div></td>
              <!--<td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31">&nbsp;</td>
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31">&nbsp;</td>-->
            ...
            <tr>
              ...
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>CurrentStock </strong></div></td>
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Batch No. </strong></div></td>
              <!--<td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Batch Stock </strong></div></td>
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Expiry Dt. </strong></div></td>-->
              <td align="left" valign="center"  
			...
			$query2 = "select * from master_itempharmacy where itemcode like '%$itemcode%' and categoryname like '%$categoryname%' and status <> 'DELETED' ";//limit 0,100";// and companyanum = '$companyanum'";// and cstid='$custid' and cstname='$custname'";
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td  align="left" valign="center" class="bodytext31"><div class="bodytext31">
                  <div align="left"><?php echo $res2packagename; ?>&nbsp;</div>
              </div></td>
              <td class="bodytext31" valign="center"  align="left">
              ...
              <td class="bodytext31" valign="center"  align="left">
			  <div class="bodytext31">
			    <div align="right"><?php echo $res1batchnumber; // $itemrate; ?>&nbsp;</div>
			  </div></td>
             <!-- <td  align="left" valign="center" class="bodytext31"><div class="bodytext31">
                  <div align="right">
                    <?php //echo ; //$totalitemrate; ?>
                    &nbsp;</div>
              </div></td>
			 
              <td class="bodytext31" valign="center"  align="left">
			  <div class="bodytext31">
			    <div align="right"><?php //echo $res1expirydate; //$totalitemrate; ?>&nbsp;</div>
			  </div></td>-->
              <td class="bodytext31" valign="center"  align="left"><div class="bodytext31">
			...
			<tr>
               ...
               <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#FFFFFF">&nbsp;</td>
               <td colspan="19"  align="left" valign="center" 
                bgcolor="#FFFFFF" class="bodytext31">
				 <table width="559" style="BORDER-COLLAPSE: collapse" bordercolor="#FFFFFF">
				<tr> 
				<td width="235"  align="left" valign="center" 
                bgcolor="#CCCCCC" class="bodytext31"><div align="left"><strong>Item Name</strong></div></td>
				<td width="182"  align="left" valign="center" 
                bgcolor="#CCCCCC" class="bodytext31"><div align="left"><strong>Batch Number</strong></div></td>
				<td width="182"  align="left" valign="center" 
                bgcolor="#CCCCCC" class="bodytext31"><div align="left"><strong>Batch Stock</strong></div></td>
				<td width="182"  align="left" valign="center" 
                bgcolor="#CCCCCC" class="bodytext31"><div align="left"><strong>Expiry Date</strong></div></td>
			  ...
			  <td class="bodytext31" valign="center"  align="left">
			    <div align="left"><?php  echo $batchnumber; ?></div></td>
				<td class="bodytext31" valign="center"  align="left">
			    <div align="left"><?php  echo $batchcurrentstock; ?></div></td>
				<td class="bodytext31" valign="center"  align="left">

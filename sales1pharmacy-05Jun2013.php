  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="980" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
                <td bgcolor="#CCCCCC" class="bodytext3"><strong>Pharmacy Invoice </strong></td>
	...
	//$delBillSt = $_REQUEST["delbillst"];
			  ...
			  <tr>
                ...
                <td align="left" valign="top" ><div align="left"><span class="style4">PT. Code</span></div></td>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
            ...
            <tr>
			  ...
			  <input onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemmrp" onFocus="javascript:this.select()" value="0.00" id="itemmrp" style="border: 1px solid #001E6A; text-align:right" size="4" /></td>
            ...
            <tr>
              <td colspan="2" rowspan="2" align="left" valign="center"  bgcolor="#FFFFFF" class="bodytext31"><div align="right"><strong>Description</strong></div></td>
              <td colspan="4" rowspan="2" align="left" valign="center"  bgcolor="#FFFFFF" class="bodytext31"><strong>
                <textarea name="itemdescription" cols="35" rows="2" id="itemdescription" style="border: 1px solid #001E6A; text-align:left"></textarea>
              </strong></td>

...
//	IMPORTANT : PLEASE CHANGE DESTINATION DATABASE NAME TO LIVE DATABASE NAME //
	...
	$destinationdbname = 'sudhahospital'; //CHANGE ONLY THIS TO LVE DB NAME.
	
	$sourcedbname = 'simaclehospitalcomparesource';
	
	$sourcedbfilepath = 'updates_download/simaclehospitalcomparesource.sql';
...
if ($submit == 'Yes. Proceed.')
{
	...
	//$comparisonsourcedatabasecontents = file_get_contents($sourcedbfilepath);

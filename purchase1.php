...
//include ("autocompletebuild_item1pharmacy.php"); //Intentionally disabled to avoid overwite of file.
//echo $pagename;
...
if ($frm1submit1 == 'frm1submit1')
{
	...
	{
		$query19 = "select auto_number,lastupdate from master_purchase where auto_number = '$delbillautonumber' and billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'DELETED'";
		...
		while ($res19 = mysql_fetch_array($exec19))
		{
			...
			$query15 = "update master_purchase set recordstatus = 'DELETED' where auto_number = '$res19anum' and companyanum = '$companyanum'";
			$exec15 = mysql_query($query15) or die ("Error in Query15".mysql_error());
		
			$query16 = "update purchase_details set recordstatus = 'DELETED' where bill_autonumber = '$res19anum' and companyanum = '$companyanum'";
			$exec16 = mysql_query($query16) or die ("Error in Query16".mysql_error());
		
			$query17 = "update purchase_tax set recordstatus = 'DELETED' where bill_autonumber = '$res19anum' and companyanum = '$companyanum'";
			...
			$query20="update master_stock set recordstatus='DELETED' where transactionmodule = 'PURCHASE' and billnumber = '$delbillnumber' and companyanum = '$companyanum'";
...
include ("purchase1include1.php"); //handles all the purchase insert operations
...

{
	...
	$query41 = "select * from master_purchase where billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'deleted'";
	...
	$res41suppdateonly = $res41['supplierbilldate'];
	$res41suppdateonly = substr($res41suppdateonly,0,10);
	$suppdateonly = $res41suppdateonly;
...
{
	$query41 = "select * from master_purchaserequest where billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'deleted'";
	$exec41 = mysql_query($query41) or die ("Error in Query41".mysql_error());
	$res41 = mysql_fetch_array($exec41);
	$res41suppliername = $res41['suppliername'];
	$res41suppliercode = $res41['suppliercode'];
...
{
	$query41 = "select * from master_purchaseorder where billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'deleted'";
	$exec41 = mysql_query($query41) or die ("Error in Query41".mysql_error());
	$res41 = mysql_fetch_array($exec41);
	$res41suppliername = $res41['suppliername'];
	$res41suppliercode = $res41['suppliercode'];
...
<?php include ("js/purchase1scripting1.php"); ?>
<?php include ("js/dropdownlist2scripting2.php"); ?>

<script type="text/javascript" src="js/purchaseinsertitem1.js"></script>
...
<script type="text/javascript" src="js/purchasenovalidation1.js"></script>
<script type="text/javascript" src="js/autocomplete_package1pharmacy1.js"></script>
<script type="text/javascript" src="js/autocomplete_manufacturer1pharmacy1.js"></script>
...
function loadprintpage1(varPaperSizeCatch)
{
	...
	var varPrintHeader = "PURCHASE RECEIPT";
...
function funcDefaultTax1() //Function to CST Taxes if required.
{
	...
	if (varDefaultTax != "")
	{
		...
		{
		?>
		window.location="purchase1.php?defaulttax="+varDefaultTax+"&&delbillst=<?php echo $delBillSt; ?>&&delbillautonumber="+<?php echo $delBillAutonumber; ?>+"&&delbillnumber="+<?php echo $delBillNumber; ?>+"";
		<?php
		}
		else
		{
		?>
		window.location="purchase1.php?defaulttax="+varDefaultTax+"";
		<?php
		}
		?>
	}
...
<form name="frmpurchase" id="frmpurchase" method="post" action="purchase1.php" onKeyDown="return disableEnterKey(event)">
    ...
    <td width="99%" valign="top"><table width="950" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="100%"><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td bgcolor="#CCCCCC" class="bodytext3"><strong>Purchase Bill </strong></td>
              ...
              <td bgcolor="#CCCCCC" class="bodytext3"><div align="right"><strong><!--Tax--></strong></div></td>
              <td colspan="3" bgcolor="#CCCCCC" class="bodytext3">
            ...
            <?php
			  ...
			  ?>
              <tr>
                <td colspan="8" align="left" valign="middle"  bgcolor="#FFFF00" class="bodytext3">
            ...
            <?php
			  ...
			  ?>
            <tr>
              <td colspan="8" align="left" valign="middle"  bgcolor="#FFFF00" class="bodytext3"> * WARNING : Please Note You Are Editing Bill No. <?php echo $delbillnumber; ?> . All The Data For This Bill Will Be Over Written Including Payments. You May Need To Re-Enter Again Everything For This Bill. </td>
            </tr>
            <?php
			  //include ("zprintdmp1test2.php"); 
			  }
			  ?>
            <tr>
              <td width="7%" align="left" valign="middle" class="bodytext3"><strong>Supplier  * </strong></td>
              <td width="36%" align="left" valign="top" >
			  <input name="supplier" id="supplier" value="<?php echo $res41suppliername; ?>" style="border: 1px solid #001E6A;" size="40" autocomplete="off"/>
                  <input type="button" name="suppliersearch" onClick="javascript:suppliersearch1('purchase')" value="Alt+M" accesskey="m" style="border: 1px solid #001E6A"></td>
              ...
              <td align="left" valign="top" ><span class="bodytext3">
                <input name="suppliercode" id="suppliercode" value="<?php echo $res41suppliercode; ?>" style="border: 1px solid #001E6A" readonly="readonly" size="10" rsize="20" />
              </span></td>
              <td width="8%" align="left" valign="middle" class="bodytext3"><strong>Supp Bill No</strong>&nbsp;</td>
              <td width="7%" align="left" valign="top" ><span class="bodytext3"><span class="style6"><span class="bodytext312"><a href="javascript:displayDatePicker('ADate1', false, 'ymd', '-');"></a></span></span></span><span class="bodytext311">
                  <input name="supplierbillnumber" id="supplierbillnumber" style="border: 1px solid #001E6A"  size="10" />
                  </span></td>
              <td width="10%" align="left" valign="middle" class="bodytext3" ><strong>Supp Bill Date </strong>&nbsp;</td>
             <td width="11%" ><span class="bodytext312">
                <input name="ADate2" id="ADate2" style="border: 1px solid #001E6A" value="<?php echo $suppdateonly; ?>"  size="8"  readonly="readonly" onKeyDown="return disableEnterKey()" />
		...
		<table id="newtable" style="BORDER-COLLAPSE: collapse" 
            ...
            <tbody id="tblrowinsert">
              <tr>
                ...
                bgcolor="#FFCC00" class="bodytext31"><strong>MFR</strong></td>
                ...
                <td width="3%" align="left" valign="center"  
                bgcolor="#FFCC00" class="bodytext31"><strong>Free</strong></td>
                <td width="5%" align="left" valign="center"  
                bgcolor="#FFCC00" class="bodytext31"><span class="bodytext311"><strong>TotalQty</strong></span></td>
                <td width="5%" align="left" valign="center"  
                bgcolor="#FFCC00" class="bodytext31"><strong>Batch</strong></td>
                <td width="5%" align="left" valign="center"  
                bgcolor="#FFCC00" class="bodytext31"><strong>Expiry</strong></td>
                <td width="5%" align="left" valign="center"  
                bgcolor="#FFCC00" class="bodytext31"><strong>Pack</strong></td>
                <td width="5%" align="left" valign="center"  
                ...
                <td width="7%" align="left" valign="center"  
                bgcolor="#FFCC00" class="bodytext31"><strong>MRP</strong></td>
                <td width="7%" align="left" valign="center"  
				...
				include ('purchase_edit1listing1.php');
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
            ...
            <tr>
              ...
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">&nbsp;</td>
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">&nbsp;</td>
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><strong>MFR</strong></td>
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><strong>Rate</strong></td>
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><strong>Qty</strong></td>
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><strong>Free</strong></td>
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><strong>TotalQty</strong></td>
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><strong>Batch</strong></td>
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><strong>Expiry</strong></td>
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><strong>Pack</strong></td>
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><strong>Total</strong></td>
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><span class="bodytext311"><strong>MRP</strong></span></td>
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">&nbsp;</td>
            </tr>
            <tr>
              <td width="2%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
			  <input type="hidden" name="dummy1" id="dummy1" style="border: 0px solid #001E6A; background-color:#66CC00; text-align:right" value="" size="1" readonly="readonly" />
              ...
              <td width="7%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
			  <input onKeyDown="return itemcodekeypress1(event)" name="itemcode" id="itemcode" style="border: 1px solid #001E6A; text-align:left;text-transform: uppercase;" value="" size="5" /></td>
              <td width="26%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
			  <input name="itemname" id="itemname" autocomplete="off" style="border: 1px solid #001E6A; text-align:left" value="" size="30" />
			  <span class="bodytext311"><strong>
			  <input name="itemdescription" type="hidden" id="itemdescription" style="border: 1px solid #001E6A; text-align:left" value="" size="35">
			  </strong></span></td>
              <td width="7%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
			  <!--<input type="button" name="itemsearch2" onClick="javascript:itemsearch1('purchase')" value="Alt+S" accesskey="s" style="border: 1px solid #001E6A">-->
			  	
				<select name="manufacturername" id="manufacturername" onFocus="return funcManufacturerPopulate1()" style="width:80px">
				  <option value="" selected="selected">MFR</option>
				</select>

			  </td>
              <td width="3%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
			  <input onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemmrp" value="0.00" id="itemmrp" style="border: 1px solid #001E6A; text-align:right" size="4" /></td>
              <td width="7%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
			  <input onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemquantity" value="1" id="itemquantity" style="border: 1px solid #001E6A; text-align:right" size="2" /></td>
              <td width="7%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><span class="bodytext311">
                <input name="itemfreequantity" id="itemfreequantity" style="border: 1px solid #001E6A; text-align:right" onBlur="return itemtotalamountupdate1()" onKeyDown="return itemquantitykeypress1(event)" value="0" size="1" />
              </span></td>
              <td width="7%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><span class="bodytext311">
                <input onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemtotalquantity" value="1" readonly="readonly" id="itemtotalquantity" style="border: 1px solid #001E6A; text-align:right" size="2" />
              </span></td>
              <td width="7%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
			    <span class="bodytext311"><strong>
			    <input name="batchnumber" id="batchnumber" onBlur="return itemtotalamountupdate1()" value="<?php //echo $batchnumber; ?>" style="border: 1px solid #001E6A;"  size="5" />
			    </strong></span>
			    <input type="hidden"s onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemdiscountpercent" value="0.00" id="itemdiscountpercent" style="border: 1px solid #001E6A; text-align:right" size="2" /></td>
              <td width="11%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
			  <input type="hidden" onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemdiscountrupees" value="0.00" id="itemdiscountrupees" style="border: 1px solid #001E6A; text-align:right" size="3" />
			  <span class="bodytext311"><strong>
			  <input name="expirydate" id="expirydate" value="<?php //echo date('m/y'); ////echo $batchnumber; ?>" onBlur="return itemtotalamountupdate1()" onFocus="javascript:select(this);" style="border: 1px solid #001E6A"  size="3" />
			  <strong><span class="bodytext312"><!--<img src="images2/cal.gif" onClick="javascript:NewCssCal('expirydate')" style="cursor:pointer"/>--> </span></strong
				>			  </strong
				></span></td>
              <td width="3%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><span class="bodytext311">
				<select name="packagename" id="packagename" onFocus="return funcPackagePopulate1()">
			  ...
			  <input name="itemtotalamount" value="0.00" id="itemtotalamount" onBlur="return funcTaxReverseCalc1()" style="border: 1px solid #001E6A; text-align:right" size="4" /></td>
              <td width="5%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><span class="bodytext311">
                ...
                <strong>
                <input name="salesprice" id="salesprice" value="<?php //echo $batchnumber; ?>" style="border: 1px solid #001E6A"  size="3" />
                </strong></span></td>
              <td width="11%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><span class="bodytext311"><strong>
            ...
            <tr>
              ...
              <td align="left" valign="center"  bgcolor="#FFFFFF" class="bodytext31">&nbsp;</td>
              <td align="left" valign="center"  bgcolor="#FFFFFF" class="bodytext31">&nbsp;</td>
              <td align="left" valign="center"  bgcolor="#FFFFFF" class="bodytext31"><div align="right"><span class="bodytext311"><strong>Stock</strong></span></div></td>
              <td colspan="2" align="left" valign="center"  bgcolor="#FFFFFF" class="bodytext31"><span class="bodytext311"><strong>
                <input onKeyDown="return disableEnterKey()" name="showcurrentstock1" id="showcurrentstock1" onFocus="javascript:this.select()" readonly="readonly" style="border: 1px solid #001E6A; text-align:left;text-transform: uppercase; background:#CDCDCD" autocomplete="off" value="" size="5" />
              </strong></span></td>
              <td align="left" valign="center"  bgcolor="#FFFFFF" class="bodytext31"><div align="right"><span class="bodytext311"><strong>Tax</strong></span></div></td>
              <td align="left" valign="center"  bgcolor="#FFFFFF" class="bodytext31"><span class="bodytext311">
                <input onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemtaxpercent" value="0.00" id="itemtaxpercent" readonly="readonly" style="border: 1px solid #001E6A; text-align:right" size="2" />
              </span></td>
            </tr>
          </tbody>
        </table></td>
...
-->
              ...
              <tr>
                ...
                bgcolor="#F3F3F3"><span class="bodytext3"><strong><strong>
                  <strong>
                  <input type="hidden" name="deliveryaddress" id="deliveryaddress" style="border: 1px solid #001E6A" value="<?php echo $res41deliveryaddress; ?>" size="25">
                  <input type="hidden" name="address1" id="address1" value="<?php echo $res41address1; ?>" style="border: 1px solid #001E6A;text-transform: uppercase;" size="25" />
                  ...
                  <input type="hidden" name="pincode" id="pincode" value="<?php echo $res41pincode; ?>" style="border: 1px solid #001E6A;text-transform: uppercase;" size="10" />
                  <input type="hidden" name="suppliertin" id="suppliertin" value="<?php echo $res41tinnumber; ?>" style="border: 1px solid #001E6A"  size="10" />
                  </strong>
                  <input type="hidden" name="suppliercst" id="suppliercst" value="<?php echo $res41cstnumber; ?>" style="border: 1px solid #001E6A"  size="10" />
                </strong></strong></span></td>
                <td align="left" valign="center"  
                bgcolor="#F3F3F3" class="bodytext31"><div align="right"> <strong><?php echo $f29; ?></strong></div></td>
                <td align="left" valign="top" ><input type="text" name="packaging" id="packaging" value="0.00" onKeyDown="return disableEnterKey()" onBlur="return funcbillamountcalc1()" style="border: 1px solid #001E6A; text-align:right" size="8"/></td>
              </tr>
              <tr>
                <td align="left" valign="center"  
                bgcolor="#F3F3F3" class="bodytext31">&nbsp;</td>
...
bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong>Cash Amount </strong></div></td>
              ...
              <tr id="cashamounttr2">
                <td colspan="7" align="left" valign="center"  
bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong>Cash Given By Supplier </strong></div></td>
                <td align="left" valign="top" ><span class="bodytext31">
                  <input name="cashgivenbysupplier" id="cashgivenbysupplier" onBlur="return funcbillamountcalc1()" onFocus="return cashentryonfocus1()" tabindex="2" value="0.00" style="border: 1px solid #001E6A; text-align:right" size="8"  />
                </span></td>
              </tr>
              <tr id="cashamounttr3">
                <td colspan="7" align="left" valign="center"  
bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong>Cash To Be Returned To Supplier </strong></div></td>
                <td align="left" valign="top" ><span class="bodytext31">
                  <input name="cashgiventosupplier" id="cashgiventosupplier" onBlur="return funcbillamountcalc1()" value="0.00" style="border: 1px solid #001E6A; text-align:right" size="8" readonly="readonly"  />
                </span></td>
              </tr>
              ...
              <tr>
                ...
                bgcolor="#CCCCCC" class="bodytext31"><div align="right"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
                  ...
                  <input name="delbillnumber" id="delbillnumber" type="hidden" value="<?php echo $delbillnumber;?>">
					<input name="pageidentificationcontrol" id="pageidentificationcontrol" type="hidden" value="purchaseentry">
          ...
          <tbody>
            <tr>
              <td width="54%" align="left" valign="top" ><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
                ...
                <input type="button" name="suppliersearch2" onClick="javascript:suppliersearch1('purchase')" value="Supplier Alt+M" accesskey="m" style="border: 1px solid #001E6A">
                <span class="bodytext31">
                <input type="button" name="itemsearch22" onClick="javascript:itemsearch1('purchase')" value="Item Alt+S" accesskey="s" style="border: 1px solid #001E6A">
              ...
              <td width="46%" align="left" valign="top" ><div align="right"><span class="bodytext31">
                ...
                <!--<input name="print4inch2" type="button" class="button" id="print4inch2" style="border: 1px solid #001E6A" 
				  onClick="return quickprintbill1purchase()" value="Print 40" accesskey="p"/>-->
				 ...
				 <!-- <input name="print4inch" type="button" class="button" id="print4inch" style="border: 1px solid #001E6A" 
				  onClick="return quickprintbill2purchase()" value="View 40" accesskey="p"/>-->

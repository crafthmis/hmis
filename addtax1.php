...
if ($st == 'del')
{
	...
	{
		$query4 = "select * from master_itemhospital where taxanum = '$delanum'";
		$exec4 = mysql_query($query4) or die ("Error in Query4".mysql_error());
		$rowcount4 = mysql_num_rows($exec4);

		$query5 = "select * from master_itempharmacy where taxanum = '$delanum'";
		$exec5 = mysql_query($query5) or die ("Error in Query5".mysql_error());
		$rowcount5 = mysql_num_rows($exec5);

		$query6 = "select * from master_itemlab where taxanum = '$delanum'";
		$exec6 = mysql_query($query6) or die ("Error in Query6".mysql_error());
		$rowcount6 = mysql_num_rows($exec6);

		if ($rowcount4 == 0 && $rowcount5 == 0 && $rowcount6 == 0)
		{
		...
		{
			$errmsg = "Failed. Selected Tax Applies To One Or More Of Active Item On Hospital / Pharmacy / Lab. Delete Failed.";
		}
	}
}
if ($st == 'activate')

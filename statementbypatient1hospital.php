    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="statementbypatient1hospital.php">
		<table width="791" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Hospital Statement - By Patient </strong></td>
          ...
          <tbody>
            <tr>
              ...
              <td colspan="6" bgcolor="#cccccc" class="bodytext31">
				...
				$filename1 = "print_salescustomerreport1hospital.php?$urlpath";
				$fileurl = $applocation1."/".$filename1;
				$filecontent1 = @file_get_contents($fileurl);
				
				$indiatimecheck = date('d-M-Y-H-i-s');
				$foldername = "dbexcelfiles";
				$fp = fopen($foldername.'/StatementByPatientHospital.xls', 'w+');
				...
				{
					window.open("print_salescustomerreport1hospital.php?<?php echo $urlpath; ?>","Window1",'width=1000,height=600,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
					//window.open("message_popup.php?anum="+anum,"Window1",'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,width=200,height=400,left=312,top=84');
				}
				function printbillreport2()
				{
					window.location = "dbexcelfiles/StatementByPatientHospital.xls"
				}
				</script>
<!--				
...
-->
			...
			$query2 = "select * from master_transactionhospital where customername like '%$customername%' and transactiondate between '$transactiondatefrom' and '$transactiondateto' and supplieranum = '0' and suppliername = '' and companyanum = '$companyanum' and recordstatus <> 'DELETED' order by transactiondate desc";
			...
			$particulars = preg_replace('/SALES/', 'INVOICE', $particulars);
			?>

...
/*
//Download Updated zipped folder containg latest files under xampp/update_download folder and rename as date_time_stamp name.

// folder to save downloaded files to. must end with slash
$download_url = 'http://www.simpleindia.com/softwareupdates/simacle_billingretail_update.zip';

$destination_folder_name = 'update_download';

    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="drugdestroyedreport1.php">
          ...
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Drug Destroyed Report -By Date</strong></td>
            ...
            <tr>
              ...
              <td width="64%" align="left" valign="center"  bgcolor="#FFFFFF"><span class="bodytext31">
...
&nbsp;				<input value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" />
            ...
            <tr>
              ...
              <td width="8%" align="left" valign="center"  
                bgcolor="#ffffff" class="style1">ItemCode</td>
              <td width="25%" align="left" valign="center"  
                bgcolor="#ffffff" class="style1">ItemName</td>
              <td width="9%"  align="left" valign="center" 
                bgcolor="#ffffff" class="style1">Quantity</td>
              <td width="11%"  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>BatchNumber</strong></div></td>
              <td width="12%"  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Destroyed Date </strong></div></td>
              <td width="21%"  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>UserName</strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><div align="left"><strong>Updated Date </strong></div></td>
            </tr>
			<?php
			...
			$query2 = "select * from drug_destroyedreport where date_of_destroy between '$transactiondatefrom' and '$transactiondateto'  order by date_of_destroy desc";
			...
			$destroy_quantity = $res2['destroy_quantity'];
			$batch_number = $res2['batch_number'];
			$date_of_destroy = $res2['date_of_destroy'];
			$destroyed_by_username  = $res2['destroyed_by_username'];
			$date_of_update = $res2['date_of_update'];
			
			/*$query3 = "select * from drug_destroyedreport where itemcode = '$itemcode', itemname = '$itemname' , 
			destroy_quantity = '$destroy_quantity',batch_number = '$batch_number',date_of_destroy = '$date_of_destroy ',destroyed_by_username  = '$destroyed_by_username ',date_of_update = '$date_of_update'";
			$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
			$res3 = mysql_fetch_array($exec3);
			$itemcode = $res3['itemcode'];
			$itemname = $res3['itemname'];
			$destroy_quantity = $res3['destroy_quantity'];
			$batch_number = $res3['batch_number'];
			$date_of_destroy = $res3['date_of_destroy'];
			$destroyed_by_username  = $res3['destroyed_by_username'];
			$date_of_update = $res3['date_of_update'];
			*/
			
			
			
			
			if ('$transactiondatefrom') // To avoid black credit record insert.
			{
			$transactiondatefrom = $transactiondatefrom + 1;
			$showcolor = ($transactiondatefrom & 1); 
			if ($showcolor == 0)
			{
				//echo "if";
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left">
                <div class="bodytext31"><?php echo $destroy_quantity; ?></div> </td>
             <td class="bodytext31" valign="center"  align="left">
                <div class="bodytext31"><?php echo $batch_number; ?></div> </td>
             <td class="bodytext31" valign="center"  align="left">
                <div class="bodytext31"><?php echo $date_of_destroy; ?></div> </td>
             <td class="bodytext31" valign="center"  align="left">
                <div class="bodytext31"><?php echo $destroyed_by_username ; ?></div> </td>
             <td class="bodytext31" valign="center"  align="left">
                <div class="bodytext31"><?php echo $date_of_update ; ?></div> </td>
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#cccccc"><div align="right"><strong>
                  <?php 
				//$totalbalanceamount = $totalsalesamount - $netpaymentamount;
              ...
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#cccccc"><div align="right"><strong>
                  <?php 
				//$totalbalanceamount = $totalsalesreturnamount - $netcollectionamount;
				//echo number_format($totalbalanceamount, 2, '.', ''); 
				?>
              </strong></div></td>
            </tr>

...
if ($frmflag1 == 'frmflag1')
{
	...
	$query1 = "update master_itempharmacy set unitname_abbreviation = '$unitname_abbreviation', taxanum = '$taxanum', taxname = '$res4taxname', 
	...
	packagename = '$packagename', packageanum = '$packageanum'  
...
if ($sanum != '')
{
	$query2 = "select * from master_itempharmacy where auto_number = '$sanum'";
	...
	$manufactureranum = $res2['manufactureranum'];
...
function edititem1process1()
{
	...
	else if (document.form1.manufactureranum.value == "")
	{
	...
	else if (document.form1.packageanum.value == "")
	{
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="edititem1pharmacy.php?sanum=<?php echo $sanum; ?>" onSubmit="return edititem1process1()">
                  <table width="800" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Pharmacy Item Master - Edit </strong></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top"  bgcolor="#FFFFFF">
						<input name="itemname" id="itemname" value="<?php echo $itemname; ?>" onKeyDown="return process1backkeypress1()" style="border: 1px solid #001E6A" size="60" /></td>
                      </tr>
                      <tr>
                        <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="left">Select Manufacture </div></td>
                        <td align="left" valign="top"  bgcolor="#FFFFFF">
						<select id="manufactureranum" name="manufactureranum">
                          <?php
							if ($manufactureranum != '')
							{
							$query1 = "select * from master_manufacturerpharmacy where auto_number = '$manufactureranum'";
							$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
							$res1 = mysql_fetch_array($exec1);
							$manufacturername = $res1['manufacturername'];
							?>
                          <option value="<?php echo $manufactureranum; ?>" selected="selected"><?php echo $manufacturername; ?></option>
                          <?php
							}
							else
							{
...
<!--                      <tr>
                       <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="left">Select Unit Name  </div></td>
                        <td align="left" valign="top"  bgcolor="#FFFFFF">
						<select name="unitname_abbreviation" id="unitname_abbreviation">
                      ...
                      <tr>
                        <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="left">Select Package Name </div></td>
                        <td align="left" valign="top"  bgcolor="#FFFFFF">
						<select id="packageanum" name="packageanum">
							...
							{
							?>
                            <option value="<?php echo $packageanum; ?>" selected="selected"><?php echo $packagename; ?></option>
                            <?php
							}
							else
							{
						...
						while ($res1 = mysql_fetch_array($exec1))
						{
						$res1packageanum = $res1["auto_number"];
						$res1packagename = $res1["packagename"];
						$res1packagename = stripslashes($res1packagename);
						$res1quantityperpackage = $res1["quantityperpackage"];
						$res1quantityperpackage = round($res1quantityperpackage);
						$res1packageanum = $res1["auto_number"];
						?>
                            <option value="<?php echo $res1packageanum; ?>" disabled="disabled"><?php echo $res1packagename.' ( '.$res1quantityperpackage.' ) '; ?></option>
                            <?php
						}
						?>
                        </select>						</td>
                   <!-- <tr>
					  ...
					  <textarea name="description" cols="60" id="description" style="border: 1px solid #001E6A;visibility:hidden"><?php echo $description; ?></textarea>
					  <input name="purchaseprice"  type= "hidden" id="purchaseprice" value="<?php echo $purchaseprice; ?>" style="border: 1px solid #001E6A" size="20" />
					  <input name="rateperunit" type="hidden" id="rateperunit" value="<?php echo $rateperunit; ?>" style="border: 1px solid #001E6A" size="20" />

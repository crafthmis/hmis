            ...
            <tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center"  align="left"><?php echo $colorloopcount; ?></td>
                  <td  align="left" valign="center" class="bodytext31">
                    <div align="center">
                      <a href="javascript:loadprintpage1('<?php echo $patientcode; ?>')" class="bodytext3">
                      <span class="bodytext3">
                  Print				</span>				</a>				</div>				</td>
                  <td class="bodytext31" valign="center"  align="left">
                    <div align="center">
                      <a href="editpatient1.php?customercode=<?php echo $patientcode; ?>" target="_blank" class="bodytext3">
                  <span class="bodytext3">Edit</span>				</a>				</div>				</td>
                  <td  align="left" valign="center" class="bodytext31">
                    <div align="center">
                      <a href="sales1dischargesummary.php?customercode=<?php echo $patientcode; ?>" target="_blank" class="bodytext3">
                  <span class="bodytext3">Discharge</span>				</a>				</div>				</td>
                  <td class="bodytext31" valign="center"  align="left">
                  ...
                  <td class="bodytext31" valign="center"  align="left">
                  <div align="left"><?php echo $admissiontime; ?></div></td>
                  <td class="bodytext31" valign="center"  align="left">

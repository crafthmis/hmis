...
$discountexists = "";
$query4 = "select * from sales_print_dump where bill_autonumber = '$billautonumber' and companyanum = '$companyanum' and financialyear = '$financialyear'";
$exec4 = mysql_query($query4) or die ("Error in Query4".mysql_error());
	...
	<table width="98%" border="1" align="left" cellpadding="0" cellspacing="0" frame="box" rules="groups" class="style27">
      ...
      <thead>
		...
		$varLimitRow = 24;
	  	...
	  	$query4 = "select * from sales_print_dump where bill_autonumber = '$billautonumber' and companyanum = '$companyanum' and financialyear = '$financialyear' limit $varStartRow, $varLimitRow";
		$exec4 = mysql_query($query4) or die ("Error in Query4".mysql_error());
		while ($res4 = mysql_fetch_array($exec4))
		{

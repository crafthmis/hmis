...
$companycode = $_SESSION['companycode'];
	...
	$res7financialyear = $res7["settingsvalue"];
...
function loadprintpage1(banum)
{
	var varbanum = banum;
	//alert (varqanum);
	window.open("print_bill1lab.php?billautonumber="+varbanum+"","Window"+varbanum+"",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
...
{
	window.location = "invoicereport1lab.php";
}
    ...
    <td width="99%" valign="top"><table width="1498" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="1424">
              ...
              <form name="cbform1" method="get" action="invoicereport1lab.php">
		<table width="916" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Lab Invoice Report     - Select Patient </strong></td>
...
-->			  
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
		  ...
		  ?>
            <tr>
              <td colspan="25" bgcolor="#FFFF00" class="bodytext31">&nbsp;<?php echo $errmsg1; ?></td>
              </tr>
			<?php
			}
			?>	
...
--></td>
            ...
            <tr>
			  ...
			  <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><div align="left"><strong>Test Report</strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
              ...
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="style1"><span class="bodytext31"><strong>Service Charge</strong></span></td>
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="style1"><span class="bodytext31"><strong>Additional Charge </strong></span></td>
              <!--<td class="bodytext31" valign="center"  align="left" 
              ...
              <td  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Doctor Commission </strong></div></td>
			...
			if ($res7financialyear == '') $res7financialyear = $res7financialyear;
			if ($res7financialyear == 'Show All') $res7financialyear = '';
			...
			*/
			...
			$query2 = "select * from master_saleslab where customername like '%$customername%' and billnumber like '%$cbbillnumber%' and 
			...
			$doctorcommission = $res2['doctorcommission'];
			...
			$query21 = "select sum(taxamount) as sumtaxamount from labsales_tax where bill_autonumber = '$res2anum' and 
			...
			from master_transactionlab where billnumber = '$res2billnumber' and 
			...
			$query1 = "select * from master_customer";
			$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
			while ($res1 = mysql_fetch_array($exec1))
			{
			$name = $res1['customername'];
			}
			?>
            <tr <?php echo $colorcode; ?>>
			  ...
			  if ($billstatus != 'DELETED')
			  {
			  if ($res2financialyear == $res7financialyear)
			  {
				$query1reportdelete = "select * from master_employee where username = '$username'";
				$exec1reportdelete = mysql_query($query1reportdelete) or die ("Error in Query1reportdelete".mysql_error());
				$res1reportdelete = mysql_fetch_array($exec1reportdelete);
				$option_edit_delete = $res1reportdelete["option_edit_delete"];
				if ($option_edit_delete == 'Edit Delete Option Available' || $option_edit_delete == '')
				{
			  ?>
              <a href="sales1labtest.php?delbillst=billimport&&delbillautonumber=<?php echo $billautonumber; ?>&&delbillnumber=<?php echo $billnumber; ?>&&customercode=<?php echo $customercode; ?>" class="bodytext3" target="_blank"><span class="bodytext3">Report</span></a>
              <?php
			  	}
			  }
			  }
              ...
              <td class="bodytext31" valign="center"  align="left"><div align="left">
				...
				*/
				...
				$totaldoctorcommission1 = $totaldoctorcommission1 + $doctorcommission;
			...
			?>
			  ...
			  if ($res2financialyear == $res7financialyear)
			  {
				...
				{
			  ?>
                  <a href="sales1lab.php?delbillst=billedit&&delbillautonumber=<?php echo $billautonumber; ?>&&delbillnumber=<?php echo $billnumber; ?>" class="bodytext3" target="_blank"><span class="bodytext3">Edit</span></a>
              <?php
			  	}
			  }
			  }
             ...
             <?php
			  ...
			  ?>
			  <div align="center"> 
			  <a href="salesdelete1lab.php?task=delete&&anum=<?php echo $billautonumber; ?>" 
			  ...
			  <img src="images/b_drop.png" width="16" height="16" border="0">			  </a>			  </div>			  
				...
				?>			  </td>
              <td  align="left" valign="center" class="bodytext31"><div align="right"> <?php echo $doctorcommission; ?>&nbsp;</div></td>
              <td class="bodytext31" valign="center"  align="left"><div align="left"> 
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#cccccc">&nbsp;</td>
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#cccccc"><div align="right"><strong><?php echo number_format($totaldoctorcommission1, 2, '.', '');; ?></strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#cccccc">&nbsp;</td>
              </tr>
          </tbody>

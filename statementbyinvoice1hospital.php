    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="statementbyinvoice1hospital.php">
		<table width="791" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Hospital Statement By Invoice</strong></td>
          ...
          <tbody>
            <tr>
			  ...
			  <?php
				...
				$fp = fopen($foldername.'/StatementBySalesHospital.xls', 'w+');
				...
				{
					window.location = "dbexcelfiles/StatementBySalesHospital.xls"
				}
				</script>
<!--				
...
-->
			...
			$query2 = "select * from master_saleshospital where customername like '%$customername%' and billdate between '$transactiondatefrom' and '$transactiondateto' and companyanum = '$companyanum' and recordstatus <> 'DELETED'";//  order by transactiondate desc";
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left">
                <div class="bodytext31"><?php echo substr($billdate, 0, 10); ?></div>              </td>
              <td class="bodytext31" valign="center"  align="left">
			  <div class="bodytext31"><?php echo $billnumberprefix.' '.$billnumber; ?></div></td>
              <td class="bodytext31" valign="center"  align="left">

    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="backupsoftware1.php">
                  <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td bgcolor="#CCCCCC" class="bodytext3"><strong>Software Backup - Click Button To Take Backup of Software </strong></td>
                      </tr>
					  <tr>
                ...
                <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
					...
					<tr <?php echo $colorcode; ?>>
						...
						<a href="backupsoftware1.php?st=del&&anum=<?php echo $auto_number; ?>" onClick="return funcDeleteBackup1('<?php echo $backupfilename; ?>')">
						...
						<a href="backupsoftwaredownload1.php?filename=<?php echo $backupfilename; ?>">

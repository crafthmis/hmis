...
//Top capture from link click from collectionpending1pharmacy.php
if (isset($_REQUEST["linkfrmflag1"])) { $linkfrmflag1 = $_REQUEST["linkfrmflag1"]; } else { $linkfrmflag1 = ""; }
//echo $linkfrmflag1;
if ($linkfrmflag1 == 'linkfrmflag1')
{

	$searchcustomeranum = $_REQUEST['searchcustomeranum'];
	if ($searchcustomeranum != '')
	{
		$query1 = "select * from master_customer where auto_number = '$searchcustomeranum'";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
		$res1 = mysql_fetch_array($exec1);
		$customeranum = $res1['auto_number'];
		$arraycustomername = $res1['customername'];
		$openingbalance = $res1['openingbalance'];

		$cbcustomername = $arraycustomername;
		$customername = $arraycustomername;
		$searchcustomername = $arraycustomername;
	}
	else
	{
		$cbcustomername = $_REQUEST['cbcustomername'];
...
if ($frmflag2 == 'frmflag2')
{
	...
	$query81 = "select auto_number from master_salespharmacy where billnumber = '$billnumber' and companyanum = '$companyanum' and recordstatus <> 'deleted'";
	...
	$query9 = "insert into master_transactionpharmacy (transactioncode, transactiondate, particulars, customeranum, customername, 
	...
	$query21 = "select * from master_transactionpharmacy where transactiontype = 'COLLECTION' and transactionmodule = 'COLLECTION' and companyanum = '$companyanum' order by auto_number desc";
	...
	$query23 = "update master_transactionpharmacy set collectionnumber = '$collectionreceiptnumber' where transactioncode = '$transactioncode'";
	$exec23 = mysql_query($query23) or die ("Error in Query23".mysql_error());
	
	header ("location:collectionentry1pharmacy.php?st=1");
	exit;
...
if ($st == '1')
{
	$errmsg = "Success. Pharmacy Collection Entry Update Completed.";
}
if ($st == '2')
{
	$errmsg = "Failed. Pharmacy Collection Entry Not Completed.";
}
...
function paymententry1process1()
{
	...
	if (fRet == true)
	{
		...
		if (varCollectionAmount > varPendingAmount)
		{
			...
			alert ("Pharmacy Collection Entry Not Completed.");
			return false;
		}
		*/
	}
...
function funcPrintReceipt1()
{
	...
	window.open("print_collection_receipt1pharmacy.php","OriginalWindow<?php echo $banum; ?>",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
}
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="collectionentry1pharmacy.php">
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#CCCCCC" class="bodytext3"><strong>Pharmacy Collection Entry     - Select Customer </strong></td>
              </tr>
            <tr>
              <td colspan="4" align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><span class="bodytext32">
              <input name="printreceipt1" type="reset" id="printreceipt1" onClick="return funcPrintReceipt1()" style="border: 1px solid #001E6A" value="Print Receipt - Previous Pharmacy Collection Entry" />
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><div align="right"><strong>By Sales </strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><div align="right"><strong>By Collections </strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><div align="right"><strong>By Adjustment </strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
...
*/
			...
			$query2 = "select * from master_transactionpharmacy where customeranum = '$customeranum' and recordstatus = '' group by customeranum";// and approvalstatus =  'APPROVED' and cstid='$custid' and cstname='$custname'";//  order by transactiondate desc";
			$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
			...
			$query3 = "select * from master_transactionpharmacy where transactiontype = 'SALES' and customeranum = '$res2anum' and recordstatus = ''";// and approvalstatus =  'APPROVED' and cstid='$custid' and cstname='$custname'";
			...
			$query3 = "select * from master_transactionpharmacy where transactiontype = 'COLLECTION' and customeranum = '$res2anum' and recordstatus = ''";// and approvalstatus =  'APPROVED' and cstid='$custid' and cstname='$custname'";
			$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
			while ($res3 = mysql_fetch_array($exec3))
			{
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><strong> Customer </strong></td>
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><div align="right"><strong>By Sales Return </strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><div align="right"><strong>By Payments </strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><div align="right"><strong>By Adjustment </strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><div align="right"><strong>By Balance </strong></div></td>
...
*/
			...
			$query2 = "select * from master_transactionpharmacy where customeranum = '$customeranum' and transactionmodule = 'SALES RETURN' and recordstatus = '' group by customeranum";// and cstid='$custid' and cstname='$custname'";//  order by transactiondate desc";
			$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
			while ($res2 = mysql_fetch_array($exec2))
			{
			$res2anum = $res2['customeranum'];
			...
			$query3 = "select * from master_transactionpharmacy where transactiontype = 'SALES RETURN' and transactionmodule = 'SALES RETURN' and customeranum = '$res2anum' and recordstatus = ''";// and cstid='$custid' and cstname='$custname'";
			$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
			while ($res3 = mysql_fetch_array($exec3))
			{
				$transactionamount = $res3['transactionamount'];
			...
			$query3 = "select * from master_transactionpharmacy where transactiontype = 'PAYMENT' and transactionmodule = 'SALES RETURN' and customeranum = '$res2anum' and recordstatus = ''";// and cstid='$custid' and cstname='$custname'";
			$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
			while ($res3 = mysql_fetch_array($exec3))
			{
				$cashamount1 = $res3['cashamount'];
      ...
      <tr>
        <td>
				...
				<form name="form1" id="form1" method="post" action="collectionentry1pharmacy.php?cbfrmflag1=<?php echo $cbfrmflag1; ?>" onSubmit="return paymententry1process1()">
			  <table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                <tbody>
                  <tr bgcolor="#011E6A">
                    <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Pharmacy Collection Entry - Details </strong></td>
                  ...
                  <tr>
                    <td colspan="4" align="left" valign="middle"  class="bodytext3"><span class="style2"><!--* For Bill Number Wise Pharmacy Collection Entry. Optional. --></span></td>
                  </tr>
                  <tr>

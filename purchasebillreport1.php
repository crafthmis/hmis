...
function loadprintpage1(banum)
{
	var varbanum = banum;
	//alert (varqanum);
	window.open("print_bill1_purchase1.php?billautonumber="+varbanum+"","Window"+varbanum+"",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
...
function loadprintpage2(banum)
{
	...
	window.open("print_bill1_purchase1.php?copy1=INVOICE && title1=ORIGINAL && banum="+varbanum+"","Window1"+varbanum+"",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
	//window.open("print_bill1_purchase1.php?banum="+varbanum+"","Window2"Original"",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
	
	window.open("print_bill1_purchase1.php?copy1=INVOICE && title1=DUPLICATE && banum="+varbanum+"","Window2"+varbanum+"",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
	window.open("print_bill1_purchase1.php?copy1=INVOICE && title1=TRIPLICATE && banum="+varbanum+"","Window3"+varbanum+"",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
	//window.open("message_popup.php?anum="+anum,"Window1",'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,width=200,height=400,left=312,top=84');
}
...
function loadpdfpage1(banum)
{
	...
	//window.open("print_bill1_purchase1.php?banum="+varbanum+"","Window"+varbanum+"",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
	//window.open("message_popup.php?anum="+anum,"Window1",'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,width=200,height=400,left=312,top=84');
}

function funcRedirectWindow1()
{
	window.location = "purchasebillreport1.php";
}
...
function funcDeleteRecord1(varBillNumberNumber)
{
	...
	var fRet;
	fRet = confirm('Are You Sure Want To Delete This Purchase Bill Number '+varBillNumberNumber+'?');
	//alert(fRet);
	if (fRet == true)
	{
		var fRet2;
		fRet2 = confirm('All Payment Details Saved Will Also Be Deleted. Are Sure Your Want To Delete This Purchase Bill Number '+varBillNumberNumber+'?');
		//alert(fRet);
		if (fRet2 == true)
		{
			alert ("Success. Purchase Entry Delete Completed.");
			//return false;
		}
		if (fRet2 == false)
		{
			alert ("Failed. Purchase Entry Delete Not Completed.");
			return false;
		}
	}
	if (fRet == false)
    ...
    <td width="99%" valign="top"><table width="1425" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="get" action="purchasebillreport1.php">
		<table width="867" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Purchase Bill Report     - Select Supplier </strong></td>
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
		  ...
		  ?>
            <tr>
              <td colspan="18" bgcolor="#FFFF00" class="bodytext31">&nbsp;<?php echo $errmsg1; ?></td>
              </tr>
			<?php
			}
			?>	
            ...
            <tr>
              ...
              <td colspan="3" align="left" valign="center" bgcolor="#ffffff" class="bodytext31">
				...
				if ($cbfrmflag1 == 'cbfrmflag1')
				{
					...
					$urlpath = "cbsuppliername=$cbsuppliername&&cbbillnumber=$cbbillnumber&&approvalstatus=$approvalstatus&&paymenttype=$paymenttype&&ADate1=$transactiondatefrom&&ADate2=$transactiondateto&&username=$username&&financialyear=$financialyear&&companyanum=$companyanum";//&&companyname=$companyname";
				}
				else
				{
					$urlpath = "cbsuppliername=$cbsuppliername&&cbbillnumber=$cbbillnumber&&approvalstatus=APPROVED&&ADate1=$transactiondatefrom&&ADate2=$transactiondateto&&username=$username&&financialyear=$financialyear&&companyanum=$companyanum";//&&companyname=$companyname";
				}
				?>
 				<?php
				...
				$fp = fopen($foldername.'/PurchaseReport.xls', 'w+');
				...
				{
					window.location = "dbexcelfiles/PurchaseReport.xls"
				}
				</script>
<!--				
...
-->
            ...
            <tr>
              ...
              <td align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>SubTotal</strong></div></td>
              <td align="left" valign="center" bgcolor="#ffffff" class="style1"><div align="right"><span class="bodytext31"><strong>Tax</strong></span></div></td>
              <!--<td class="bodytext31" valign="center" align="left" 
              ...
              <td width="6%" align="left" valign="center" bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Remarks</strong></div></td>
			...
			*/
			...
			$query2 = "select * from master_purchase where suppliername like '%$suppliername%' and 
			...
			$query21 = "select sum(taxamount) as sumtaxamount from purchase_tax where bill_autonumber = '$res2anum' and 
			...
			from master_transactionpharmacy where billnumber = '$res2billnumber' and customeranum = '0' and customername = '' and 
			transactiontype = 'PAYMENT' and companyanum = '$companyanum' and 
			transactionmodule = 'purchase' and  
			cstid='$custid' and cstname='$custname' and $billstatusquery1";
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center" align="left"><div align="left">
				...
				*/
				...
				$totalnetamount = $totalnetamount + $totalamount;
				$totalcashamount = $totalcashamount + $sumcashamount;
				$totalchequeamount = $totalchequeamount + $sumchequeamount;
				$totalonlineamount = $totalonlineamount + $sumonlineamount;
				$totalcardamount = $totalcardamount + $sumcardamount;
				$totalcreditamount = $totalcreditamount + $sumcreditamount;
			?>
              </div></td>
			  ...
			  {
			  ?>
                  <a href="purchase1.php?delbillst=billedit&&delbillautonumber=<?php echo $billautonumber; ?>&&delbillnumber=<?php echo $billnumber; ?>" class="bodytext3" target="_blank">
             ...
             <?php
			  ...
			  ?>
			  <div align="center"> 
			  <a href="purchasedelete1.php?task=delete&&anum=<?php echo $billautonumber; ?>" 
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center" align="left" 
                bgcolor="#cccccc">&nbsp;</td>
              <td class="bodytext31" valign="center" align="left" 
                bgcolor="#cccccc"><div align="right"><strong><?php echo $totalnetamount; ?>&nbsp;</strong></div></td>
              <td class="bodytext31" valign="center" align="left" 
                bgcolor="#cccccc"><div align="right"><strong><?php echo $totalcashamount; ?>&nbsp;</strong></div></td>
              <td class="bodytext31" valign="center" align="left" 
                bgcolor="#cccccc"><div align="right"><strong><?php echo $totalchequeamount; ?>&nbsp;</strong></div></td>
              <td class="bodytext31" valign="center" align="left" 
                bgcolor="#cccccc"><div align="right"><strong><?php echo $totalonlineamount; ?>&nbsp;</strong></div></td>
              <td class="bodytext31" valign="center" align="left" 
                bgcolor="#cccccc"><div align="right"><strong><?php echo $totalcardamount; ?>&nbsp;</strong></div></td>
              <td class="bodytext31" valign="center" align="left" 
                bgcolor="#cccccc"><div align="right"><strong><?php echo $totalcreditamount; ?>&nbsp;</strong></div></td>
              <td class="bodytext31" valign="center" align="left" 
                bgcolor="#cccccc">&nbsp;</td>
              <td class="bodytext31" valign="center" align="left" 
                bgcolor="#cccccc">&nbsp;</td>

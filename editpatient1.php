	...
	if ($res2 != 0)
	{
		...
		if ($_FILES['browse1']['name'] != '')
		{
			if(move_uploaded_file($_FILES['browse1']['tmp_name'], $target_path)) 
			{
				...
				openingbalance = '$openingbalance', insuranceid = '$insuranceid', gender = '$gender', age = '$age'  
		...
		header("location:editpatient1.php?customercode=$customercode&&st=$status");
...
{
		$errmsg = "Failed. Photo Upload Not Completed.";
		$bgcolorcode = 'failed';
}
...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top">
      	  ...
      	  <form name="form1" id="form1" method="post" onKeyDown="return disableEnterKey()" enctype="multipart/form-data" action="editpatient1.php" onSubmit="return process1()">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="860"><table width="800" height="282" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
                <td bgcolor="#CCCCCC" class="bodytext3" colspan="2"><strong>Patient - Edit </strong></td>
              ...
              <!--<tr>
			    ...
			    <tr>
			      ...
			      <td align="left" valign="middle"  bgcolor="#E0E0E0">
				  <input type="text" name="age" id="age" value="<?php echo $age; ?>" style="border: 1px solid #001E6A;">
<!--				  
...
-->				   </td>
				 ...
				 <tr>
				   ...
				   <td align="left" valign="middle"  bgcolor="#E0E0E0"><input name="insuranceid" id="insuranceid" value="<?php echo $insuranceid; ?>" style="border: 1px solid #001E6A;"  size="20"></td>
				 ...
				 <tr>
				   ...
				   <td colspan="3" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><input type="hidden" name="MAX_FILE_SIZE" value="100000">
                       <input type="file" name="browse1" value="" size="20" style="border: 1px solid #001E6A"/>
                       <strong>Only JPG or JPEG Files Allowed. </strong> &nbsp;</td>
			      </tr>
                 <tr>
                <td colspan="4" align="middle"  bgcolor="#E0E0E0"><div align="right"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"> <font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
                 ...
                 <tr>
					<td colspan="4" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">
					<?php 

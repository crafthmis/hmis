    ...
    <td valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
			...
			<form name="stockinward" action="salesreportbycategory1hospital.php" method="post" onKeyDown="return disableEnterKey()" onSubmit="return process1()">
        ...
        <tr>
          ...
          <td colspan="4" align="left" valign="center"  bgcolor="#ffffff" class="bodytext31">
			<select name="categoryname" id="categoryname">
				...
				?>
				<?php
				$query42 = "select * from master_categoryhospital where status = '' order by categoryname";
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            <tr>
              ...
              <td width="33%" bgcolor="#cccccc" class="bodytext31">&nbsp;</td>
            ...
            <tr>
              ...
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><strong>Total Amt </strong></td>
              <td align="left" valign="center"  
			...
			if ($searchoption1 == 'DETAILED')
			{
				...
				$query2 = "select * from hospitalsales_details where itemcode like '%$itemcode%' and entrydate between '$transactiondatefrom' and '$transactiondateto' and recordstatus <> 'DELETED' and companyanum = '$companyanum' order by entrydate desc";// and cstid='$custid' and cstname='$custname'";
			}
			if ($searchoption1 == 'CUMULATIVE')
			{
				//$query2 = "select *, sum(totalrate) as sumtotalrate, sum(quantity) as sumquantity from master_stock where itemcode like '%$itemcode%' and transactiondate between '$transactiondatefrom' and '$transactiondateto' and recordstatus <> 'DELETED' and companyanum = '$companyanum' group by itemcode, transactionmodule order by itemname";// and cstid='$custid' and cstname='$custname'";
				$query2 = "select *, sum(totalamount) as sumtotalamount, sum(quantity) as sumquantity from hospitalsales_details where itemcode like '%$itemcode%' and entrydate between '$transactiondatefrom' and '$transactiondateto' and recordstatus <> 'DELETED' and companyanum = '$companyanum' group by itemcode order by itemname";// and cstid='$custid' and cstname='$custname'";
			}
			...
			$query3 = "select * from master_itemhospital where itemcode = '$itemcode'";
			...
			if ($searchoption1 == 'DETAILED')
			{
				$sumtotalamount = $res2['totalamount'];
				$sumquantity = $res2['quantity'];
				$billdate = $res2['entrydate'];
				$billdate = substr($billdate, 0, 10);
				$billnumber = 'By Bill No. '.$res2['billnumber'];
			}
			if ($searchoption1 == 'CUMULATIVE')
			{
				$sumtotalamount = $res2['sumtotalamount'];

...
{
//echo 'inside if';
$query41 = "select * from proformainvoice_details where billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'deleted'";
...
$query42 = "select * from proformainvoice_tax where itemcode = '$varItemCode' and billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'deleted'";
...
<input onClick="return btnFreeClick(<?php echo $itemcount; ?>)" name="btnfree<?php echo $itemcount; ?>" id="btnfree<?php echo $itemcount; ?>" type="button" value="Free" class="button" style="border: 1px solid #001E6A"/><input onClick="return btnDeleteClick(<?php echo $itemcount; ?>)" name="btndelete<?php echo $itemcount; ?>" id="btndelete<?php echo $itemcount; ?>" type="hidden" value="Del" class="button" style="border: 1px solid #001E6A"/>
</td>
</TR>
<?php
...
<td id="idTD3<?php echo $itemcount; ?>" align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3">
<input name="taxpercent<?php echo $itemcount; ?>" value="<?php echo $varItemTaxPercent; ?>" id="taxpercent<?php echo $itemcount; ?>" readonly="readonly" style="border: 0px solid #001E6A; text-align:right" size="3" />
<input type="hidden"  name="taxautonumber<?php echo $itemcount; ?>" value="<?php echo $varItemTaxAnum; ?>" id="itemtaxautonumber<?php echo $itemcount; ?>" readonly="readonly" style="border: 0px solid #001E6A; text-align:right" size="3" />
<input type="hidden"  name="taxname<?php echo $itemcount; ?>" value="<?php echo $varItemTaxName; ?>" id="itemtaxname<?php echo $itemcount; ?>" readonly="readonly" style="border: 0px solid #001E6A; text-align:right" size="3" />
</td>
<td id="idTD3<?php echo $itemcount; ?>" align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3">
<input name="totalamount<?php echo $itemcount; ?>" value="<?php echo $varItemTotalAmount; ?>" id="totalamount<?php echo $itemcount; ?>" readonly="readonly" style="border: 0px solid #001E6A; text-align:right" size="8" />

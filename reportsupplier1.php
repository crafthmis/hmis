...
&nbsp;				<input value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" />
			...
			$query2 = "select * from master_transactionpharmacy where suppliername like '%$suppliername%' and transactiondate between '$transactiondatefrom' and '$transactiondateto' and customeranum = '0' and customername = '' and companyanum = '$companyanum' and recordstatus <> 'DELETED' order by transactiondate desc";

    ...
    <td width="99%" valign="top"><table width="1498" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="1424">
              ...
              <form name="cbform1" method="get" action="invoicereport1prescription.php">
		<table width="916" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Prescription Report     - Select Patient </strong></td>
            ...
            <tr>
              <td colspan="8" align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="right">
		  ...
		  ?>
            ...
            <tr>
			  ...
			  <?php
				...
				$filename1 = "print_salesreport1prescription.php?$urlpath";
				$fileurl = $applocation1."/".$filename1;
				$filecontent1 = @file_get_contents($fileurl);
				
				$indiatimecheck = date('d-M-Y-H-i-s');
				$foldername = "dbexcelfiles";
				$fp = fopen($foldername.'/SalesReportPrescription.xls', 'w+');
				...
				{
					window.open("print_salesreport1prescription.php?<?php echo $urlpath; ?>","Window1",'width=900,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
					//window.open("message_popup.php?anum="+anum,"Window1",'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,width=200,height=400,left=312,top=84');
				}
				function printbillreport2()
				{
					window.location = "dbexcelfiles/SalesReportPrescription.xls"
				}
				</script>
				<?php
...
&nbsp;				<input value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" /></td>
			...
			*/
			...
			$query2 = "select * from master_salesprescription where customername like '%$customername%' and billnumber like '%$cbbillnumber%' and 
			...
			from master_transactionhos where billnumber = '$res2billnumber' and 

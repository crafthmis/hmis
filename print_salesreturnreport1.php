...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
  ...
  <tbody>
            ...
            <tr>
              <td colspan="17" align="left" valign="center" bordercolor="#f3f3f3" bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Sales Return Report</strong></div></td>
            </tr>
            <tr>
            ...
            <tr>
              <td colspan="17" align="left" valign="center" bordercolor="#f3f3f3" bgcolor="#ffffff" class="bodytext31"><div align="center"><strong><?php echo 'Report Date From '.$transactiondatefrom.' To '.$transactiondateto; ?></strong></div></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center" bordercolor="#f3f3f3" align="left" 
                bgcolor="#ffffff"><div align="left"><strong>BillDateShow </strong></div></td>
              <td class="bodytext31" valign="center" bordercolor="#f3f3f3" align="left" 
			...
			//$query2 = "select * from master_salesreturn where customername like '%$customername%' and billnumber like '%$cbbillnumber%' and recordstatus = '$billstatus' and billtype like '%$paymenttype%' and companyanum = '$companyanum' and lastupdate between '$transactiondatefrom' and '$transactiondateto' order by lastupdate desc";
			$query2 = "select * from master_salesreturn where customername like '%$customername%' and billnumber like '%$cbbillnumber%' 
			...
			$query21 = "select sum(taxamount) as sumtaxamount from salesreturn_tax where bill_autonumber = '$res2anum' and 
			...
			from master_transaction where billnumber = '$res2billnumber' and transactiontype = 'PAYMENT' and 
			transactiontype = 'PAYMENT' and companyanum = '$companyanum' and 
			transactionmodule = 'sales return' and $billstatusquery1 and 
			supplieranum = '0' and suppliername = '' and cstid='$custid' and cstname='$custname'";

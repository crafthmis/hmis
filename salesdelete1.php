...
if ($task == 'delete' && $anum != '')
{
	$query19 = "select * from master_sales where auto_number = '$anum' and companyanum = '$companyanum' and financialyear = '$financialyear'";
	...
	while ($res19 = mysql_fetch_array($exec19))
	{
		...
		$query18 = "update master_transaction set recordstatus = 'DELETED' where transactionmodule = 'SALES' and billnumber = '$delbillnumber' and companyanum = '$companyanum' and financialyear = '$financialyear'";
...
header ("location:billreport1.php?task=deleted");
//exit;

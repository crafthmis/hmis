    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="addcategory1lab.php" onSubmit="return addcategory1process1()">
                  <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Lab Category Master - Add New </strong></td>
                      </tr>
					  <tr>
                ...
                <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="3" bgcolor="#CCCCCC" class="bodytext3"><strong>Lab Category Master - Existing List </strong></td>
                      </tr>
                      <?php
        ...
        <tr <?php echo $colorcode; ?>>
                        <td width="6%" align="left" valign="top"  class="bodytext3"><div align="center"><a href="addcategory1lab.php?st=del&&anum=<?php echo $auto_number; ?>"><img src="images/b_drop.png" width="16" height="16" border="0" /></a></div></td>
						...
						{ 
						?>
						<a href="addcategory1lab.php?st=default&&anum=<?php echo $auto_number; ?>">
						...
						{ 
						?>
						<a href="addcategory1lab.php?st=removedefault&&anum=<?php echo $auto_number; ?>">
		...
		?>
                ...
                <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Lab Category Master - Deleted </strong></td>
                      </tr>
                      <?php
        ...
        <tr <?php echo $colorcode; ?>>
						...
						<a href="addcategory1lab.php?st=activate&&anum=<?php echo $auto_number; ?>" class="bodytext3">

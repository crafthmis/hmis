...
//	IMPORTANT : PLEASE CHANGE DESTINATION DATABASE NAME TO LIVE DATABASE NAME //
	...
	$comparisondestinationdatabasename = 'simaclehospitaldestination'; //CHANGE ONLY THIS LVE DB NAME.
...
if ($submit == 'Yes. Proceed.')
{
	...
	///*
	$query5 = "SHOW TABLES FROM $comparisonsourcedatabasename";
	$exec5 = mysql_query($query5, $comparisonsourcedatabaseconnect);
	...
	///*
	$query8 = "SHOW TABLES FROM $comparisonsourcedatabasename";
	$exec8 = mysql_query($query8, $comparisonsourcedatabaseconnect);
	while ($res8 = mysql_fetch_row($exec8)) 
	{
		...
		$exec9 = mysql_query($query9, $comparisonsourcedatabaseconnect) or die ("Error in Query9".mysql_error());
	...
	///*
	$query12 = "SHOW TABLES FROM $comparisonsourcedatabasename";
	$exec12 = mysql_query($query12, $comparisonsourcedatabaseconnect);
	while ($res12 = mysql_fetch_row($exec12)) 
	{
		...
		$exec13 = mysql_query($query13, $comparisonsourcedatabaseconnect) or die ("Error in Query13".mysql_error());

...
$query3 = "select * from master_saleslab where billnumber = '$billnumber' and recordstatus <> 'deleted' and companyanum = '$companyanum' and financialyear = '$financialyear'";
...
<script type="text/javascript">
      ...
      function funcPrint() {
         ...
         if (applet != null) {
			...
			<?php
			$serialnumber = "";
			$query4 = "select * from labsales_details where bill_autonumber = '$billautonumber' and recordstatus <> 'deleted' and companyanum = '$companyanum' and financialyear = '$financialyear'";
			...
			*/
			...
			?>
			<?php
			$query41 = "select *, sum(taxamount) as sumtaxamount from labsales_tax  where bill_autonumber = '$billautonumber' and recordstatus <> 'deleted' and companyanum = '$companyanum' and financialyear = '$financialyear' group by tax_autonumber, taxname order by auto_number";

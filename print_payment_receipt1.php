...
$query1 = "select * from master_transactionpharmacy where transactiontype = 'PAYMENT' and transactionmodule = 'PAYMENT' and recordstatus <> 'DELETED' and companyanum = '$companyanum' order by auto_number desc";
$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
$rowcount1 = mysql_num_rows($exec1);
if ($rowcount1 == 0)
{
	echo 'Sorry. No Payment Entry To Print.';
	exit;
}
...
{
	$query21 = "select * from master_transactionpharmacy where transactiontype = 'PAYMENT' and transactionmodule = 'PAYMENT' and recordstatus <> 'DELETED' and companyanum = '$companyanum' order by auto_number desc";
}
...
$billdate = $dbdateday;//.' '.$billtime;
$supplieranum = $res21['supplieranum'];
...
$query3 = "select * from master_supplier where auto_number = '$supplieranum'";

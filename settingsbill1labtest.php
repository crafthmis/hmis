...
if ($frmflag1 == 'frmflag1')
{
	...
	$query3 = "select auto_number from settings_billlabtest where companyanum = '$companyanum'";
	$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
	$rowcount3 = mysql_num_rows($exec3);
	if ($rowcount3 != 0)
	{
		$query1 = "update settings_billlabtest set f1 = '$f1', f2 = '$f2', f3 = '$f3', f4 = '$f4', f5 = '$f5', 
	...
	{
		$query4 = "insert into settings_billlabtest (f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, 
	...
	$errmsg = "Success. Bill Settings Update Completed.";
...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top">
      	  ...
      	  <form name="form1" id="form1" method="post" action="settingsbill1labtest.php" enctype="multipart/form-data">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
		  ...
		  <table width="900" height="282" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
                <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Settings - Lab Test </strong></td>
                ...
                <td align="middle" colspan="4" ><table width="682" border="0" cellpadding="0" cellspacing="0">
                  ...
                  <tr>
                    <td colspan="3"><table width="98%" border="0" cellspacing="0" cellpadding="0" class="sample">
                      <tr>
                        <td width="53%"><input type="hidden" name="f17" id="f17" value="<?php echo $f17; ?>" style="border: 1px solid #001E6A"  size="20"   />
                            <span class="style27"><br />
                            <input type="hidden" name="f18" id="f18" value="<?php echo $f18; ?>" style="border: 1px solid #001E6A"  size="20"   />
                            </span><span class="style27"><br />
                            <input type="hidden" name="f19" id="f19" value="<?php echo $f19; ?>" style="border: 1px solid #001E6A"  size="20"   />
                          </span></td>
                        <td width="47%"><input type="hidden" name="f20" id="f20" value="<?php echo $f20; ?>" style="border: 1px solid #001E6A"  size="20"   />
                            <span class="style27"><br />
                            <input type="hidden" name="f21" id="f21" value="<?php echo $f21; ?>" style="border: 1px solid #001E6A"  size="20"   />
                            </span><span class="style27"><br />
                            <input type="hidden" name="f22" id="f22" value="<?php echo $f22; ?>" style="border: 1px solid #001E6A"  size="20"   />
                          </span></td>
                      </tr>
                    </table></td>
                  </tr>
                  ...
                  <tr>
                    <td colspan="3"><table width="98%" border="0" cellspacing="0" cellpadding="0" class="sample">
                        <tr>
                          ...
                          <td width="49%"><div align="left" class="style28">&nbsp;Description</div></td>
                          <td width="7%"><div align="left" class="style28">&nbsp;<!--Qty--></div></td>
                          <td width="13%"><div align="left" class="style28">&nbsp;<!--Unit--></div></td>
                          <td width="8%"><div align="right" class="style28">
                            <div align="center">Result Values&nbsp;</div>
                          </div></td>
                          <td width="10%"><div align="center"><span class="style28">Normal Values </span></div></td>
                          <td width="8%"><div align="left" class="style28">
                              <div align="center">Test Unit&nbsp;</div>
                          </div></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td colspan="3"><div align="right" class="style29"><strong>
                            ...
                            <input type="hidden" name="f29" id="f29" value="<?php echo $f29; ?>" style="border: 1px solid #001E6A"  size="20"   />
                            &nbsp;</strong></div></td>
                        ...
                        <tr>
                          ...
                          <span class="bodytext3"><!--*If Zero, this line will not appear in printout.--> </span>
                          <input type="hidden" name="f30" id="f30" value="<?php echo $f30; ?>" style="border: 1px solid #001E6A"  size="20"   />
                            &nbsp;</strong></div></td>
                          <td colspan="3"><div align="right" class="style29"><?php echo $transportation; ?>&nbsp;</div></td>
                        </tr>
                        <tr>

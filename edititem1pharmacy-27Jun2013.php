...
if ($frmflag1 == 'frmflag1')
{
	...
	$query1 = "update master_itempharmacy set unitname_abbreviation = '$unitname_abbreviation', taxanum = '$taxanum',  
                  ...
                  <table width="800" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      ...
                      <tr>
						...
						$res1packageanum = $res1["auto_number"];
						?>
                            <option value="<?php echo $res1packageanum; ?>"><?php echo $res1packagename.' ( '.$res1quantityperpackage.' ) '; ?></option>
                            <?php
						}
						?>
                        </select>						</td>
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top"  bgcolor="#FFFFFF"><input name="rateperunit" id="rateperunit" value="<?php echo $rateperunit; ?>" style="border: 1px solid #001E6A" size="20" /></td>
                      </tr>
                      <tr>

...
function loadprintpage1(banum)
{
	var varbanum = banum;
	//alert (varqanum);
	window.open("print_bill1_purchaseorder1.php?billautonumber="+varbanum+"","Window"+varbanum+"",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
...
function loadprintpage2(banum)
{
	...
	window.open("print_bill1_purchaseorder1.php?copy1=INVOICE && title1=ORIGINAL && banum="+varbanum+"","Window1"+varbanum+"",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
	//window.open("print_bill1_purchaseorder1.php?banum="+varbanum+"","Window2"Original"",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
	
	window.open("print_bill1_purchaseorder1.php?copy1=INVOICE && title1=DUPLICATE && banum="+varbanum+"","Window2"+varbanum+"",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
	window.open("print_bill1_purchaseorder1.php?copy1=INVOICE && title1=TRIPLICATE && banum="+varbanum+"","Window3"+varbanum+"",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
	//window.open("message_popup.php?anum="+anum,"Window1",'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,width=200,height=400,left=312,top=84');
}
...
function loadpdfpage1(banum)
{
	...
	//window.open("print_bill1_purchaseorder1.php?banum="+varbanum+"","Window"+varbanum+"",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
	//window.open("message_popup.php?anum="+anum,"Window1",'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,width=200,height=400,left=312,top=84');
}

function funcRedirectWindow1()
{
	window.location = "purchaseorderreport1.php";
}
...
function funcDeleteRecord1(varBillNumberNumber)
{
	...
	var fRet;
	fRet = confirm('Are You Sure Want To Delete This Purchase Order Bill Number '+varBillNumberNumber+'?');
	//alert(fRet);
	if (fRet == true)
	{
		var fRet2;
		fRet2 = confirm('All Payment Details Saved Will Also Be Deleted. Are Sure Your Want To Delete This Purchase Order Bill Number '+varBillNumberNumber+'?');
		//alert(fRet);
		if (fRet2 == true)
		{
			alert ("Success. Purchase Order Entry Delete Completed.");
			//return false;
		}
		if (fRet2 == false)
		{
			alert ("Failed. Purchase Order Entry Delete Not Completed.");
			return false;
		}
	}
	if (fRet == false)
    ...
    <td width="99%" valign="top"><table width="1425" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="get" action="purchaseorderreport1.php">
		<table width="936" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Purchase Order Report</strong></td>
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="936" 
            align="left" border="0">
          <tbody>
		  <?php
		  	$errmsg1 = '';
		  ...
		  ?>
            ...
            <tr>
              ...
              <td width="28%" bgcolor="#cccccc" class="bodytext31">&nbsp;</td>
            ...
            <tr>
              ...
              <td colspan="9"  align="left" valign="center" 
				...
				$filename1 = "print_purchaseorderreport1.php?$urlpath";
				$fileurl = $applocation1."/".$filename1;
				$filecontent1 = @file_get_contents($fileurl);
				
				$indiatimecheck = date('d-M-Y-H-i-s');
				$foldername = "dbexcelfiles";
				$fp = fopen($foldername.'/PurchaseOrderReport.xls', 'w+');
				...
				{
					window.open("print_purchaseorderreport1.php?<?php echo $urlpath; ?>","Window1",'width=900,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
					//window.open("message_popup.php?anum="+anum,"Window1",'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,width=200,height=400,left=312,top=84');
				}
				function printbillreport2()
				{
					window.location = "dbexcelfiles/PurchaseOrderReport.xls"
				}
				</script>
...
&nbsp;				<input value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" />
			...
			$query2 = "select * from master_purchaseorder where suppliername like '%$suppliername%' and 
			billnumber like '%$cbbillnumber%' and $billstatusquery1 and billtype like '%$paymenttype%' and 
			companyanum = '$companyanum' and lastupdate between '$transactiondatefrom' and '$transactiondateto' 
			...
			$query21 = "select sum(taxamount) as sumtaxamount from purchaseorder_tax where bill_autonumber = '$res2anum' and 
			$billstatusquery1 and companyanum = '$companyanum' and 
			updatedate between '$transactiondatefrom' and '$transactiondateto' order by billdate desc";
			...
			transactionmodule = 'purchase order' and $billstatusquery1 and  
			...
			?>
			  ...
			  {
			  ?>
                  <a href="purchaseorder1.php?delbillst=billedit&&delbillautonumber=<?php echo $billautonumber; ?>&&delbillnumber=<?php echo $billnumber; ?>" class="bodytext3" target="_blank">
              ...
              <td class="bodytext31" valign="center"  align="left"><div align="center"> 
			  <a href="purchase1.php?delbillst=importpurchaseorder&&delbillautonumber=<?php echo $billautonumber; ?>&&delbillnumber=<?php echo $billnumber; ?>" class="bodytext3" target="_blank"><span class="bodytext3">Purchase</span></a></div></td>
             ...
             <?php
			  ...
			  ?>
			  <div align="center"> 
			  <a href="purchaseorderdelete1.php?task=delete&&anum=<?php echo $billautonumber; ?>" 

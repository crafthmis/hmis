...
//{
	...
	if ($printsource == '')
	{
		//$query22 = "select * from master_salesreturnpharmacy where auto_number = '$banum'";// and recordstatus <> 'DELETED' and companyanum = '$companyanum'";
		$query22 = "select * from master_salesreturnpharmacy where auto_number = '$billautonumber' and companyanum = '$companyanum'";// and financialyear = '$financialyear'";
	}
	if ($printsource == 'billpage')
	{
		//$query22 = "select * from master_salesreturnpharmacy where auto_number = '$banum'";// and recordstatus <> 'DELETED' and companyanum = '$companyanum'";
		$query22 = "select * from master_salesreturnpharmacy where billnumber = ".$_REQUEST["billnumber"]." and recordstatus <> 'DELETED' and companyanum = '$companyanum'";// and financialyear = '$financialyear'";
	}
	else if ($printsource == 'printselectionpage')
	{
		//$query22 = "select * from master_salesreturnpharmacy where billnumber = '$banum' and status <> 'CANCELLED' and companyanum = '$companyanum' and recordstatus <> 'DELETED'";
		$query22 = "select * from master_salesreturnpharmacy where billnumber = ".$_REQUEST["billnumber"]." and recordstatus <> 'DELETED' and companyanum = '$companyanum'";// and financialyear = '$financialyear'";
	}
...
$query2 = "select * from settings_billpharmacy where companyanum = '$companyanum'";
...
//$query21 = "select auto_number from master_salesreturnpharmacy where billnumber = '$banum' and companyanum = '$companyanum' and recordstatus <> 'DELETED'";
$query21 = "select auto_number from master_salesreturnpharmacy where auto_number = '$res22anum'";// and financialyear = '$financialyear'";// and recordstatus <> 'DELETED' and companyanum = '$companyanum'";
$exec21 = mysql_query($query21) or die ("Error in Query21".mysql_error());
$res21 = mysql_fetch_array($exec21);
$res21anum = $res21["auto_number"];

$query3 = "select * from master_salesreturnpharmacy where auto_number = '$res21anum' and companyanum = '$companyanum'";// and financialyear = '$financialyear'";
...
$dateofadmission = '';// = $res3["dateofadmission"];
/*
...
$dateofdischarge = '';// = $res3["dateofdischarge"];
/*
...
$discountexists = "";
$query4 = "select * from pharmacysalesreturn_details where bill_autonumber = '$billautonumber' and companyanum = '$companyanum'";// and financialyear = '$financialyear'";
$exec4 = mysql_query($query4) or die ("Error in Query4".mysql_error());
...
$query5 = "select * from master_customer where customercode = '$customercode'";
$exec5 = mysql_query($query5) or die ("Error in Query5".mysql_error());
$res5 = mysql_fetch_array($exec5);
$phonenumber1 = $res5['phonenumber1'];
$mobilenumber = $res5['mobilenumber'];
if ($phonenumber1 != '') $phonenumber1 = 'Phone: '.$phonenumber1;
if ($mobilenumber != '') $mobilenumber = 'Mobile: '.$mobilenumber;
  ...
  <tr>
	...
	?>
      <table width="99%" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
		<?php include ("print_showlogo1pharmacy.php"); ?>
          <td width="50%"><div align="center" class="style12">
		...
		?>
		  ...
		  <div class="style27">
		    <div align="right"><span class="style6"><?php //echo $title1; //Original Duplicate Etc. ?></span>&nbsp;&nbsp;</div>
		  </div>
		<div class="style27">
		    <div align="right"><span class="style6"><?php echo $f31; //$f15.' '.$billnumberprefix; ?></span>&nbsp;&nbsp;</div>
		  </div>
		<div class="style27">
		    <div align="right"><span class="style6"><?php echo $f32; //$f16.' '.$billdate; ?></span>&nbsp;&nbsp;</div>
		  </div>
		  	 <?php 
			 if ($billtype == 'CASH') 
			 {
			 ?>	  
		<div class="style27">
		    <div align="right"><span class="style6"><?php //echo $billtype.' BILL'; ?></span>&nbsp;&nbsp;</div>
		  </div>		  
	        <?php 
			  }
			  ?>		  </td>
    ...
    <tr>
      <td colspan="3"><table width="98%" border="0" cellspacing="0" cellpadding="0" class="sample">
        <tr>
          <td valign="top" width="62%"><table width="97%" border="0" align="left" cellpadding="0" cellspacing="0">
              <tr>
                <td><div align="left" class="style27"><span class="style6"> <?php echo 'Doctor Name : '.$doctorname; //$f13; ?></span></div>
                    <div align="left" class="style27"><span class="style6"> <font> <?php echo $f13.' : '.$f14.' '.$customername; ?></font></span></div>
                  <div align="left" class="style27"><span class="style6"> <?php //echo $address; ?></span></div>
                  <div align="left" class="style27"><span class="style6"> <?php //echo $location.' '.$city; ?></span></div>
				<?php
          ...
          <td width="38%" valign="top"><table width="97%" border="0" align="left" cellpadding="0" cellspacing="0">
              <tr>
                <td><?php
			if ($letterheadprinting == 'YES')
			{
			?>
                    <div align="left" class="style27"><span class="style6"><strong><?php //echo $f15.' '.$billnumberprefix.' / '.$f16.' '.$billdate; ?></strong></span></div>
			...
			//{
			?>
					<div align="left" class="style27"><span class="style6"> <?php echo $billtype.' '.$f15.' '.$billnumberprefix; ?></span></div>
					<div align="left" class="style27"><span class="style6"> <?php echo $f16.' '.$billdate; ?></span></div>
					<div align="left" class="style27"><span class="style6"> <?php //echo 'Date Of Discharge : '.$dateofdischarge; ?></span></div>
                  <?php
			//}
			?>                </td>
              </tr>
	...
	<?php
	if ($tinnumber != '' || $cstnumber != '' || $footerline1 != '' || $footerline2 != '' || $footerline3 != '' || $footerline4 != '')
	{
	?>
  ...
  <tr>
    <td colspan="3">
	  ...
	  <table width="98%" border="0" cellspacing="0" cellpadding="0" class="sample">
        <tr>
          <td width="50%" height="18"><div align="left" class="style27"><span class="style6">&nbsp;<?php echo $f17.' '.$tinnumber; ?></span></div><span class="style27">
          </span><span class="style27">
          </span></td>
          <td width="50%" valign="top"><div align="left" class="style27"><span class="style6">&nbsp;<?php echo $f20.' '.$cstnumber; ?></span></div></td>
        </tr>
      </table>
	  <table width="98%" border="0" cellspacing="0" cellpadding="0" class="sample">
      <tr>
        <td width="50%"><span class="style27"><span class="style6">&nbsp;<?php echo $f18.' '.$footerline1; ?></span></span><span class="style27"><br />
          <span class="style6">&nbsp;<?php echo $f19.' '.$footerline2; ?></span></span></td>
        <td width="50%"><span class="style27"><span class="style6">&nbsp;<?php echo $f21.' '.$footerline3; ?></span></span><span class="style27"><br />
      ...
      <thead>
        <tr>
         ...
         <td width="5%"><div align="left" class="style27">
		  ...
		  {
		  ?>
          <td width="11%"><div align="right" class="style27">
		...
		$query8 = "select * from master_itempharmacy where auto_number = '$itemanum'";
		...
		$batchnumber = $res4['batchnumber'];
		$expirydate = $res4['expirydate'];
		$expirydatemonth = substr($expirydate, 5, 2);
		...
		$query9 = "select * from pharmacysalesreturn_tax where  bill_autonumber = '$billautonumber' and itemanum = '$itemanum' and companyanum = '$companyanum'";// and financialyear = '$financialyear'";
		...
		{
		?>
		<td valign="top"><div align="right"><span class="style27">&nbsp;<?php echo $batchnumber; ?>&nbsp;</span></div></td>
		<?php
		}
		?>
 		<?php
		...
		{
		?>
       <td valign="top"><div align="right"><span class="style27">&nbsp;<?php echo $expirydate; ?>&nbsp;</span></div></td>
		<?php
		}
		?>
 		<?php
		...
		$tablemaxlines = 30 - $totaldescriptionlines;
		
		$query5 = "select * from master_salesreturnpharmacy where auto_number = '$res21anum' and recordstatus <> 'deleted'";// and financialyear = '$financialyear'";
		$exec5 = mysql_query($query5) or die ("Error in Query5".mysql_error());
		$res5 = mysql_fetch_array($exec5);
...
-->		
     ...
     <?php
		//$subtotalaftertax = $subtotalafterdiscountamount;
	  	...
	  	//$query6 = "select *, sum(taxamount) as sumtaxamount from pharmacysalesreturn_tax where bill_autonumber = '$res22anum' group by taxpercent order by auto_number";
	  	//$query6 = "select *, sum(taxamount) as sumtaxamount from pharmacysalesreturn_tax where bill_autonumber = '$billautonumber' and financialyear = '$financialyear' and recordstatus <> 'DELETED' group by tax_autonumber, taxname order by auto_number";
	  	$query6 = "select *, sum(taxamount) as sumtaxamount from pharmacysalesreturn_tax where bill_autonumber = '$billautonumber' and recordstatus <> 'DELETED' group by tax_autonumber, taxname order by auto_number";
		$exec6 = mysql_query($query6) or die ("Error in Query6".mysql_error());
		...
		//Tax is reworked because of bug in cummulative discount calculation and printing.
		if ($subtotaldiscounttotal != '')
		{
			$taxamount = $subtotalaftertax - $subtotalafterdiscountamount;
      ...
      <tr>
        <td height="21" colspan="<?php echo $columncount - 1; ?>" valign="top"><div align="left"><span class="style27"><?php echo $taxname.' : '.$taxamount; //.' @ '.$taxpercent.'%'; ?>&nbsp;</span></div></td>
...
-->	  
      ...
      <tr>
        <td height="21" colspan="<?php echo $columncount; ?>" valign="top"><div align="right"><span class="style27">
		<?php echo $f29; //'Delivery '.$deliverymode;//$f30; ?>&nbsp;</span></div></td>
        <td valign="top"><div align="right"><span class="style27">&nbsp;
		<?php echo $packaging; ?>&nbsp;</span></div></td>
      </tr>
	  <?php
	  }
	  ?>
...
-->	  
      <tr>
        <td height="21" colspan="<?php echo $columncount - 1; ?>" valign="top">
		<div align="left">
		<span class="style27"><?php echo 'Total Items : '.round($totalquantity, 4); ?>&nbsp;</span>
		<span class="style27">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
		<span class="style27">Prepared By:  &nbsp;<?php echo strtoupper($res3username); ?>&nbsp;</span>
		<span class="style27">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
		<span class="style27">Checked By:  &nbsp;</span>
		</div>
		</td>
        <td valign="top"><div align="right">
		<span class="style27">Total&nbsp;&nbsp;</span>
		</div>
		</td>
        <td valign="top"><div align="right">
		<span class="style27">&nbsp;<?php echo $totalamount; ?>&nbsp;</span>
		</div>
		</td>
      </tr>
      </thead>
...
<!--  
  <tr>
	...
	$convertedwords = covert_currency_to_words($totalamount); //function call
	
	$query72 = "select * from master_settings where companycode = '$res6companycode' and modulename = 'SALES' and 
	settingsname = 'AMOUNT_IN_WORDS_SALES_PRINT_SETTING'";
	$exec72 = mysql_query($query72) or die ("Error in Query72".mysql_error());
	$res72 = mysql_fetch_array($exec72);
	$salesamountinwordssettings1settings1 = $res72["settingsvalue"];
	if ($salesamountinwordssettings1settings1 == 'SALES AMOUNT IN WORDS AS BOLD TEXT')
	{
		echo '<strong>'.$convertedwords.'</strong>';
	}
	else
	{
		echo $convertedwords;
...
<!-- 
  <tr>
    ...
    <td width="319" colspan="2" valign="top">&nbsp;</td>
  </tr>
-->  
  <?php
  if ($billremarks != '')
  ...
  <tr>
    ...
    <td width="319" colspan="2" rowspan="4" valign="top"><table width="98%" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr>
        <td><div align="right">
            <table width="99%" border="0" align="left">
              <tr>
                <td><div align="right"><span class="style27"><b>
                  <?php //echo $f25; ?>
                </b></span></div></td>
              </tr>
            </table>

...
//{
	...
	if ($printsource == '')
	{
		...
		$query22 = "select * from master_purchase where auto_number = '$billautonumber' and companyanum = '$companyanum' and financialyear = '$financialyear'";
	}
	if ($printsource == 'billpage')
	{
		//$query22 = "select * from master_purchase where auto_number = '$banum'";// and recordstatus <> 'DELETED' and companyanum = '$companyanum'";
		$query22 = "select * from master_purchase where billnumber = ".$_REQUEST['billnumber']." and recordstatus <> 'DELETED' and companyanum = '$companyanum' and financialyear = '$financialyear'";
	}
...
$query3 = "select * from master_purchase where auto_number = '$res21anum' and companyanum = '$companyanum' and financialyear = '$financialyear'";
...
$discountexists = "";
$query4 = "select * from purchase_print_dump where bill_autonumber = '$billautonumber' and companyanum = '$companyanum' and financialyear = '$financialyear'";
$exec4 = mysql_query($query4) or die ("Error in Query4".mysql_error());
	...
	<table width="98%" border="1" align="left" cellpadding="0" cellspacing="0" frame="box" rules="groups" class="style27">
      ...
      <thead>
		...
		$varLimitRow = 24;
	  	...
	  	$query4 = "select * from purchase_print_dump where bill_autonumber = '$billautonumber' and companyanum = '$companyanum' and financialyear = '$financialyear' limit $varStartRow, $varLimitRow";
		$exec4 = mysql_query($query4) or die ("Error in Query4".mysql_error());
		while ($res4 = mysql_fetch_array($exec4))
		{
		...
		$query9 = "select * from purchase_tax where  bill_autonumber = '$billautonumber' and itemanum = '$itemanum' and companyanum = '$companyanum' and financialyear = '$financialyear'";
		...
		*/
		...
		$query5 = "select * from master_purchase where auto_number = '$res21anum' and financialyear = '$financialyear'";
     ...
     <tr>
      ...
      <?php
		//$subtotalaftertax = $subtotalafterdiscountamount;
	  	...
	  	$query6 = "select *, sum(taxamount) as sumtaxamount from purchase_tax where bill_autonumber = '$billautonumber' and financialyear = '$financialyear' and recordstatus <> 'DELETED' group by tax_autonumber, taxname order by auto_number";

...
if ($frmflag1 == 'frmflag1')
{
	...
	$tpaname = addslashes($tpaname);
	$openingbalance=$_REQUEST["openingbalance"];
		
	$query2 = "select * from master_tpa where tpacode = 'tpacode'";
	$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
	$res2 = mysql_num_rows($exec2);
	if ($res2 == 0)
	{
		$query1 = "insert into master_tpa (insurancecompany,tpacode,tpaname,openingbalance) 
		values('$insurancecompany', '$tpacode', '$tpaname', '$openingbalance')";
		...
		header("location:tpa.php?st=success");
		//header ("location:addcompany1.php?st=success&&cpynum=1");
	}
	else
	{
		header ("location:tpa.php?st=failed");
	}
...
if ($st == 'failed')
{
		$errmsg = "Failed. TPA Already Exists.";
}

$query2 = "select * from master_tpa order by auto_number desc limit 0, 1";
$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
$res2 = mysql_fetch_array($exec2);
$res2tpacode = $res2["tpacode"];
if ($res2tpacode == '')
{
	$tpacode = 'TPA00000001';
	$openingbalance = '0.00';
...
{
	$res2tpacode = $res2["tpacode"];
	$tpacode = substr($res2tpacode, 3, 8);
	$tpacode = intval($tpacode);
	$tpacode = $tpacode + 1;
...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top">
      	  ...
      	  <form name="form1" id="form1" method="post" onKeyDown="return disableEnterKey()" action="tpa.php" onSubmit="return from1submit1()">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="860"><table width="600" height="100" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
                <td bgcolor="#CCCCCC" class="bodytext3" colspan="2"><strong>TPA - New </strong></td>
             ...
             <tr>
              ...
              <!--<tr>
				...
				<tr>
                <td width="19%" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><span class="bodytext32">TPA Name   *</span></td>
                <td width="38%" align="left" valign="middle"  bgcolor="#E0E0E0"><input name="tpaname" id="tpaname" value="<?php echo $tpaname; ?>" style="border: 1px solid #001E6A;" size="40"></td>
                
				</tr>
			  <tr>
			   <td width="21%" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3">TPA Code   *</td>
                <td width="22%" align="left" valign="middle"  bgcolor="#E0E0E0"><input name="tpacode" id="tpacode" value="<?php echo $tpacode; ?>" readonly="readonly" style="border: 1px solid #001E6A;text-transform: uppercase; background-color:#CCCCCC" size="20"></td>
			  </tr>

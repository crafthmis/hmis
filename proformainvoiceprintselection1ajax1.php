...
$query5 = "TRUNCATE TABLE proformainvoice_print_dump";
$exec5 = mysql_query($query5) or die ("Error in Query5".mysql_error());

$query3 = "select * from master_proformainvoice where billnumber = '$billnumber' and companyanum = '$companyanum' and recordstatus <> 'DELETED'";
$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
$res3 = mysql_fetch_array($exec3);
//print_r($res3);
$res3anum = $res3['auto_number'];

$query4 = "select * from proformainvoice_details where bill_autonumber = '$res3anum' and recordstatus <> 'DELETED' and companyanum = '$companyanum' order by auto_number";
...
while ($res4 = mysql_fetch_array($exec4))
{
	...
	$query6 = "insert into proformainvoice_print_dump (serialnumber, bill_autonumber, companyanum, 
	...
	for ($i=0;$i<$itemdescriptionarraycount;$i++)
	{
		...
		$query7 = "insert into proformainvoice_print_dump (bill_autonumber, companyanum, itemdescription) 

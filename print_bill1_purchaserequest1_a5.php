...
//{
	...
	if ($printsource == '')
	{
		//$query22 = "select * from master_purchaserequest where auto_number = '$banum'";// and recordstatus <> 'DELETED' and companyanum = '$companyanum'";
		$query22 = "select * from master_purchaserequest where auto_number = '$billautonumber' and companyanum = '$companyanum'";
	}
	if ($printsource == 'billpage')
	{
		//$query22 = "select * from master_purchaserequest where auto_number = '$banum'";// and recordstatus <> 'DELETED' and companyanum = '$companyanum'";
		$query22 = "select * from master_purchaserequest where billnumber = ".$_REQUEST['billnumber']." and recordstatus <> 'DELETED' and companyanum = '$companyanum'";
	}
	else if ($printsource == 'printselectionpage')
	{
		//$query22 = "select * from master_purchaserequest where billnumber = '$banum' and status <> 'CANCELLED' and companyanum = '$companyanum' and recordstatus <> 'DELETED'";
		$query22 = "select * from master_purchaserequest where billnumber = ".$_REQUEST['billnumber']." and recordstatus <> 'DELETED' and companyanum = '$companyanum'";
	}
...
//$query21 = "select auto_number from master_purchaserequest where billnumber = '$banum' and companyanum = '$companyanum' and recordstatus <> 'DELETED'";
$query21 = "select auto_number from master_purchaserequest where auto_number = '$res22anum'";// and recordstatus <> 'DELETED' and companyanum = '$companyanum'";
$exec21 = mysql_query($query21) or die ("Error in Query21".mysql_error());
$res21 = mysql_fetch_array($exec21);
$res21anum = $res21['auto_number'];

$query3 = "select * from master_purchaserequest where auto_number = '$res21anum' and companyanum = '$companyanum'";
...
$discountexists = "";
$query4 = "select * from purchaserequest_details where bill_autonumber = '$billautonumber' and companyanum = '$companyanum'";
$exec4 = mysql_query($query4) or die ("Error in Query4".mysql_error());
...
<table width="660" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="4"><table width="98%" border="1" align="left" cellpadding="0" cellspacing="0" frame="box" rules="groups" class="sample">
      <colgroup span="1">
      </colgroup>
      <colgroup span="1">
      </colgroup>
      ...
      <thead>
        <tr>
          <td width="4%" height="21"><div align="left" class="style27">&nbsp;SN</div></td>
          <td width="75%"><div align="left" class="style27">&nbsp;Description&nbsp;</div></td>
      ...
      <?php
		...
		$query9 = "select * from purchaserequest_tax where  bill_autonumber = '$billautonumber' and itemanum = '$itemanum' and companyanum = '$companyanum'";
      ...
      <?php
		...
		$query5 = "select * from master_purchaserequest where auto_number = '$res21anum'";

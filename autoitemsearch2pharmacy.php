...
$searchresult = '';
	...
	if ($res100settingsvalue == 'GET PRICE FROM PREVIOUS INVOICE')
	{
		...
		$query101 = "select * from master_salespharmacy where customercode = '$customercode' and recordstatus <> 'deleted' and companyanum = '$companyanum' and financialyear = '$financialyear' order by billdate desc";
		...
		$query102 = "select * from pharmacysales_details where itemcode = '$itemcode' and bill_autonumber = '$res101billautonumber' and companyanum = '$companyanum' and financialyear = '$financialyear' and recordstatus <> 'deleted'";

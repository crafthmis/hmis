...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
  ...
  <tbody>
            ...
            <tr>
              <td colspan="18" align="left" valign="center" bordercolor="#f3f3f3" bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Sales Order  Report</strong></div></td>
            </tr>
            <tr>
			...
			*/
			...
			$query21 = "select sum(taxamount) as sumtaxamount from salesorder_tax where bill_autonumber = '$res2anum'  

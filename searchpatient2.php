...
$fp = fopen($foldername.'/PatientAddress.xls', 'w+');
fwrite($fp, $data);
fclose($fp);
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<form name="form1" id="form1" method="get" action="searchcustomer2.php" onSubmit="return process1()">
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            <tbody>
              ...
              <tr>
                ...
                bgcolor="#FFFFFF">Search Patient </td>
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            <tbody>
              ...
              <tr>
				...
				function excelexport1()
				{
					...
					window.location = "dbexcelfiles/PatientAddress.xls"
				}
				</script>&nbsp;</td>
			...
			if ($frmflag1 == 'frmflag1')
			{
			  $searchcustomer = $_REQUEST['searchcustomer'];
			  $status = $_REQUEST['status'];
			  $query2 = "select * from master_customer where customername like '%$searchcustomer%' and status like '%$status%'";
			}
			else
			{
			  $query2 = "select * from master_customer where status like '%$status%' order by customername desc limit 0, 200";
			}
			  $exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
			  while ($res2 = mysql_fetch_array($exec2))
			  {
              ...
              <tr <?php echo $colorcode; ?>>
                ...
                <div class="bodytext31">
                  <div align="left">
				  <strong><?php echo $res2customername; ?></strong><br>

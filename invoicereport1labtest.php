...
{
	window.location = "invoicereport1labtest.php";
}
    ...
    <td width="99%" valign="top"><table width="1498" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="1424">
              ...
              <form name="cbform1" method="get" action="invoicereport1labtest.php">
		<table width="916" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Lab Test Report List </strong></td>
...
--></td>
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><div align="left"><strong>SampleID</strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><div align="left"><strong>ReceivedDate</strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><div align="left"><strong>ReportedDate</strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><div align="left"><strong>ReferredBy</strong></div></td>
              <!--<td class="bodytext31" valign="center"  align="left" 
			...
			*/
			...
			$query2 = "select * from master_saleslabtest where customername like '%$customername%' and billnumber like '%$cbbillnumber%' and 
			...
			?>
              ...
              <td class="bodytext31" valign="center"  align="left"> 
			    <div align="left"><?php echo $receiveddate; ?>&nbsp;</div></td>
              <td class="bodytext31" valign="center"  align="left"> 
			    <div align="left"><?php echo $reporteddate; ?>&nbsp;</div></td>
              <td class="bodytext31" valign="center"  align="left"> 
			  ...
			  if ($res2financialyear == $_SESSION['financialyear'])
			  {
				...
				{
			  ?>
                  <a href="sales1labtest.php?delbillst=billedit&&delbillautonumber=<?php echo $billautonumber; ?>&&delbillnumber=<?php echo $billnumber; ?>" class="bodytext3" target="_blank"><span class="bodytext3">Edit</span></a>
              <?php
			  	}
			  }
			  }
             ...
             <?php
			  ...
			  ?>
			  <div align="center"> 
			  <a href="salesdelete1labtest.php?task=delete&&anum=<?php echo $billautonumber; ?>" 

...
{
//echo 'inside if';
$query41 = "select * from dccustomer_details where billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'deleted'";
...
$query42 = "select * from dccustomer_tax where itemcode = '$varItemCode' and billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'deleted'";
...
<td id="idTD3<?php echo $itemcount; ?>" align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3">
<input type="hidden" name="taxpercent<?php echo $itemcount; ?>" value="<?php echo $varItemTaxPercent; ?>" id="discountrupees<?php echo $itemcount; ?>" readonly="readonly" style="border: 0px solid #001E6A; text-align:right" size="3" />
...
$varItemDiscountPercent = $res41['itemdiscountpercentage'];
if ($varItemDiscountPercent == '') $varItemDiscountPercent = '0.00';
$varItemDiscountRupees = $res41['itemdiscountrupees'];
if ($varItemDiscountRupees == '') $varItemDiscountRupees = '0.00';

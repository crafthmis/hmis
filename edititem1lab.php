...
if ($frmflag1 == 'frmflag1')
{
	...
	$query1 = "update master_itemlab set unitname_abbreviation = '$unitname_abbreviation', taxanum = '$taxanum',  
...
if ($sanum != '')
{
	$query2 = "select * from master_itemlab where auto_number = '$sanum'";
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="edititem1lab.php?sanum=<?php echo $sanum; ?>" onSubmit="return edititem1process1()">
                  <table width="800" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Lab Item Master - Edit </strong></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top"  bgcolor="#FFFFFF">
						  <textarea name="itemname" cols="60" id="itemname" style="border: 1px solid #001E6A" onKeyDown="return process1backkeypress1()"><?php echo htmlentities($itemname); ?></textarea></td>
                      </tr>
                      <tr>
                        <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="left">Select Unit Name  </div></td>
                        <td align="left" valign="top"  bgcolor="#FFFFFF">
						<input name="unitname_abbreviation" type="text" id="unitname_abbreviation" value="<?php echo $unitname_abbreviation; ?>" size="20" style="border: 1px solid #001E6A">
<!--						
...
-->						</td>
                      ...
                      <tr>
                        <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="left">Charge  Price  Per Unit </div></td>
                        <td align="left" valign="top"  bgcolor="#FFFFFF"><input name="rateperunit" id="rateperunit" value="<?php echo $rateperunit; ?>" style="border: 1px solid #001E6A" size="20" />
                          <input type="hidden" name="purchaseprice" id="purchaseprice" value="<?php echo $purchaseprice; ?>" style="border: 1px solid #001E6A" size="20" /></td>
                      </tr>
                      
                      <tr>
                        <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><div align="left">Lab Item Reference Value (Optional) </div></td>
                        <td align="left" valign="top"  bgcolor="#FFFFFF"><textarea name="referencevalue" cols="60" id="referencevalue" style="border: 1px solid #001E6A"><?php echo $referencevalue; ?></textarea>
...
-->					  
                      ...
                      <tr>
                        <td width="28%" align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3"><div align="left"></div></td>
                        <td width="72%" align="left" valign="top"  bgcolor="#FFFFFF"><input type="hidden" name="frmflag" value="addnew" />

...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
  ...
  <tbody>
            ...
            <tr>
			  ...
			  <div align="center"><strong>Collection Received Report</strong></div></td>
            </tr>
            <tr>
		  ...
		  $query2 = "select * from master_transaction where customername like '%$customername%' and recordstatus <> 'DELETED' and supplieranum = '0' and suppliername = '' and companyanum = '$companyanum' and transactiondate between '$paymentreceiveddatefrom' and '$paymentreceiveddateto' and transactiontype = 'COLLECTION' order by transactiondate desc";
		  ...
		  if ($writeoffamount != '0.00') { $paymentamount = $writeoffamount; }
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td align="left" valign="center" bordercolor="#f3f3f3" bgcolor="#FFFFFF" class="bodytext31"><div align="left"><?php echo $customername; ?></div></td>

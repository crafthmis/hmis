	...
	<table width="98%" border="1" align="left" cellpadding="0" cellspacing="0" frame="box" rules="groups" class="sample">
      ...
      <thead>
        <tr>
          ...
          <td width="52%"><div align="left" class="style27">&nbsp;Description&nbsp;</div></td>
          <td width="16%"><div align="right" class="style27">
              <div align="center">Result Values&nbsp;</div>
          </div></td>
          <td width="16%"><div align="center">Normal Values&nbsp;</div></td>
		...
		$normalvalue = $res4["normalvalue"];
		$testunit = $res4["testunit"];
		
		$itemanum = $res4["itemanum"];
		$query8 = "select * from master_itemlabtest where auto_number = '$itemanum'";
        ...
        <td valign="top"><div align="center"><span class="style27">&nbsp;<?php echo $normalvalue; ?>&nbsp;</span></div></td>

...
$query1 = "select * from master_transactionhospital where transactiontype = 'COLLECTION' and transactionmodule = 'COLLECTION' and recordstatus <> 'DELETED' and companyanum = '$companyanum' order by auto_number desc";
...
if ($receiptanum != '')
{
	$query21 = "select * from master_transactionhospital where auto_number = '$receiptanum'";
}
else
{
...
$vouchernumber = $res21['vouchernumber'];
	...
	?>
      <table width="99%" border="0" align="left" cellpadding="0" cellspacing="0">
		...
		<?php include ("print_showlogo1hospital.php"); ?>
		  ...
		  <div class="style27">
		    <div align="right"><span class="style6"><strong><?php echo 'Hospital'; //$title1; ?></strong></span>&nbsp;&nbsp;</div>
		  </div></td>
        </tr>
      </table>
	  <?php
    ...
    <td colspan="2"  valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="38%" valign="top"><table width="92%" border="0" align="right" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td><span class="style6"><?php echo 'Voucher No : '.$vouchernumber; ?></span></td>
          </tr>
        </table></td>
      </tr>
    </table></td>

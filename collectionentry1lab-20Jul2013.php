...
if ($frmflag2 == 'frmflag2')
{
	...
	header ("location:collectionentry1lab.php?st=1");
	exit;
...
if ($st == '1')
{
	$errmsg = "Success. Lab Collection Entry Update Completed.";
}
if ($st == '2')
{
	$errmsg = "Failed. Lab Collection Entry Not Completed.";
}
...
function paymententry1process1()
{
	...
	if (fRet == true)
	{
		...
		if (varCollectionAmount > varPendingAmount)
		{
			...
			alert ("Lab Collection Entry Not Completed.");
			return false;
		}
		*/
	}
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="4" bgcolor="#CCCCCC" class="bodytext3"><strong>Lab Collection Entry     - Select Patient </strong></td>
              </tr>
            <tr>
              <td colspan="4" align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><span class="bodytext32">
              <input name="printreceipt1" type="reset" id="printreceipt1" onClick="return funcPrintReceipt1()" style="border: 1px solid #001E6A" value="Print Receipt - Previous Lab Collection Entry" />
      ...
      <tr>
        <td>
			  ...
			  <table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                <tbody>
                  <tr bgcolor="#011E6A">
                    <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Lab Collection Entry - Details </strong></td>

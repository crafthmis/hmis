...
$query90 = "select count(auto_number) as masterscount from master_categoryhospital";
...
if ($res90count == 0)
{
	header ("location:addcategory1hospital.php?svccount=firstentry");
}


//to redirect if there is no entry in masters category or item or customer.
$query90 = "select count(auto_number) as masterscount from master_itemhospital";
$exec90 = mysql_query($query90) or die ("Error in Query90".mysql_error());
$res90 = mysql_fetch_array($exec90);
$res90count = $res90["masterscount"];
if ($res90count == 0)
{
	header ("location:additem1hospital.php?svccount=firstentry");
	exit;
}
...
if ($res91count == 0)
{
	header ("location:settingsbill1hospital.php?svccount=firstentry");
	exit;
}
...
include ("autocompletebuild_item1hospital.php");
...
$query88 = "select count(auto_number) as cntanum from master_saleshospital";// where lastupdate like '$thismonth%'";
...
if ($frm1submit1 == 'frm1submit1')
{
	...
	{
		//$query19 = "select auto_number,lastupdate from master_saleshospital where auto_number = '$delbillautonumber' and billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'DELETED'";
		$query19 = "select auto_number,lastupdate from master_saleshospital where billnumber = '$delbillnumber' and companyanum = '$companyanum' and financialyear = '$financialyear'";
		...
		while ($res19 = mysql_fetch_array($exec19))
		{
			...
			//$query15 = "update master_saleshospital set recordstatus = 'DELETED' where auto_number = '$res19anum' and companyanum = '$companyanum'";
			$query15 = "update master_saleshospital set recordstatus = 'DELETED' where billnumber = '$delbillnumber' and companyanum = '$companyanum' and financialyear = '$financialyear'";
			$exec15 = mysql_query($query15) or die ("Error in Query15".mysql_error());
		
			//$query16 = "update hospitalsales_details set recordstatus = 'DELETED' where bill_autonumber = '$res19anum' and companyanum = '$companyanum'";
			$query16 = "update hospitalsales_details set recordstatus = 'DELETED' where billnumber = '$delbillnumber' and companyanum = '$companyanum' and financialyear = '$financialyear'";
			$exec16 = mysql_query($query16) or die ("Error in Query16".mysql_error());
		
			//$query17 = "update hospitalsales_tax set recordstatus = 'DELETED' where bill_autonumber = '$res19anum' and companyanum = '$companyanum'";
			$query17 = "update hospitalsales_tax set recordstatus = 'DELETED' where billnumber = '$delbillnumber' and companyanum = '$companyanum' and financialyear = '$financialyear'";
			$exec17 = mysql_query($query17) or die ("Error in Query17".mysql_error());
		
			//$query18 = "update master_transactionhospital set recordstatus = 'DELETED' where billanum = '$res19anum' and companyanum = '$companyanum'";
			$query18 = "update master_transactionhospital set recordstatus = 'DELETED' where billnumber = '$delbillnumber' and companyanum = '$companyanum' and financialyear = '$financialyear'";
...
include ("sales1include1hospital.php"); //handles all the sales insert operations
...
if ($delbillst == 'billedit' && $delbillnumber != '')
{
	$query41 = "select * from master_saleshospital where billnumber = '$delbillnumber' and companyanum = '$companyanum' and financialyear = '$financialyear' and recordstatus <> 'deleted'";
...
<script type="text/javascript" src="js/autosuggest4.js"></script> <!-- For searching customer -->
<script type="text/javascript" src="js/autocomplete_customer1.js"></script>
<script type="text/javascript" src="js/autocustomercodesearch2.js"></script>
<script type="text/javascript" src="js/autocustomercodesearch3.js"></script>

<script type="text/javascript" src="js/autosuggest2item.js"></script>
<script type="text/javascript" src="js/autocomplete_item1hospital.js"></script> <!-- Drop Down List Holding File -->
<script type="text/javascript" src="js/autocomplete_itemsearch1.js"></script>
<script type="text/javascript" src="js/autocomplete_itemsearch3hospital.js"></script> <!-- For mouse click event of item name drop down list. -->
<script type="text/javascript" src="js/autoitemsearch3hospital.js"></script> <!-- For enter key selection and mouse click event of item name drop down list. -->
...
function funcPopupPrintFunctionCall()
{
	...
	{
	$query1print = "select * from master_printer_hospital where defaultstatus = 'default' and status <> 'deleted'";
...
function funcDefaultTax1() //Function to CST Taxes if required.
{
	...
	if (varDefaultTax != "")
	{
		...
		{
		?>
		window.location="sales1hospital.php?defaulttax="+varDefaultTax+"&&delbillst=<?php echo $delBillSt; ?>&&delbillautonumber="+<?php echo $delBillAutonumber; ?>+"&&delbillnumber="+<?php echo $delBillNumber; ?>+"";
		<?php
		}
		else
		{
		?>
		window.location="sales1hospital.php?defaulttax="+varDefaultTax+"";
		<?php
		}
		?>
	}
	...
	{
		window.location="sales1hospital.php";
	}
	//return false;
}
...
//Working Perfectly as stand alone.
//http://www.webdeveloper.com/forum/showthread.php?250339-Clicked-element-Id
/*
...
<form name="frmsales" id="frmsales" method="post" action="sales1hospital.php" onKeyDown="return disableEnterKey(event)">
    ...
    <td width="99%" valign="top"><table width="980" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
                <td bgcolor="#CCCCCC" class="bodytext3"><strong>Hospital Invoice </strong></td>
	...
	//$delBillSt = $_REQUEST["delbillst"];
			  ...
			  <tr>
                ...
                <td align="left" valign="top" >
                    ...
                    <div align="left"><span class="style4">PT. Code</span></div></td>
                <td align="left" valign="top" >
				<input name="customercode" id="customercode" value="<?php echo $res41customercode; ?>" style="border: 1px solid #001E6A" readonly="readonly" size="12" rsize="20" /></td>
                <td width="9%" align="left" valign="middle"  bgcolor="#E0E0E0"  class="bodytext3"><strong>Doctor Name </strong></td>
                <td width="28%" align="left" valign="top" >
                  <!--<textarea name="deliveryaddress" cols="25" rows="3" id="deliveryaddress" style="border: 1px solid #001E6A"><?php //echo $res41deliveryaddress; ?></textarea>-->				  <span class="bodytext3">
				...
				else
				{
					...
					//echo '<option value="">Select Normal Tax</option>';
					echo '<option value="'.$res51doctorname.'" selected="selected">'.$res51doctorname.'</option>';
				}
				...
				?>
                    <option value="<?php echo $res5doctorname; ?>"><?php echo $res5doctorname; ?></option>
                    <?php
				}
				?>
                  </select>
			  ...
			  <tr>
			    ...
			    <td align="left" valign="top" ><span class="bodytext3"><strong>Admission</strong></span></td>
			    <td align="left" valign="top" ><span class="bodytext3"><strong>
			      ...
			      <input name="dateofadmission" id="dateofadmission" style="border: 1px solid #001E6A" value="<?php //echo $dateonly; ?>"  size="8"  readonly="readonly" onKeyDown="return disableEnterKey()" />
                  <img src="images2/cal.gif" onClick="javascript:NewCssCal('dateofadmission')" style="cursor:pointer"/> </span></strong></span></td>
				  <td align="left" valign="top" >
                  
                    <div align="left"><span class="style4">Registration Date</span></div></td>
                <td align="left" valign="top" >
				<input name="registrationdate" id="registrationdate" value="" style="border: 1px solid #001E6A" readonly="readonly" size="12" rsize="20" /></td>
			  ...
			  <tr>
			    ...
			    <td align="left" valign="top" >
			      <input name="city1" id="city1" value="<?php echo $res41city; ?>" style="border: 1px solid #001E6A;text-transform: uppercase;"  size="10" /> 
			    <span class="bodytext3"><strong>Pincode</strong></span>
			      <input name="pincode" id="pincode" value="<?php echo $res41pincode; ?>" style="border: 1px solid #001E6A;text-transform: uppercase;" size="10" /></td>
				  <td align="left" valign="top" ><span class="bodytext3"><strong>Discharge</strong></span></td>
			      <td align="left" valign="top" ><span class="bodytext3"><strong>
			      <input type="hidden" name="customercst" id="customercst" value="<?php echo $res41cstnumber; ?>" style="border: 1px solid #001E6A"  size="12" />
			      <span class="bodytext312">
			      <input name="dateofdischarge" id="dateofdischarge" style="border: 1px solid #001E6A" value="<?php //echo $dateonly; ?>"  size="8"  readonly="readonly" onKeyDown="return disableEnterKey()" />
                  <img src="images2/cal.gif" onClick="javascript:NewCssCal('dateofdischarge')" style="cursor:pointer"/> </span></strong></span></td>
				  
				  <td align="left" valign="top" >
                    <div align="left"><span class="style4">Consultation Fee</span></div></td>
                <td align="left" valign="top" >
				<input name="consultationfees" id="consultationfees" value="" style="border: 1px solid #001E6A" readonly="readonly" size="12" rsize="20" /></td>
			  ...
			  <tr>
			    <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><div align="left"><strong>Insurance Company</strong>&nbsp;&nbsp;</div></td>
			    <td align="left" valign="top" >
			      <input name="insurancecompany" id="insurancecompany" value="" style="border: 1px solid #001E6A;text-transform: uppercase;"  size="10" /> 
			    <span class="bodytext3"><strong>TPA</strong></span>
			    <input name="tpa" id="tpa" value="" style="border: 1px solid #001E6A;text-transform: uppercase;" size="10" /></td>
				  </tr>
		...
		<table id="newtable" style="BORDER-COLLAPSE: collapse" 
            ...
            <tbody id="tblrowinsert">
              <tr>
                ...
                <td width="7%" align="left" valign="center"  
                bgcolor="#FFCC00" class="bodytext31"><span class="bodytext311"><strong>ReverseTax</strong></span></td>
              </tr>
				<?php
				$itemcount = "";
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
            <tr>
              ...
              <td width="6%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
			  <input onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemmrp" onFocus="javascript:this.select()" value="0.00" id="itemmrp" style="border: 1px solid #001E6A; text-align:right" size="6" /></td>
              <td width="4%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
			  <input onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemquantity" onFocus="javascript:this.select()" value="1" id="itemquantity" autocomplete="off" style="border: 1px solid #001E6A; text-align:right" size="4" /></td>
              <td width="6%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
			  <input onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemdiscountpercent" onFocus="javascript:this.select()" value="0.00" id="itemdiscountpercent" style="border: 1px solid #001E6A; text-align:right" size="2" /></td>
              <td width="6%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
			  <input onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemdiscountrupees" onFocus="javascript:this.select()" value="0.00" id="itemdiscountrupees" style="border: 1px solid #001E6A; text-align:right" size="3" /></td>
              <td width="6%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><span class="bodytext311">
              <input onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemtaxpercent" onFocus="javascript:this.select()" value="0.00" id="itemtaxpercent" readonly="readonly" style="border: 1px solid #001E6A; text-align:right" size="3" />
              ...
              <td width="18%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><span class="bodytext311">
                <input name="itemreversetax" value="0.00" id="itemreversetax" onFocus="javascript:this.select()" onBlur="return funcTaxReverseCalc2()" style="border: 1px solid #001E6A; text-align:right" size="5" />
              </span></td>
            </tr>
            <tr>
              <td colspan="2" align="left" valign="center"  bgcolor="#FFFFFF" class="bodytext31"><div align="right"><strong>Description</strong></div></td>
              <td colspan="10" align="left" valign="center"  bgcolor="#FFFFFF" class="bodytext31"><strong>
...
-->					
              ...
              <tr>
				...
				<strong>Round Off <?php //echo $f29; ?></strong></div></td>
                <td align="left" valign="top" >
              ...
              <tr>
                ...
                bgcolor="#F3F3F3"  class="bodytext31" id="tdShowCustomerBalanceAmount1">
				<!--<div align="right"><strong><?php //echo $f30; ?></strong></div>-->
				<div align="right"><strong>(  Should Equal With Nett  Amount ) Total Amount </strong></div>				</td>
              ...
              <tr>
                ...
                bgcolor="#F3F3F3">&nbsp;</td>
                <td align="left" valign="center"  
                bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong>Advance Amount Paid </strong></div></td>
                <td align="left" valign="top" >
				<input name="advanceamountpaid" type="text" id="advanceamountpaid" style="border: 1px solid #001E6A; text-align:right" onKeyDown="return disableEnterKey()" value="0.00" size="8" readonly="readonly">
				</td>
              </tr>
              <tr>
                <td align="left" valign="center"  
                ...
                bgcolor="#F3F3F3" class="bodytext31">&nbsp;</td>
                <td align="left" valign="center"  
                bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong>*Balance After Advance </strong></div></td>
                <td align="left" valign="top" ><input name="balanceafteradvance" type="text" id="balanceafteradvance" style="border: 1px solid #001E6A; text-align:right" onKeyDown="return disableEnterKey()" value="0.00" size="8" readonly="readonly"></td>
              </tr>
              <tr>
                <td align="left" valign="center"  
bgcolor="#F3F3F3" class="bodytext31">&nbsp;</td>
...
bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong>Credit Amount </strong></div></td>
			  ...
			  <tr id="insuranceamounttr">
                <td colspan="7" align="left" valign="center"  
bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong>Insurance Amount </strong></div></td>
                <td align="left" valign="top" ><span class="bodytext31">
                  <input name="insuranceamount" id="insuranceamount" onBlur="return funcbillamountcalc1()" value="0.00" style="border: 1px solid #001E6A; text-align:right" size="8"  readonly="readonly" />
                </span></td>
              </tr>
...
bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong>Online Amount </strong></div></td>
                <td align="left" valign="top" ><span class="bodytext31">
                  <input name="onlineamount" id="onlineamount" onBlur="return funcbillamountcalc2()" value="0.00" style="border: 1px solid #001E6A; text-align:right" size="8" readonly="readonly" />
                </span></td>
              </tr>
              ...
              <tr>
                ...
                bgcolor="#CCCCCC" class="bodytext31"><div align="right"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
                  ...
                  <input name="delbillnumber" id="delbillnumber" type="hidden" value="<?php echo $delbillnumber;?>">
					<input name="pageidentificationcontrol" id="pageidentificationcontrol" type="hidden" value="hospitalsalesentry">
				  <input name="Submit2223" type="button" onClick="return funcSaveBill1()" value="Save Bill" accesskey="b" class="button" style="border: 1px solid #001E6A"/>
      ...
      <tr>
        <td><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            ...
            <tr>
              <td colspan="2" align="left" valign="top" class="bodytext31">
			  *Please Note : If Advance Amount Given, Invoice Need To Be Saved As Credit &amp; Collection Entry To Be Made At Hospital Collection Entry Page.
			  </td>

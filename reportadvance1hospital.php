    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="reportadvance1hospital.php">
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="1179" 
            align="left" border="0">
          <tbody>
            <tr>
...
-->
            ...
            <tr>
              ...
              <td width="6%" align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Advance</strong></div></td>
		  ...
		  $advancedate = $res2['transactiondate'];
		  $advancedate = substr($advancedate, 0, 10);
		  ...
		  $transactionamount = $res2['transactionamount'];
			...
			$advanceremarks = $res2['advanceremarks'];
           ...
           <tr <?php echo $colorcode; ?>>
			 ...
			 <a href="#" class="bodytext31" onClick="return funcPrintReceipt1('<?php echo $receiptanum; ?>')">Print</a></div>			 </td>
              ...
              <td  align="left" valign="center" class="bodytext31">
			    <div align="left"><?php echo $res3city; ?></div></td>
              <td class="bodytext31" valign="center"  align="left">
			    <div align="right"><?php echo $totalamount; ?></div></td>
              <td class="bodytext31" valign="center"  align="left">
			  <div align="right"><?php echo $advancedate; ?></div></td>
              <td class="bodytext31" valign="center"  align="left">
			  <div align="left"><?php echo $paymentmode; ?></div></td>
              <td class="bodytext31" valign="center"  align="left">
			  <div align="left"><?php echo $advanceremarks; ?></div></td>

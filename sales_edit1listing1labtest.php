...
{
//echo 'inside if';
$query41 = "select * from labtestsales_details where billnumber = '$delbillnumber' and companyanum = '$companyanum' and financialyear = '$financialyear' and recordstatus <> 'deleted'";
...
$query77="select * from master_itemlab where itemcode='$varItemCode'";
$exec77=mysql_query($query77) or die(mysql_error());
$res77=mysql_fetch_array($exec77);
$itemunit=$res77['unitname_abbreviation'];
$itemrefervalue=$res77['referencevalue'];
...
$query42 = "select * from labtestsales_tax where itemcode = '$varItemCode' and billnumber = '$delbillnumber' and companyanum = '$companyanum' and financialyear = '$financialyear' and recordstatus <> 'deleted'";
...
$varResultValue = $res41["resultvalue"];
$varTestUnit = $res41["testunit"];
$varReferenceValue = $res41["referencevalue"];
...
<input name="itemcode<?php echo $itemcount; ?>" value="<?php echo $varItemCode; ?>" id="itemcode<?php echo $itemcount; ?>" style="border: 0px solid #001E6A; text-align:left" size="8" readonly="readonly" />
</td>
<td id="idTD3<?php echo $itemcount; ?>" align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3">
<input name="itemname<?php echo $itemcount; ?>" value="<?php echo $varItemName; ?>" size="40" id="itemname<?php echo $itemcount; ?>" style="border: 0px solid #001E6A; text-align:left" readonly="readonly" />
</td>
<td id="idTD3<?php echo $itemcount; ?>" align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3">
<input type="text" name="resultvalue<?php echo $itemcount; ?>" value="<?php echo $varResultValue; ?>" id="resultvalue<?php echo $itemcount; ?>" style="border: 1px solid #001E6A;" size="8" />
</td>
<td id="idTD3<?php echo $itemcount; ?>" align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3">
<input type="hidden" name="rateperunit<?php echo $itemcount; ?>" value="<?php echo $varItemMRP; ?>" id="rateperunit<?php echo $itemcount; ?>" readonly="readonly" style="border: 0px solid #001E6A; text-align:right" size="6" />
</td>
<td id="idTD3<?php echo $itemcount; ?>" align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3">
<input type="hidden" name="quantity<?php echo $itemcount; ?>" value="<?php echo $varItemQuantity; ?>" id="quantity<?php echo $itemcount; ?>" readonly="readonly" style="border: 0px solid #001E6A; text-align:right" size="4" />
<input type="text" name="testunit<?php echo $itemcount; ?>" value="<?php echo $itemunit; ?>" id="testunit<?php echo $itemcount; ?>" readonly="readonly" style="border: 0px solid #001E6A; text-align:right" size="4" />
</td>
<td id="idTD3<?php echo $itemcount; ?>" align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3">
  <textarea name="referencevalue<?php echo $itemcount; ?>" cols="20" rows="1" readonly="readonly" id="referencevalue<?php echo $itemcount; ?>" style="border: 0px solid #001E6A; text-align:left"><?php echo $itemrefervalue; ?></textarea>
...
<td id="idTD3<?php echo $itemcount; ?>" align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3">
<input type="hidden" name="totalamount<?php echo $itemcount; ?>" value="<?php echo $varItemTotalAmount; ?>" id="totalamount<?php echo $itemcount; ?>" readonly="readonly" style="border: 0px solid #001E6A; text-align:right" size="8" />
</td>
...
<?php echo nl2br($varItemDescription); ?></textarea>
</td>
...
if ($delbillst == 'billimport' && $delbillnumber != '')
{
//echo 'inside if';
$query41 = "select * from labsales_details where billnumber = '$delbillnumber' and companyanum = '$companyanum' and financialyear = '$financialyear' and recordstatus <> 'deleted'";
$exec41 = mysql_query($query41) or die ("Error in Query41".mysql_error());
while ($res41 = mysql_fetch_array($exec41))
{
$itemcount = $itemcount + 1;

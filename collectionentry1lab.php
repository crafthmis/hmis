...
if ($frmflag2 == 'frmflag2')
{
	...
	$query81 = "select auto_number from master_saleslab where billnumber = '$billnumber' and companyanum = '$companyanum' and recordstatus <> 'deleted'";
	...
	include ("transactioncodegenerate1lab.php");
	...
	$query9 = "insert into master_transactionlab (transactioncode, transactiondate, particulars, customeranum, customername, 
	...
	//$query21 = "select * from master_transactionlab where transactiontype = 'COLLECTION' and transactionmodule = 'COLLECTION' and recordstatus <> 'DELETED' and companyanum = '$companyanum' order by auto_number desc";
	$query21 = "select * from master_transactionlab where transactiontype = 'COLLECTION' and transactionmodule = 'COLLECTION' and companyanum = '$companyanum' order by auto_number desc";
	...
	$query23 = "update master_transactionlab set collectionnumber = '$collectionreceiptnumber' where transactioncode = '$transactioncode'";
	$exec23 = mysql_query($query23) or die ("Error in Query23".mysql_error());
	
	
	header ("location:collectionentry1lab.php?st=1&&transactioncode=$transactioncode");
	exit;
...
function funcPrintReceipt1()
{
	...
	window.open("print_collection_receipt1lab.php","OriginalWindow<?php echo $banum; ?>",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
}
    ...
    <td width="97%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="collectionentry1lab.php">
...
*/
			...
			$query2 = "select * from master_transactionlab where customeranum = '$customeranum' and recordstatus = '' group by customeranum";// and approvalstatus =  'APPROVED' and cstid='$custid' and cstname='$custname'";//  order by transactiondate desc";
			$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
			...
			$query3 = "select * from master_transactionlab where transactiontype = 'SALES' and customeranum = '$res2anum' and recordstatus = ''";// and approvalstatus =  'APPROVED' and cstid='$custid' and cstname='$custname'";
			...
			$query3 = "select * from master_transactionlab where transactiontype = 'COLLECTION' and customeranum = '$res2anum' and recordstatus = ''";// and approvalstatus =  'APPROVED' and cstid='$custid' and cstname='$custname'";
			$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
			while ($res3 = mysql_fetch_array($exec3))
			{
...
*/
			...
			$query2 = "select * from master_transactionlab where customeranum = '$customeranum' and transactionmodule = 'SALES RETURN' and recordstatus = '' group by customeranum";// and cstid='$custid' and cstname='$custname'";//  order by transactiondate desc";
			$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
			while ($res2 = mysql_fetch_array($exec2))
			{
			$res2anum = $res2['customeranum'];
			...
			$query3 = "select * from master_transactionlab where transactiontype = 'SALES RETURN' and transactionmodule = 'SALES RETURN' and customeranum = '$res2anum' and recordstatus = ''";// and cstid='$custid' and cstname='$custname'";
			$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
			while ($res3 = mysql_fetch_array($exec3))
			{
				$transactionamount = $res3['transactionamount'];
			...
			$query3 = "select * from master_transactionlab where transactiontype = 'PAYMENT' and transactionmodule = 'SALES RETURN' and customeranum = '$res2anum' and recordstatus = ''";// and cstid='$custid' and cstname='$custname'";
			$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
			while ($res3 = mysql_fetch_array($exec3))
			{
				$cashamount1 = $res3['cashamount'];
...
-->		
      ...
      <tr>
        <td>
				...
				<form name="form1" id="form1" method="post" action="collectionentry1lab.php?cbfrmflag1=<?php echo $cbfrmflag1; ?>" onSubmit="return paymententry1process1()">
			  <table width="800" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                <tbody>
                  <tr bgcolor="#011E6A">

...
$query88 = "select count(auto_number) as cntanum from master_purchaserequest where lastupdate like '$thismonth%'";
...
if ($frm1submit1 == 'frm1submit1')
{
	...
	{
		$query19 = "select auto_number,lastupdate from master_purchaserequest where auto_number = '$delbillautonumber' and billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'DELETED'";
		...
		while ($res19 = mysql_fetch_array($exec19))
		{
			...
			$query15 = "update master_purchaserequest set recordstatus = 'DELETED' where auto_number = '$res19anum' and companyanum = '$companyanum'";
			$exec15 = mysql_query($query15) or die ("Error in Query15".mysql_error());
		
			$query16 = "update purchaserequest_details set recordstatus = 'DELETED' where bill_autonumber = '$res19anum' and companyanum = '$companyanum'";
			$exec16 = mysql_query($query16) or die ("Error in Query16".mysql_error());
		
			$query17 = "update purchaserequest_tax set recordstatus = 'DELETED' where bill_autonumber = '$res19anum' and companyanum = '$companyanum'";
			...
			*/
			$query20="update master_stock set recordstatus='DELETED' where transactionmodule = 'DC SUPPLIER' and billnumber = '$delbillnumber' and companyanum = '$companyanum'";
...
include ("purchaserequest1include1.php"); //handles all the purchase insert operations
...
<?php include ("js/dcsupplier1scripting1.php"); ?>
...
<script type="text/javascript" src="js/purchaserequestnovalidation1.js"></script>
...
function funcOnLoadBodyFunctionCall()
{
	...
	{
	?>
		//quickprintbill1purchaserequest();
	<?php
	}
...
<form name="frmpurchase" id="frmpurchase" method="post" action="purchaserequest1.php" onKeyDown="return disableEnterKey(event)">
    ...
    <td width="99%" valign="top"><table width="950" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="100%"><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
                <td bgcolor="#CCCCCC" class="bodytext3"><strong>Purchase Request </strong></td>
                ...
                <td width="6%" bgcolor="#CCCCCC" class="bodytext3"><strong>Bill Date </strong></td>
                <td width="13%" bgcolor="#CCCCCC" class="bodytext3">
			  ...
			  <tr>
				...
				<input name="supplier" id="supplier" style="border: 1px solid #001E6A; text-transform:uppercase" value="<?php echo $res41suppliername; ?>" size="40" autocomplete="off"/>
                ...
                <td align="left" valign="top" ><span class="bodytext3">
                  <input name="suppliercode" id="suppliercode" style="border: 1px solid #001E6A" value="<?php echo $res41suppliercode; ?>" size="10" readonly="readonly" rsize="20" />
                </span></td>
                <td width="8%" align="left" valign="middle"  bgcolor="#E0E0E0"  class="bodytext3"><strong>Delivery</strong></td>
			  ...
			  <tr>
			    ...
			    <td align="left" valign="top" >
				<input name="address1" id="address1" style="border: 1px solid #001E6A;text-transform: uppercase;" value="<?php echo $res41area; ?>" size="30" />
			      <span class="style4">Area </span>
			      <input name="area" id="area" style="border: 1px solid #001E6A;text-transform: uppercase;" value="<?php //echo $area; ?>"  size="10" /></td>
			    ...
			    <td align="left" valign="top" ><span class="bodytext3"><strong>
			      <input name="suppliertin" id="suppliertin" style="border: 1px solid #001E6A" value="<?php echo $res41tinnumber; ?>"  size="10" />
			    </strong></span></td>
			  ...
			  <tr>
			    ...
			    <td align="left" valign="top" ><span class="bodytext3"><strong>
			      <input name="suppliercst" id="suppliercst" style="border: 1px solid #001E6A" value="<?php echo $res41cstnumber; ?>"  size="10" />
			    </strong></span></td>
		...
		<table id="newtable" style="BORDER-COLLAPSE: collapse" 
            ...
            <tbody id="tblrowinsert">
              <tr>
				...
				include ('purchaserequest_edit1listing1.php');
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
            ...
            <tr>
			  ...
			  <input type="text" name="itemserialnumber" id="itemserialnumber" style="border: 1px solid #001E6A; text-align:right" value="1" size="1" readonly="readonly" /></td>
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            <tbody id="foo">
              ...
              <tr>
				...
				bgcolor="#F3F3F3" class="bodytext31"><div align="right"><span class="bodytext311">
				<strong><!--All Item Discount Percent Apply-->                  </strong></span></div></td>
...
bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong>Cash Amount </strong></div></td>
                <td align="left" valign="top" ><span class="bodytext31">
                  ...
                  <span class="bodytext311">
                  <input type="hidden" name="cashgivenbysupplier" id="cashgivenbysupplier" onBlur="return funcbillamountcalc1()" onFocus="return cashentryonfocus1()" tabindex="2" value="0.00" style="border: 1px solid #001E6A; text-align:right" size="8"  />
                  <input type="hidden" name="cashgiventosupplier" id="cashgiventosupplier" onBlur="return funcbillamountcalc1()" value="0.00" style="border: 1px solid #001E6A; text-align:right" size="8" readonly="readonly"  />
                  </span></span></td>
              </tr>
            ...
            <tr>
              ...
              <td width="46%" align="left" valign="top" ><div align="right"><span class="bodytext31">
                ...
                <!--<input name="print4inch2" type="button" class="button" id="print4inch2" style="border: 1px solid #001E6A" 
				  onClick="return quickprintbill1purchaserequest()" value="Print 40" accesskey="p"/>-->
				  ...
				  onClick="return quickprintbill2purchaserequest()" value="View 40" accesskey="p"/>-->

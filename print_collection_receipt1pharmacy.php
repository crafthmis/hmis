...
$query1 = "select * from master_transactionpharmacy where transactiontype = 'COLLECTION' and transactionmodule = 'COLLECTION' and recordstatus <> 'DELETED' and companyanum = '$companyanum' order by auto_number desc";
$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
$rowcount1 = mysql_num_rows($exec1);
if ($rowcount1 == 0)
{
	echo 'Sorry. No Collection Entry To Print.';
	exit;
}
...
if ($receiptanum != '')
{
	$query21 = "select * from master_transactionpharmacy where auto_number = '$receiptanum'";
}
else
{
	$query21 = "select * from master_transactionpharmacy where transactiontype = 'COLLECTION' and transactionmodule = 'COLLECTION' and recordstatus <> 'DELETED' and companyanum = '$companyanum' order by auto_number desc";
}
...
$collectionreceiptnumber = $res21['collectionnumber'];
      ...
      <table width="99%" border="0" align="left" cellpadding="0" cellspacing="0">
		...
		<?php include ("print_showlogo1pharmacy.php"); ?>
		  ...
		  <div align="right"><span class="style28">
			<?php 
			echo 'COLLECTION RECEIPT';
			?>
		     </span>
		    </div>
		  <div class="style27">
		    <div align="right"><span class="style6"><strong><?php echo 'Pharmacy'; //$title1; ?></strong></span>&nbsp;&nbsp;</div>
		  </div></td>
        </tr>
      </table>
	  <?php
    ...
    <td colspan="2"  valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="38%" valign="top"><table width="92%" border="0" align="right" cellpadding="0" cellspacing="0">
          <tr>
            <td><div align="left" class="style27"><span class="style6"><?php echo 'Receipt No.: '.$collectionreceiptnumber; ?></span></div></td>
          </tr>
          <tr>

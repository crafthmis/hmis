			...
			else
			{
              ...
              <tr <?php echo $colorcode; ?>>
                ...
                <div class="bodytext31">
                  <div align="left"><a href="editsupplier1.php?anum=<?php echo $res2anum; ?>" class="bodytext3"><span class="bodytext3">
				  <?php echo $res2suppliername.' ('.$res2suppliercode.')'; ?></span></a></div>
                </div></td>

    ...
    <td width="99%" valign="top"><table width="950" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="100%"><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td bgcolor="#CCCCCC" class="bodytext3"><strong>Purchase Return </strong></td>
              ...
              <td width="8%" bgcolor="#CCCCCC" class="bodytext3"><strong>Bill Date </strong></td>
            ...
            <tr>
              ...
              <td width="39%" align="left" valign="top" ><input name="supplier" id="supplier" value="<?php echo $res41suppliername; ?>" style="border: 1px solid #001E6A; text-transform:uppercase" size="40" autocomplete="off"/>
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
            ...
            <tr>
              ...
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><strong>Tax</strong></td>
            ...
            <tr>
			  ...
			  <input name="itemname" id="itemname" autocomplete="off" style="border: 1px solid #001E6A; text-align:left" value="" size="40" />
			  <span class="bodytext311"> <strong>
              <input name="itemdescription" type="hidden" id="itemdescription" style="border: 1px solid #001E6A; text-align:left" value="" size="60">
              </strong></span></td>
              <td width="7%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
              ...
              <td width="14%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
			  ...
			  <strong>
			  <input name="expirydate" id="expirydate" onFocus="return funcBatchNumberVerify1()" readonly="readonly" value="<?php //echo $batchnumber; ?>" style="border: 1px solid #001E6A"  size="3" />
              ...
              <td width="11%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><span class="bodytext311">

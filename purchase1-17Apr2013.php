        ...
        <td width="100%"><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            ...
            <?php
			  ...
			  ?>
            <tr>
              <td width="8%" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><strong>Supplier  * </strong></td>
              ...
              <td align="left" valign="top" ><div align="left"><span class="style4">Code</span></div></td>
              ...
              <td width="6%" align="left" valign="middle"  bgcolor="#E0E0E0"  class="bodytext3">&nbsp;</td>
              <td width="31%" rowspan="3" align="left" valign="top" ><span class="bodytext3"><span class="style6"><span class="bodytext312"><a href="javascript:displayDatePicker('ADate1', false, 'ymd', '-');"></a></span></span></span>
                  <input name="deliveryaddress" type="hidden" id="deliveryaddress" style="border: 1px solid #001E6A" value="<?php echo $res41deliveryaddress; ?>" size="25"></td>
            </tr>
            <tr>
              <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><span class="style4">Address 1 </span></td>
              <td align="left" valign="top" ><input name="address1" id="address1" value="<?php echo $res41address1; ?>" style="border: 1px solid #001E6A;text-transform: uppercase;" size="25" />
              ...
              <td align="left" valign="top" ><span class="bodytext3"><strong>
                <input name="suppliertin" id="suppliertin" value="<?php echo $res41tinnumber; ?>" style="border: 1px solid #001E6A"  size="10" />
              </strong></span></td>
            ...
            <tr>
              ...
              <td align="left" valign="top" ><span class="bodytext3"><strong>
                <input name="suppliercst" id="suppliercst" value="<?php echo $res41cstnumber; ?>" style="border: 1px solid #001E6A"  size="10" />
              </strong></span></td>
              <td align="left" valign="middle"  bgcolor="#E0E0E0"  class="bodytext3">&nbsp;</td>
            </tr>
          </tbody>
...
bgcolor="#F3F3F3" class="bodytext31"><span class="bodytext32"><strong><?php echo $f18;?></strong></span>
                  <input name="footerline1" id="footerline1" style="border: 1px solid #001E6A"  size="10" />                  <span class="bodytext32"><strong><?php echo $f19;?></strong></span>                  <input name="footerline2" id="footerline2" style="border: 1px solid #001E6A"  size="10" /></td>
                <td colspan="2" align="left" valign="center"  

    ...
    <td valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
			...
			<form name="stockinward" action="stockreportbyprofitmargin1.php" method="post" onKeyDown="return disableEnterKey()" onSubmit="return process1()">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><strong>Item Name </strong></td>
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><strong>Unit Sales Price </strong></td>
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><strong>Unit Purchase Price </strong></td>
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><strong>Total Sales  Qty </strong></td>
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><strong>Total Sales Price </strong></td>
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Total Purchase Price </strong></div></td>
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Sales  Margin  </strong></div></td>
              </tr>
            <?php
			...
			$query2 = "select *, sum(quantity) as sumquantity from master_stock where itemcode like '%$itemcode%' and transactiondate between '$transactiondatefrom' and '$transactiondateto' and recordstatus <> 'DELETED' and companyanum = '$companyanum' group by itemcode order by itemname";// and cstid='$custid' and cstname='$custname'";

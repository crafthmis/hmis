...
$billcustomername= $res3["billcustomername"];
          ...
          <td valign="top" width="62%"><table width="97%" border="0" align="left" cellpadding="0" cellspacing="0">
              <tr>
                <td><div align="left" class="style27"><span class="style6"> <?php echo 'Doctor Name : '.$doctorname; //$f13; ?></span></div>
                    <div align="left" class="style27"><span class="style6"> <font> <?php if ( $billcustomername != "") 
					{
					 echo $f13.' : '.$f14.' '.$billcustomername ;
					} 
					else
					{
					 echo $f13.' : '.$f14.' '.$cashsalescustomername ;
					} 
					?>
				  </font></span></div>

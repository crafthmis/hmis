...
function funcPrintReceipt1(varRecAnum)
{
	...
	window.open("print_collection_receipt1lab.php?receiptanum="+varRecAnum+"","OriginalWindow<?php //echo $banum; ?>",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
}
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="collectionreceived1lab.php">
		<table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Lab Collection Received Report     - Select Patient </strong></td>
          ...
          <tbody>
            <tr>
              ...
              <?php
				...
				$filename1 = "print_collectionreceivedreport1lab.php?$urlpath";
				$fileurl = $applocation1."/".$filename1;
				$filecontent1 = @file_get_contents($fileurl);
				
				$indiatimecheck = date('d-M-Y-H-i-s');
				$foldername = "dbexcelfiles";
				$fp = fopen($foldername.'/CollectionReceivedByPatientLab.xls', 'w+');
              ...
              <script language="javascript">
				...
				{
					window.open("print_collectionreceivedreport1lab.php?<?php echo $urlpath; ?>","Window1",'width=900,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
					//window.open("message_popup.php?anum="+anum,"Window1",'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,width=200,height=400,left=312,top=84');
				}
				function printbillreport2()
				{
					window.location = "dbexcelfiles/CollectionReceivedByPatientLab.xls"
				}
				</script>
<!--				
...
-->
            ...
            <tr>
              ...
              <td  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Bank Name </strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><div align="left"><strong>Voucher</strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
		  ...
		  $query2 = "select * from master_transactionlab where customername like '%$customername%' and recordstatus <> 'DELETED' and supplieranum = '0' and suppliername = '' and companyanum = '$companyanum' and transactiondate between '$paymentreceiveddatefrom' and '$paymentreceiveddateto' and transactiontype = 'COLLECTION' order by transactiondate desc";
		  ...
		  if ($writeoffamount != '0.00') { $paymentamount = $writeoffamount; }
           ...
           <tr <?php echo $colorcode; ?>>
			 ...
			 <a href="#" class="bodytext31" onClick="return funcPrintReceipt1('<?php echo $receiptanum; ?>')">Print</a></div>			 </td>
              ...
              <td class="bodytext31" valign="center"  align="left">
			  <div align="left"><?php echo substr($paymentdate, 0, 10); ?></a></div></td>
              <td class="bodytext31" valign="center"  align="left">
              ...
              <td class="bodytext31" valign="center"  align="left">
                ...
                <td  align="left" valign="center" class="bodytext31"><div align="left"><?php echo $bankname.' '.$bankbranch; ?></div></td>
                <td class="bodytext31" valign="center"  align="left">
			  <div align="left"><?php echo $vouchernumber; ?></div></td>
              <td class="bodytext31" valign="center"  align="left">

...
if ($frmflag1 == 'frmflag1')
{
	...
	if ($res2 == 0)
	{
		...
		admissiontime, admittedby, admittedward, chiefcomplaint, username, ipaddress, recordstatus, consultingdoctor, remarks, ipnumber) 
...
$query2 = "select * from master_patientadmission order by auto_number desc limit 0, 1";
$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
$res2 = mysql_fetch_array($exec2);
$res2ipnumber = $res2["ipnumber"];
if ($res2ipnumber == '')
{
	$ipnumber = 'IPN00000001';
}
else
{
	$res2ipnumber = $res2["ipnumber"];
	$ipnumber = substr($res2ipnumber, 3, 8);
	$ipnumber = intval($ipnumber);
	$ipnumber = $ipnumber + 1;
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="860"><table width="800" height="282" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
                <td bgcolor="#CCCCCC" class="bodytext3" colspan="2"><strong>Patient - Admission Entry </strong></td>
...
-->				   <span class="bodytext32">
                ...
                <td colspan="2" align="middle"  bgcolor="#CCCCCC"><span class="bodytext32"><strong>Patient - Admission Entry </strong></span></td>
                 ...
                 <tr>
                    ...
                    <td align="left" valign="middle"  bgcolor="#E0E0E0"><span class="bodytext31">
                      <input name="admissiondate" id="admissiondate" value="<?php echo $admissiondate; ?>" readonly="readonly" style="border: 1px solid #001E6A;"  size="20" />
                 ...
                 <tr>
                   ...
                   <td align="left" valign="middle"  bgcolor="#E0E0E0"><span class="bodytext31">
                     <input name="admissiontime" id="admissiontime" value="<?php echo $admissiontime; ?>" style="border: 1px solid #001E6A;"  size="20" />
                   </span></td>
                  </tr>
                 <tr>
				...
				?>
                 ...
                 <tr>
                   ...
                   <td align="left" valign="top"  bgcolor="#E0E0E0"><span class="bodytext31">
                     <input name="remarks" id="remarks" value="<?php echo $remarks; ?>" style="border: 1px solid #001E6A;"  size="20" />
                   </span></td>
                 </tr>
                 <tr>

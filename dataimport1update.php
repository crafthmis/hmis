...
if ($frmflag1 == 'frmflag1')
{
	...
	if ($fileformat == 'txt') // || $fileformat == 'peg') // || $fileformat == 'gif')
	{
		...
		{
			header ("location:dataimport2update.php?upload=success");
		}
		else
		{
			header ("location:dataimport1update.php?upload=failed");
		}
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form action="dataimport1update.php" method="post" enctype="multipart/form-data" name="form1" id="form1" onSubmit="return dataimport1verify()">
                  <table width="800" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Item / Services Data Update From TAB Delimited File </strong></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td colspan="2" align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><strong>Please Note: Take Complete Backup Of Database Before Proceeding. There is possibility of loosing all the data on update. </strong></td>
                        </tr>
                      <tr>

...
if ($frmflag1 == 'frmflag1')
{
	...
	$query1 = "update master_itemlabtest set unitname_abbreviation = '$unitname_abbreviation', taxanum = '$taxanum',  
...
if ($sanum != '')
{
	$query2 = "select * from master_itemlabtest where auto_number = '$sanum'";
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="edititem1labtest.php?sanum=<?php echo $sanum; ?>" onSubmit="return edititem1process1()">
                  <table width="800" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top"  bgcolor="#FFFFFF"><textarea name="description" cols="60" id="description" style="border: 1px solid #001E6A"><?php echo $description; ?></textarea>
                          <input type="hidden" name="rateperunit" id="rateperunit" value="<?php echo $rateperunit; ?>" style="border: 1px solid #001E6A" size="20" />

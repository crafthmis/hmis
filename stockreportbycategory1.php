...
<table width="1500" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
	...
	<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
      ...
      <tbody id="foo">
        <tr>
          <td colspan="5" bgcolor="#cccccc" class="bodytext31"><strong>Stock - Report </strong></td>
          </tr>
        <tr>
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            ...
            <tr>
              ...
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><strong>CustomerDC</strong></td>
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><strong>SupplierDC</strong></td>
              <td align="left" valign="center"  
			...
			if ($searchoption1 == 'CUMULATIVE')
			{
				$query2 = "select *, sum(quantity) as sumquantity, sum(totalrate) as sumtotalrate from master_stock where itemcode like '%$itemcode%' and transactiondate between '$transactiondatefrom' and '$transactiondateto' and recordstatus <> 'DELETED' and companyanum = '$companyanum' group by itemcode, transactionmodule order by itemname";// and cstid='$custid' and cstname='$custname'";
			}
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td  align="left" valign="center" class="bodytext31"><div class="bodytext31">
                  <div align="right"><?php echo $dccustomerquantity; ?></div>
              </div></td>
              <td  align="left" valign="center" class="bodytext31"><div class="bodytext31">
                  <div align="right"><?php echo $dcsupplierquantity; ?></div>
              </div></td>
              <td class="bodytext31" valign="center"  align="left"><div class="bodytext31">
            ...
            <tr>
              ...
              <td  align="left" valign="center" 
                bgcolor="#cccccc" class="bodytext31"><div class="style1">
                  <div align="right"><?php echo $totaldccustomerquantity; ?></div>
              </div></td>
              <td  align="left" valign="center" 
                bgcolor="#cccccc" class="bodytext31"><div class="style1">
                  <div align="right"><?php echo $totaldcsupplierquantity; ?></div>
              </div></td>
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#cccccc"><div class="style1">

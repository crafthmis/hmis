...
if ($frmflag1 == 'frmflag1')
{
	...
	{  
		//echo "inside if";
		$bgcolorcode = 'fail';
		$errmsg="Sorry. Hospital Item Not Added";
		
		header("location:additem1hospital.php?st=1");
		exit();
	}
	...
	if ($length1<25 && $length2<255)
	{
		...
		$query2 = "select * from master_itemhospital where itemcode = '$itemcode'";// or itemname = '$itemname'";
		$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
		$res2 = mysql_num_rows($exec2);
		if ($res2 == 0)
		{
			$query1 = "insert into master_itemhospital (itemcode, itemname, categoryname, unitname_abbreviation, rateperunit, expiryperiod, taxanum, taxname, ipaddress, updatetime, description, purchaseprice) 
			...
			$errmsg = "Success. New Hospital Item Updated.";
			$bgcolorcode = 'success';
			$itemcode = '';
			$itemname = '';
			$rateperunit  = '0.00';
			...
			//$itemcode = '';
			$query1 = "select * from master_itemhospital order by auto_number desc limit 0, 1";
			$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
		...
		{
			$errmsg = "Failed. Hospital Item Code Already Exists.";
			$bgcolorcode = 'failed';
		}
	}
	else
	{
		$errmsg = "Failed. Hospital Item Code Should Be 25 Characters And Name Should Be 255 Characters.";
		$bgcolorcode = 'failed';
	}
...
if ($st == 'del')
{
	...
	$query3 = "update master_itemhospital set status = 'deleted' where auto_number = '$delanum'";
	$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
}
if ($st == 'activate')
{
	$delanum = $_REQUEST["anum"];
	$query3 = "update master_itemhospital set status = '' where auto_number = '$delanum'";
	$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
}
...
{
	$errmsg = "Please Add Hospital Item To Proceed For Billing.";
	$bgcolorcode = 'failed';
}
...
function additem1process1()
{
	...
	{	
		alert ("Please Enter Hospital Item Code or ID.");
	...
	{	
		...
		for (var i = 0; i < data.length; i++) 
		{
			...
			{
				//alert ("Your Hospital Item Name Has Blank White Spaces Or Special Characters. Like ! ^ + = [ ] ; , { } | \ < > ? ~ $ ' \" These are not allowed.");
				alert ("Your Hospital Item Code Has Blank White Spaces Or Special Characters. These Are Not Allowed.");
				return false;
			}
		}
	}
	...
	{
		alert ("Pleae Enter Hospital Item Name.");
...
function spl()
{
	...
	for (var i = 0; i < data.length; i++) 
	{
		if (iChars.indexOf(data.charAt(i)) != -1) 
		{
			alert ("Your Hospital Item Name Has Special Characters. Like ! ^ + = [ ] ; , { } | \ < > ? ~ These are not allowed.");
			return false;
		}
	}
}
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="additem1hospital.php" onSubmit="return additem1process1()">
                  <table width="900" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Hospital Item Master - Add New </strong></td>
                      </tr>
					  <?php if ($st==1)
					  {?>
					  <tr>
                      ...
                      <tr>
						...
						<?php
						$query1 = "select * from master_categoryhospital where status <> 'deleted' order by categoryname";
						$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
						...
						?>
						</select> <a href="addcategory1hospital.php"><font  class="bodytext3" color="#000000">(Click Here To Add New Category)</font></a>						</td>
                      </tr>
                      <tr>
                        <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"> <div align="left">New Hospital Item Code </div></td><td align="left" valign="top"  bgcolor="#E0E0E0">
						<input name="itemcode" value="<?php echo $itemcode; ?>" id="itemcode" readonly="readonly" style="border: 1px solid #001E6A; background-color:#CCCCCC" size="20" maxlength="100" />
						<span class="bodytext3">( Example : PRD1234567890 ) </span></td>
                      </tr>
                      <tr>
                        <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><div align="left">Add New Hospital Item Name </div></td>
                        <td align="left" valign="top"  bgcolor="#E0E0E0">
						<input value="<?php echo $itemname; ?>" name="itemname" id="itemname" style="border: 1px solid #001E6A" size="60" onChange="return spl()"/></td>
                      </tr>
                      <tr>
                        <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><div align="left">Select Hospital Item Unit  </div></td>
                        <td align="left" valign="top"  bgcolor="#E0E0E0">
						<select id="unitname_abbreviation" name="unitname_abbreviation">
                          <option value="">Select Unit</option>
                          <?php
						$query1 = "select * from master_unitshospital where status <> 'deleted' order by unitname";
						$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
						while ($res1 = mysql_fetch_array($exec1))
						{
                      ...
                      <tr>
                        <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><div align="left">Hospital Item Description </div></td>
...
<!--                      <tr>
						...
						<div align="right">Hospital Item Period </div></td>
...
-->					  
                      ...
                      <tr>
                        ...
                        <td width="72%" align="left" valign="top"  bgcolor="#E0E0E0"><input type="hidden" name="frmflag" value="addnew" />
                          ...
                          <input type="submit" name="Submit" value="Save Hospital Item" style="border: 1px solid #001E6A" />                        </td>
                      </tr>
                    </tbody>
                  </table>
				  </form>
                ...
                <table width="900" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="10" bgcolor="#CCCCCC" class="bodytext3"><span class="bodytext32"><strong>Hospital Item Master - Existing List - Latest 100 Hospital Items </strong></span></td>
                      </tr>
                      <tr bgcolor="#011E6A">
                      ...
                      <tr bgcolor="#011E6A">
                        ...
                        <td width="35%" bgcolor="#CCCCCC" class="bodytext3"><strong>Hospital Item</strong></td>
	  ...
	  if ($searchflag1 == 'searchflag1')
	  {
	    ...
	    $query1 = "select * from master_itemhospital where itemname like '%$search1%' or categoryname like '%$search1%' and status <> 'deleted' order by auto_number desc LIMIT 100";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
		while ($res1 = mysql_fetch_array($exec1))
		{
        ...
        <tr <?php echo $colorcode; ?>>
                        <td align="left" valign="top"  bgcolor="#FFFFFF" class="bodytext3"><div align="center"><a href="additem1hospital.php?st=del&amp;&amp;anum=<?php echo $auto_number; ?>"><img src="images/b_drop.png" width="16" height="16" border="0" /></a></div></td>
                        ...
                        <td align="left" valign="top"  class="bodytext3">
						  <div align="center">
						  <a href="edititem1hospital.php?sanum=<?php echo $auto_number; ?>" class="bodytext3">Edit</a></div></td>
                      </tr>
                      <?php
		}
	}
	...
	{
	$query1 = "select * from master_itemhospital where status <> 'deleted' order by auto_number desc LIMIT 100";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
		while ($res1 = mysql_fetch_array($exec1))
		{
		$itemcode = $res1["itemcode"];
		...
		?>
                ...
                <table width="900" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="8" bgcolor="#CCCCCC" class="bodytext3"><strong>Hospital Item Master - Deleted </strong></td>
                      </tr>
                      <tr bgcolor="#011E6A">
                      ...
                      <tr bgcolor="#011E6A">
                        ...
                        <td width="23%" bgcolor="#CCCCCC" class="bodytext3"><strong>Hospital Item</strong></td>
	  ...
	  if ($searchflag2 == 'searchflag2')
	  {
	    ...
	    $query1 = "select * from master_itemhospital where itemname like '%$search2%' or categoryname like '%$search1%' and status = 'deleted' order by auto_number desc LIMIT 100";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
		while ($res1 = mysql_fetch_array($exec1))
		{
		$itemcode = $res1["itemcode"];
        ...
        <tr <?php echo $colorcode; ?>>
						...
						<a href="additem1hospital.php?st=activate&amp;&amp;anum=<?php echo $auto_number; ?>" class="bodytext3">

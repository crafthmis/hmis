...
<?php
if(isset($_REQUEST["customercode"]))
{
$customercode = $_REQUEST["customercode"];
$query42 = "select * from master_saleslabtest where customercode='$customercode'"; 
$exec42 = mysql_query($query42) or die ("Error in Query42".mysql_error());
$res42 = mysql_fetch_array($exec42);
$res42customername = $res42["customername"];
$res42patientage = $res42["patientage"];
$res42patientgender = $res42["patientgender"];
}
?>
...
<script type="text/javascript" src="js/autoitemsearch2labtest.js"></script><!-- To Populate Item Details Based On Item Code -->
...
<script type="text/javascript" src="js/autosuggest2labtest.js"></script><!-- Populates Item Date In Drop Down List Format -->
...
<script type="text/javascript" src="js/popuplatelabtestitemlist1.js"></script>
...
function loadprintpage1(varPaperSizeCatch)
{
	...
	var varnewbill=document.getElementById("billnumber").value;
	...
	if (varPaperSize == "A4")
	{
		window.open("print_bill1labtest.php?printsource=billpage&&billautonumber="+varBillAutoNumber+"&&varnewbill="+varnewbill+"&&companyanum="+varBillCompanyAnum+"&&title1="+varTitleHeader+"&&billnumber="+varBillNumber+"","OriginalWindowA4<?php echo $banum; ?>",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
	}
	if (varPaperSize == "A5")
	{
...
-->				</td>
			  ...
			  <tr>
				...
				<input name="customer" id="customer" value="<?php echo $res42customername; ?>" style="border: 1px solid #001E6A;" size="40" autocomplete="off"/>
				...
				<input name="customercode" id="customercode" value="<?php echo $customercode; ?>" style="border: 1px solid #001E6A" size="12" rsize="20" />				
			  ...
			  <tr>
			    ...
			    <td align="left" valign="top" >
				  <input type="text" name="patientage" id="patientage" value="<?php echo $res42patientage ?>" style="border: 1px solid #001E6A;text-transform: uppercase;"  size="5">
&
<input type="text" name="patientgender" id="patientgender" value="<?php echo $res42patientgender ?>" style="border: 1px solid #001E6A;text-transform: uppercase;"  size="5">
<input type="hidden" name="address1" id="address1" value="<?php echo $res41address1; ?>" style="border: 1px solid #001E6A;text-transform: uppercase;" size="30" />
				...
				?>
			      ...
			      <input type="hidden" name="customertin" id="customertin" value="<?php echo ""; ?>" style="border: 1px solid #001E6A"  size="12" />
			    </strong></span></td>
			    </tr>
			  <tr>
			    <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><strong>Sample ID </strong></td>
			    <td align="left" valign="top" ><input type="text" name="sampleid" id="sampleid" value="" style="border: 1px solid #001E6A;text-transform: uppercase;"  size="20"></td>
			    <td align="left" valign="middle" ><div align="left"><span class="style4">Received Date </span></div></td>
			    <td align="left" valign="top" ><span class="bodytext312">
			      <input name="receiveddate" id="receiveddate" style="border: 1px solid #001E6A" value="<?php //echo $dateonly; ?>"  size="8"  readonly="readonly" onKeyDown="return disableEnterKey()" />
                  <img src="images2/cal.gif" onClick="javascript:NewCssCal('receiveddate')" style="cursor:pointer"/> </span></td>
			    <td align="left" valign="middle"  bgcolor="#E0E0E0"  class="bodytext3">&nbsp;</td>
			    <td align="left" valign="top" >&nbsp;</td>
			    </tr>
			  <tr>
			    <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><strong>Category</strong></td>
			    <td align="left" valign="top" ><span class="bodytext3"><strong><!--Pincode--></strong></span>
			    <select id="categoryname" name="categoryname" onChange="return funcLabTestItemListPopulate1()">
			    ...
			    <input type="hidden" name="city1" id="city1" value="<?php echo $res41city; ?>" style="border: 1px solid #001E6A;text-transform: uppercase;"  size="10" /></td>
				  <td align="left" valign="middle" ><span class="bodytext3"><strong>Reported Date </strong></span></td>
				  <td align="left" valign="top" ><span class="bodytext3"><strong>
			      <input type="hidden" name="customercst" id="customercst" value="<?php echo ""; ?>" style="border: 1px solid #001E6A"  size="12" />
			      <span class="bodytext312">
			      <input name="reporteddate" id="reporteddate" style="border: 1px solid #001E6A" value="<?php //echo $dateonly; ?>"  size="8"  readonly="readonly" onKeyDown="return disableEnterKey()" />
                  <img src="images2/cal.gif" onClick="javascript:NewCssCal('reporteddate')" style="cursor:pointer"/> </span></strong></span></td>
			    <td align="left" valign="middle"  bgcolor="#E0E0E0"  class="bodytext3">&nbsp;</td>
          ...
          <tbody id="tblrowinsert">
            <tr>
              ...
              <td width="10%" align="left" valign="center"  
                bgcolor="#FFCC00" class="bodytext311"><strong> Units</strong></td>
              <td width="5%" align="left" valign="center"  
                bgcolor="#FFCC00" class="bodytext311">&nbsp;</td>
              <td width="31%" align="left" valign="center"  
                bgcolor="#FFCC00" class="bodytext311"><strong>Reference Value </strong></td>
            ...
            <?php
				...
				include ('sales_edit1listing1labtest.php');
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
            <tr>
              ...
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><span class="bodytext311"><strong> Units</strong></span></td>
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">&nbsp;</td>
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><span class="bodytext311"><strong>Reference Value </strong></span></td>
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">&nbsp;</td>
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">&nbsp;</td>
            </tr>
            <tr>
              ...
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><span class="bodytext311">
                <textarea name="referencevalue" cols="20" rows="1" id="referencevalue" style="border: 1px solid #001E6A; text-align:left;"></textarea>
              </span></td>
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">&nbsp;</td>
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><span class="bodytext311">
              ...
              <tr>
                ...
                bgcolor="#CCCCCC" class="bodytext31"><div align="right"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
                  ...
                  <input name="delbillnumber" id="delbillnumber" type="hidden" value="<?php echo $delbillnumber;?>">
					<input name="pageidentificationcontrol" id="pageidentificationcontrol" type="hidden" value="sales1labtest">

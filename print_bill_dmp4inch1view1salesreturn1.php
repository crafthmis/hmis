...
$query3 = "select * from master_salesreturnpharmacy where billnumber = '$billnumber' and recordstatus <> 'deleted' and companyanum = '$companyanum'";
...
<tr>
<td colspan="5"><div align="center"><?php echo $address2; ?>
    <?php
...
<tr>
<td colspan="5">
SALES RETURN BILL NO: <?php echo $billnumberprefix.$billnumber.$billnumberpostfix; ?></td>
</tr>
<tr>
<td colspan="5">
...
<?php
$serialnumber = "";
$query4 = "select * from pharmacysalesreturn_details where bill_autonumber = '$billautonumber' and recordstatus <> 'deleted' and companyanum = '$companyanum'";
...
?>
<?php
$query41 = "select *, sum(taxamount) as sumtaxamount from pharmacysalesreturn_tax  where bill_autonumber = '$billautonumber' and recordstatus <> 'deleted' and companyanum = '$companyanum' group by tax_autonumber, taxname order by auto_number";
...
<tr>
<td colspan="4">
  <div align="right"><?php echo $taxname3;; ?>
</div>
</td>
<td>
  <div align="right"><?php echo $taxamount4; ?></div>
  </td>
<?php
}
?>

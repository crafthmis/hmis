...
//{
	...
	if ($printsource == '')
	{
		//$query22 = "select * from master_saleshospital where auto_number = '$banum'";// and recordstatus <> 'DELETED' and companyanum = '$companyanum'";
		$query22 = "select * from master_saleshospital where auto_number = '$billautonumber' and companyanum = '$companyanum' and financialyear = '$financialyear'";
	}
	if ($printsource == 'billpage')
	{
		//$query22 = "select * from master_saleshospital where auto_number = '$banum'";// and recordstatus <> 'DELETED' and companyanum = '$companyanum'";
		$query22 = "select * from master_saleshospital where billnumber = ".$_REQUEST["billnumber"]." and recordstatus <> 'DELETED' and companyanum = '$companyanum' and financialyear = '$financialyear'";
	}
	else if ($printsource == 'printselectionpage')
	{
		//$query22 = "select * from master_saleshospital where billnumber = '$banum' and status <> 'CANCELLED' and companyanum = '$companyanum' and recordstatus <> 'DELETED'";
		$query22 = "select * from master_saleshospital where billnumber = ".$_REQUEST["billnumber"]." and recordstatus <> 'DELETED' and companyanum = '$companyanum' and financialyear = '$financialyear'";
	}
...
//$query21 = "select auto_number from master_saleshospital where billnumber = '$banum' and companyanum = '$companyanum' and recordstatus <> 'DELETED'";
$query21 = "select auto_number from master_saleshospital where auto_number = '$res22anum' and financialyear = '$financialyear'";// and recordstatus <> 'DELETED' and companyanum = '$companyanum'";
$exec21 = mysql_query($query21) or die ("Error in Query21".mysql_error());
$res21 = mysql_fetch_array($exec21);
$res21anum = $res21["auto_number"];

$query3 = "select * from master_saleshospital where auto_number = '$res21anum' and companyanum = '$companyanum' and financialyear = '$financialyear'";
...
$dateofadmission = substr($dateofadmission, 0, 10);
if ($dateofadmission != '0000-00-00')
{
	$dotarray = explode("-", $billdateonly);
	$dotyear = $dotarray[0];
	$dotmonth = $dotarray[1];
...
$dateofdischarge = substr($dateofdischarge, 0, 10);
if ($dateofdischarge != '0000-00-00')
{
	$dotarray = explode("-", $billdateonly);
	$dotyear = $dotarray[0];
	$dotmonth = $dotarray[1];
...
$discountexists = "";
$query4 = "select * from hospitalsales_details where bill_autonumber = '$billautonumber' and companyanum = '$companyanum' and financialyear = '$financialyear'";
$exec4 = mysql_query($query4) or die ("Error in Query4".mysql_error());
...
include ("print_column_count_include1hospital.php");
...
<table width="660" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td valign="top" width="50%"><table width="97%" border="0" align="left" cellpadding="0" cellspacing="0">
              <tr>
                <td><div align="left" class="style27"><span class="style6"> <?php echo $f13; ?></span></div>
                    <div align="left" class="style27"><span class="style6"> <font> <?php echo $f14.' '.$customername.' ( Age : '.round($patientage, 2).' )'; ?></font></span></div>
          ...
          <td width="50%" valign="top"><table width="97%" border="0" align="left" cellpadding="0" cellspacing="0">
			...
			?>
					...
					<?php
					if ($showhospitaldoadod == 'SHOW DOA & DOD ON HOSPITAL PRINTOUT')
					{
					if ($dateofadmission != '0000-00-00')
					{
					?>
					<div align="left" class="style27"><span class="style6"> <?php echo 'Date Of Admission : '.$dateofadmission; ?></span></div>
  ...
  <tr>
	...
	<table width="98%" border="1" align="left" cellpadding="0" cellspacing="0" frame="box" rules="groups" class="sample">
      ...
      <thead>
		...
		$query8 = "select * from master_itemhospital where auto_number = '$itemanum'";
		...
		$query9 = "select * from hospitalsales_tax where  bill_autonumber = '$billautonumber' and itemanum = '$itemanum' and companyanum = '$companyanum' and financialyear = '$financialyear'";
       ...
       <td valign="top"><div align="right"><span class="style27">&nbsp;<?php echo $quantity; ?>&nbsp;</span></div></td>
		...
		$query5 = "select * from master_saleshospital where auto_number = '$res21anum' and recordstatus <> 'deleted' and financialyear = '$financialyear'";
		$exec5 = mysql_query($query5) or die ("Error in Query5".mysql_error());
		$res5 = mysql_fetch_array($exec5);
     ...
     <?php
		//$subtotalaftertax = $subtotalafterdiscountamount;
	  	...
	  	//$query6 = "select *, sum(taxamount) as sumtaxamount from hospitalsales_tax where bill_autonumber = '$res22anum' group by taxpercent order by auto_number";
	  	$query6 = "select *, sum(taxamount) as sumtaxamount from hospitalsales_tax where bill_autonumber = '$billautonumber' and financialyear = '$financialyear' and recordstatus <> 'DELETED' group by tax_autonumber, taxname order by auto_number";
		$exec6 = mysql_query($query6) or die ("Error in Query6".mysql_error());
  ...
  <tr>
    ...
    <td width="319" colspan="2" rowspan="5" valign="top">

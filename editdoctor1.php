...
if ($frmflag1 == 'frmflag1')
{
	...
	if ($res2 != 0)
	{
		...
		openingbalance = '$openingbalance' where doctorcode  = '$doctorcode'"; 
		...
		header("location:editdoctor1.php?doctorcode=$doctorcode&&st=success");
		//header ("location:addcompany1.php?st=success&&cpynum=1");
	}
	else
	{
		header ("location:editdoctor1.php?doctorcode=$doctorcode&&st=failed");
	}
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="860"><table width="800" height="282" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
                <td bgcolor="#CCCCCC" class="bodytext3" colspan="2"><strong>Doctor - Edit </strong></td>

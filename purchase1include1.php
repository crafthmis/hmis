...
if ($frm1submit1 == 'frm1submit1')
{
	...
	*/
	...
	subtotaldiscountpercentapply1, subtotaldiscountamountapply1, subtotaldiscountamountonlyapply1, subtotaldiscountamountonlyapply2, supplierbillnumber,supplierbilldate) 	
	...
	'$deliveryaddress', '$subtotalamountdiscountpercent', '$subtotalamountdiscountamount', '$subtotalaftercombinediscount', 
	'$subtotaldiscountpercentapply1', '$subtotaldiscountamountapply1', '$subtotaldiscountamountonlyapply1', '$subtotaldiscountamountonlyapply2', '$supplierbillnumber','$suppbilldate')";
	...
	for ($i=1;$i<=1000;$i++)
	{
		...
		if ($serialnumber != '')
		{
			...
			manufactureranum, manufacturername) 
	...
	$particulars1 = 'BY PURCHASE (BILL NO:'.$billnumberprefix.$billnumber.')';	
...
*/	
	...
	header ("location:purchase1.php?src=frm1submit1&&st=success&&billnumber=$billnumber&&billautonumber=$billautonumber&&companyanum=$companyanum&&titlestr=PURCHASE");
	exit;

...
$stringbuild1 = '';
$query5 = "select * from master_packagepharmacy where status <> 'deleted' order by packagename";// and batchnumber = '$batchnumber'";
$exec5 = mysql_query($query5) or die ("Error in Query5".mysql_error());
while ($res5 = mysql_fetch_array($exec5))
{
	$packageanum = $res5['auto_number'];
	...
	$stringbuild1 = $stringbuild1.'||||'.$packageanum.'^^'.$packagename.'^^'.$quantityperpackage;

...
{
	window.location = "invoicereport1labcommission.php";
}
    ...
    <td width="99%" valign="top"><table width="1498" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="1424">
              ...
              <form name="cbform1" method="get" action="invoicereport1labcommission.php">
		<table width="916" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            ...
            <tr>
                <td width="10%"  align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"> Doctor  * </td>
                <td colspan="3" align="left" valign="top" >
				<input value="<?php echo $cbcustomername; ?>" name="cbcustomername" type="hidden" id="cbcustomername" size="20" style="border: 1px solid #001E6A">
				<strong><strong>
            ...
            <tr>
              <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3"><!--Payment Type -->
                Financial Year </td>
...
-->			  
			  ...
			  <input value="<?php echo $cbbillnumber; ?>" name="cbbillnumber" type="text" id="cbbillnumber" size="10" style="border: 1px solid #001E6A"></td>
              <td align="left" valign="middle"  bgcolor="#FFFFFF"><span class="bodytext3"><!--Bill Status --></span></td>
              <td align="left" valign="top"  bgcolor="#FFFFFF">
			  <input type="hidden" name="billstatus" id="billstatus" value="CONFIRMED">
<!--			  
...
--></td>
            ...
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><strong>Doctor Name </strong></td>
              <td  align="left" valign="center" 
			...
			*/
			...
			$query2 = "select * from master_saleslab where referredby like '%$referredby%' and billnumber like '%$cbbillnumber%' and 
			...
			?>
              ...
              <td class="bodytext31" valign="center"  align="left">
			    <div align="left"><?php echo $referredby; ?>&nbsp;</div></td>

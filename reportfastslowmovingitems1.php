    ...
    <td valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
			...
			<form name="stockinward" action="reportfastslowmovingitems1.php" method="post" onKeyDown="return disableEnterKey()">
	<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="800" 
            align="left" border="0">
      <tbody id="foo">
        <tr>
          <td colspan="5" bgcolor="#cccccc" class="bodytext31"><strong>Stock - Report By Fast/Slow Moving Items</strong></td>
          </tr>
        <tr>
...
function deleterecord1(varEntryNumber,varAutoNumber)
{
	...
	else
	{
        ...
        <tr>
		  ...
		  <tr>
		  <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><strong>Show Moving Items</strong></td>
				<td colspan="4" align="left" valign="center"  bgcolor="#ffffff" class="bodytext31">
				<select name="movingitemselection" id="movingitemselection">
				<option selected="selected" value="">Show All items</option>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td align="left" valign="center"  
				...
				<td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><strong>Qty Sold </strong></td>
                <td align="left" valign="center"  
              ...
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Total PP </strong></div></td>
            </tr>
            <?php
			...
			if ($movingitemselection == 'Fast Moving') $movingitemquery = 'desc';
			if ($movingitemselection == 'Slow Moving') $movingitemquery = 'asc';
			...
			$query3 = "select itemcode, sum(quantity) as sumquantity from pharmacysales_details where itemcode like '%$itemcode%' and recordstatus <> 'DELETED' and companyanum = '$companyanum' group by itemcode order by sumquantity $movingitemquery";// itemcode = '$itemcode' and";
			$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
			while ($res3 = mysql_fetch_array($exec3))
			{
			$itemcode = $res3['itemcode'];
			$res3sumquantity = $res3['sumquantity'];
			...
			$query2 = "select * from master_itempharmacy where itemcode = '$itemcode' and status <> 'DELETED'";// and categoryname like '%$categoryname%'";// limit 0, 1000";// and companyanum = '$companyanum'";// and cstid='$custid' and cstname='$custname'";
            ...
            <tr <?php echo $colorcode; ?>>
              ...
              <td  align="left" valign="center" class="bodytext31"><div class="bodytext31">
			   ...
			   <td  align="left" valign="center" class="bodytext31"><div class="bodytext31">
                  <div align="left"><?php echo round($res3sumquantity, 2) ; ?>&nbsp;</div>
              </div></td>
              <td class="bodytext31" valign="center"  align="left">

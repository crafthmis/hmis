...
//{
	...
	if ($printsource == '')
	{
		//$query22 = "select * from master_saleslabtest where auto_number = '$banum'";// and recordstatus <> 'DELETED' and companyanum = '$companyanum'";
		$query22 = "select * from master_saleslabtest where auto_number = '$billautonumber' and companyanum = '$companyanum' and financialyear = '$financialyear'";
	}
	if ($printsource == 'billpage')
	{
		//$query22 = "select * from master_saleslabtest where auto_number = '$banum'";// and recordstatus <> 'DELETED' and companyanum = '$companyanum'";
		$query22 = "select * from master_saleslabtest where billnumber = ".$_REQUEST["billnumber"]." and recordstatus <> 'DELETED' and companyanum = '$companyanum' and financialyear = '$financialyear'";
	}
	else if ($printsource == 'printselectionpage')
	{
		//$query22 = "select * from master_saleslabtest where billnumber = '$banum' and status <> 'CANCELLED' and companyanum = '$companyanum' and recordstatus <> 'DELETED'";
		$query22 = "select * from master_saleslabtest where billnumber = ".$_REQUEST["billnumber"]." and recordstatus <> 'DELETED' and companyanum = '$companyanum' and financialyear = '$financialyear'";
	}
...
$query2 = "select * from settings_billlabtest where companyanum = '$companyanum'";
...
//$query21 = "select auto_number from master_saleslabtest where billnumber = '$banum' and companyanum = '$companyanum' and recordstatus <> 'DELETED'";
$query21 = "select auto_number from master_saleslabtest where auto_number = '$res22anum' and financialyear = '$financialyear'";// and recordstatus <> 'DELETED' and companyanum = '$companyanum'";
$exec21 = mysql_query($query21) or die ("Error in Query21".mysql_error());
$res21 = mysql_fetch_array($exec21);
$res21anum = $res21["auto_number"];

$query3 = "select * from master_saleslabtest where auto_number = '$res21anum' and companyanum = '$companyanum' and financialyear = '$financialyear'";
...
$referredby = $res3['referredby'];
$sampleid = $res3['sampleid'];

$receiveddate = $res3['receiveddate'];
//$billtime = substr($receiveddate, 11, 8);
$billdateonly = substr($receiveddate, 0, 10);
$dotarray = explode("-", $billdateonly);
$dotyear = $dotarray[0];
$dotmonth = $dotarray[1];
$dotday = $dotarray[2];
$receiveddate = strtoupper(date("d-M-Y", mktime(0, 0, 0, $dotmonth, $dotday, $dotyear)));

$reporteddate = $res3['reporteddate'];
//$billtime = substr($reporteddate, 11, 8);
$billdateonly = substr($reporteddate, 0, 10);
$dotarray = explode("-", $billdateonly);
$dotyear = $dotarray[0];
$dotmonth = $dotarray[1];
$dotday = $dotarray[2];
$reporteddate = strtoupper(date("d-M-Y", mktime(0, 0, 0, $dotmonth, $dotday, $dotyear)));
...
$discountexists = "";
$query4 = "select * from labtestsales_details where bill_autonumber = '$billautonumber' and companyanum = '$companyanum' and financialyear = '$financialyear'";
$exec4 = mysql_query($query4) or die ("Error in Query4".mysql_error());
...
<table width="660" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	?>
      <table width="99%" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
		<?php include ("print_showlogo1labtest.php"); ?>
		...
		<div class="style27">
		    <div align="right"><span class="style6"><?php //echo $f15.' '.$billnumberprefix; ?></span>&nbsp;&nbsp;</div>
		  </div>
		<div class="style27">
    ...
    <tr>
      <td colspan="3">
	  <table width="99%" border="1" class="sample">
        <tr>
          <td></td>
        </tr>
      </table>
    ...
    <tr>
	  ...
	  <table width="98%" border="0" cellspacing="0" cellpadding="0" class="sample">
        <tr>
          <td valign="top" width="61%"><table width="97%" border="0" align="left" cellpadding="0" cellspacing="0">
              <tr>
                <td><div align="left" class="style27"><span class="style6"> <?php //echo $f13; ?></span></div>
                    <div align="left" class="style27"><span class="style6"> <font> <?php echo 'Patient : '.$customername; //$f14.' '.$customername;//.' ( '.$customercode.' )'; ?></font></span></div>
                  <div align="left" class="style27"><span class="style6"> <?php echo 'Sex & Age : '.$patientgender.' / '.$patientage; //echo $address; ?></span></div>
                  <div align="left" class="style27"><span class="style6"> <?php echo 'Referred By : '.$referredby; //echo $location.' '.$city; ?></span></div>
				<?php
          ...
          <td width="39%" valign="top"><table width="97%" border="0" align="left" cellpadding="0" cellspacing="0">
              <tr>
                <td><?php
			...
			//{
			?>
					<div align="left" class="style27"><span class="style6"> <?php echo 'Patient ID : '.$customercode; ?></span></div>
					<div align="left" class="style27"><span class="style6"> <?php echo 'Sample ID : '.$sampleid; ?></span></div>
					<div align="left" class="style27"><span class="style6"> <?php echo 'Received Date : '.$receiveddate; ?></span></div>
					<div align="left" class="style27"><span class="style6"> <?php echo 'Reported Date : '.$reporteddate; ?></span></div>
                  <?php
			//}
			?>                </td>
              </tr>
  ...
  <tr>
	...
	settingsname = 'SHOW_PRINTOUT_TABLE_BORDER'";
	$exec8 = mysql_query($query8) or die ("Error in Query8".mysql_error());
	$res8 = mysql_fetch_array($exec8);
	$showcolumnunit = $res8["settingsvalue"];
	if ($showcolumnunit == 'SHOW PRINTOUT TABLE BORDER') 
	{
		$border = 'border="1"';
		$frame = 'frame="box"';
		$rules = 'rules="groups"';
	}
	else //To hide table columns.
	{	
		$border = 'border="0"';
		$frame = '';
		$rules = '';
	...
	<table width="98%" <?php echo $border; ?> align="left" cellpadding="0" cellspacing="0" <?php echo $frame; ?> <?php echo $rules; ?> class="sample">
      <colgroup span="1">
      </colgroup>
      <colgroup span="1">
      </colgroup>
      ...
      <thead>
        <tr>
          <td width="52%" height="21"><div align="left" class="style27">&nbsp;Test Name &nbsp;</div></td>
          <td width="12%"><div align="right" class="style27">
            <div align="left">Result &nbsp;</div>
          </div></td>
          <td width="12%"><div align="right" class="style27">
            <div align="left">Unit&nbsp;</div>
          </div></td>
          <td width="20%"><div align="left">Reference&nbsp;</div></td>
        </tr>
		</thead>
		<?php
		$sno = "";
        ...
        <tr>
          <td height="21" valign="top" class="style27">&nbsp;&nbsp;<b></b></td>
          <td valign="top">&nbsp;</td>
          <td valign="top">&nbsp;</td>
          <td valign="top">&nbsp;</td>
        </tr>
		<?php
	  	...
	  	//$query4 = "select * from labtestsales_details where billnumber = '$_REQUEST[billnumber]' and companyanum = '$companyanum' and financialyear = '$financialyear'";
	  	$query4 = "select * from labtestsales_details where billnumber = '$res22bnum' and companyanum = '$companyanum' and financialyear = '$financialyear'";
		$exec4 = mysql_query($query4) or die ("Error in Query4".mysql_error());
		while ($res4 = mysql_fetch_array($exec4))
		{
		$sno = $sno + 1;
		$description = $res4["itemname"];
		$resultvalue = $res4["resultvalue"];
		$referencevalue = $res4["referencevalue"];
		$testunit = $res4["testunit"];
		
		$itemanum = $res4["itemanum"];
		$query8 = "select * from master_itemlab where auto_number = '$itemanum'";
		$exec8 = mysql_query($query8) or die ("Error in Query8".mysql_error());
		$res8 = mysql_fetch_array($exec8);
        ...
        <tr>
        <td height="21" valign="top"><div align="left" class="style27">&nbsp;
			<?php 
          ...
          <div align="left"></div></td>
        <td valign="top"><div align="left"><span class="style27">&nbsp;<?php echo $resultvalue; ?>&nbsp;</span></div></td>
		<td valign="top"><div align="left"><span class="style27">&nbsp;<?php echo $testunit; ?>&nbsp;</span></div></td>
		<td valign="top"><div align="left"><span class="style27">&nbsp;<?php echo nl2br($referencevalue); ?>&nbsp;</span></div></td>
        </tr>
		<?php
		$discounttext = '';
		...
		$tablemaxlines = 20 - $totaldescriptionlines;

...
$stringbuild2 = "";
$query1 = "select * from master_itempharmacy where status <> 'deleted' order by categoryname";
...
$filefolder = 'js';
$filename = 'autocomplete_item1pharmacy.js'; //Intentionally renamed to avoid overwrite of file.

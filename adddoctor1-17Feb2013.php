...
$queryup = "select * from master_doctor where doctorcode='$codeup'";
...
if ($frmflag1 == 'frmflag1')
{
	...
	if ($res2 == 0)
	{
		$query1 = "insert into master_doctor (doctorname, 
		phonenumber,mobilenumber,address, 
		location, city, state, pincode, country,dateposted,doctorcode,rate1) 
		values ('$doctorname', 
		'$phonenumber', '$mobilenumber','$address', 
		...
		//$query10 = "insert into master_hospitalitems(itemcode, itemname, categoryname, unitname_abbreviation, rateperunit,  ipaddress, updatetime) 
		//values ('$doctorcode', '$doctorname', 'PROFESSIONAL CHARGES', 'NOS', '$rate1','$ipaddress', '$updatedatetime')";
		//$exec10 = mysql_query($query10) or die ("Error in Query10".mysql_error());
		
		$errmsg = "Success. New Doctor Added.";
...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top">
      	  ...
      	  <form name="form1" id="form1" method="post" action="adddoctor1.php" onSubmit="return from1submit1()">
          ...
          <td width="860"><table width="95%" height="282" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              ...
              <tr>
                ...
                <td align="left" valign="middle"><input name="city" id="city" value="<?php echo $city; ?>" style="border: 1px solid #001E6A"  size="20" /></td>
				</tr>
				<tr>
                <td align="left" valign="middle" class="bodytext3">State * </td>
                <td align="left" valign="middle"><input name="state" id="state" value="<?php echo $state; ?>" style="border: 1px solid #001E6A"  size="20" /></td>
              
                <td align="left" valign="middle" class="bodytext3">Country </td>
                <td align="left" valign="middle"><input name="country" id="country" value="<?php echo $country; ?>" style="border: 1px solid #001E6A"  size="20" /></td>
				</tr>
				  <tr>
              ...
              <tr>
				...
				<input name="phonenumber" id="phonenumber" value="<?php echo $phonenumber; ?>" style="border: 1px solid #001E6A" size="20" />                </td>
                 ...
                 <td align="left" valign="middle"><input name="doctorcode" id="doctorcode" value="<?php echo $doctorcode; ?>" style="border: 1px solid #001E6A"  size="20" /></td>
              ...
              <tr>
                ...
                <td align="left" valign="middle">
				<input name="dateposted" id="dateposted" value="<?php echo $dateposted; ?>" onKeyDown="return process1backkeypress1()" style="border: 1px solid #001E6A; background-color:#CCCCCC"  size="20"  readonly="readonly" />                </td>
               <td align="left" valign="middle" class="bodytext3">Professional Charges </td>
                <td align="left" valign="middle"><input name="rate1" id="rate1" value="<?php echo $rate1; ?>" onKeyDown="return process1backkeypress1()" style="border: 1px solid #001E6A"  size="20" />                </td>
                </tr>

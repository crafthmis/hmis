    ...
    <td width="99%" valign="top"><table width="1700" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="get" action="doctorsreport1.php">
		<table width="600" border="1" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Doctor Report     - Select Date </strong></td>
            ...
            <tr>
              ...
              <td width="26%" align="left" valign="center" bordercolor="#f3f3f3" bgcolor="#ffffff" class="bodytext31">
            ...
            <tr>
              ...
              <td colspan="3" align="left" valign="top" bordercolor="#F3F3F3">
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="6" align="left" valign="center" bordercolor="#f3f3f3" 
				...
				function printbillreport1()
				{
					...
					window.open("print_billreport1.php?<?php echo $urlpath; ?>","Window1",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
					//window.open("message_popup.php?anum="+anum,"Window1",'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,width=200,height=400,left=312,top=84');
				}
				</script>
			...
			*/
			...
			$query2 = "select * from master_doctor where dateposted between '$quotedatefrom' and '$quotedateto'  order by dateposted desc";
			$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
			while ($res2 = mysql_fetch_array($exec2))
			{
			$code=$res2['doctorcode'];
			$customername = $res2['doctorname'];
			$city = $res2['city'];
           ...
           <tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center" bordercolor="#f3f3f3" align="left"><?php echo $res2loopcount; ?></td>
              <td class="bodytext31" valign="center" bordercolor="#f3f3f3" align="left"><span class="bodytext3"><?php echo $customername;?></span></a></td>
              <td class="bodytext31" valign="center" bordercolor="#f3f3f3" align="left"><?php echo $address;?></td>
			 
              <td class="bodytext31" valign="center" bordercolor="#f3f3f3" align="left"><div align="left"> <?php echo $location; ?></div></td>
			...
			?></div></td>
              <td class="bodytext31" valign="center" bordercolor="#f3f3f3" align="left">
                ...
                <div class="bodytext31"><?php echo $state; ?></div>              </td>
              <td class="bodytext31" valign="center" bordercolor="#f3f3f3" align="left">
			  <?php echo $date1; ?></td>
			  <td class="bodytext31" valign="center" bordercolor="#f3f3f3" align="left">
			 <a href="editdoctor1.php?doctorcode=<?php echo $code;?>"><font class="bodytext3">Edit</font></a></td>
            </tr>
			<?php
			}
			?>

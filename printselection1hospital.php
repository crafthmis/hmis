...
function loadprintpage1()
{
	...
	if (isNaN(varBillNumber))
	{
		alert ("Bill Number Can Only Be Numbers. Please Enter Bill Number Properly.");
		document.getElementById("billnumber").select();
	...
	if (varTitleHeader != 'ALL')
	{
		...
		{
			window.open("print_bill1hospital.php?printsource=printselectionpage&&title1="+varTitleHeader+"&&copy1="+varPrintHeader+"&&billnumber="+varBillNumber,"OriginalWindow<?php echo rand(); //$banum; ?>",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
		}
		if (varPaperSize == "A5 Sheet Paper")
		{
			window.open("print_bill1hospital_a5.php?printsource=printselectionpage&&title1="+varTitleHeader+"&&copy1="+varPrintHeader+"&&billnumber="+varBillNumber,"OriginalWindow<?php echo rand(); //$banum; ?>",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
		}
	}
	else
	{
		...
		if (varPaperSize == "A4 Sheet Paper")
		{
			window.open("print_bill1.php?printsource=printselectionpage&&title1=<?php echo $billtitleheader11; ?>&&copy1="+varPrintHeader+"&&billnumber="+varBillNumber,"OriginalWindow<?php echo $masanum11; ?>",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
		}
		if (varPaperSize == "A5 Sheet Paper")
		{
			window.open("print_bill1_a5.php?printsource=printselectionpage&&title1=<?php echo $billtitleheader11; ?>&&copy1="+varPrintHeader+"&&billnumber="+varBillNumber,"OriginalWindow<?php echo $masanum11; ?>",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
		}
		<?php
		}
		?>
...
function loadmultiprintpage1()
{
	...
	xmlhttp.open("POST","billprintselection1ajax1.php",true);
...
function funcPrintPage1(varPageCount)
{
	...
	if (varPageCount == 1 || varPageCount == 0)
	{
		//alert ("Single Print");
		window.open("print_bill1hospital.php?printsource=printselectionpage&&title1="+varTitleHeader+"&&copy1="+varPrintHeader+"&&billnumber="+varBillNumber,"OriginalWindow<?php echo rand(); //$banum; ?>",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
	}
	else
	{
		...
		for(i=1;i<=varPageCount;i++)
		{
			...
			if (i < varPageCount)
			{
				...
				window.open("print_bill1_multi1part1.php?pagenumber="+varPageNumber+"&&printsource=printselectionpage&&title1="+varTitleHeader+"&&copy1="+varPrintHeader+"&&billnumber="+varBillNumber,"OriginalWindow"+varPageNumber+"",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
			}
			else if (i == varPageCount)
			{
				//alert ("Final Page");
				window.open("print_bill1_multi1part2.php?pagenumber="+varPageNumber+"&&printsource=printselectionpage&&title1="+varTitleHeader+"&&copy1="+varPrintHeader+"&&billnumber="+varBillNumber,"OriginalWindow"+varPageNumber+"",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
			}
		}
	}
}
  ...
  <tr>
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<table width="90%" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Hospital Invoice  Print - Enter Bill Number </strong></td>
            ...
            <tr>
				...
				<input value="<?php //echo $billnumber; ?>" name="billnumber" type="text" id="billnumber" size="10" style="border: 1px solid #001E6A; text-align:right">
            ...
            <tr>
              ...
              <td colspan="2" align="left" valign="top"  bgcolor="#FFFFFF">
              <input onClick="return loadmultiprintpage1()" style="border: 1px solid #001E6A" type="button" value="Print A4 Multi Page" name="billprintmulti" />
			  </td>
            </tr>
          </tbody>
        </table>

...
$query21 = "select auto_number from master_purchase where auto_number = '$res22anum' and financialyear = '$financialyear'";// and recordstatus <> 'DELETED' and companyanum = '$companyanum'";

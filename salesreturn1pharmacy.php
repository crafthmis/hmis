...
$bgcolorcode = "";
$itemcount = "";
$pagename = 'SALES RETURN ENTRY';

$titlestr = 'SALES RETURN';
...
$query88 = "select count(auto_number) as cntanum from master_salesreturnpharmacy";// where lastupdate like '$thismonth%'";
...
if ($frm1submit1 == 'frm1submit1')
{
	...
	{
		//$query19 = "select auto_number,lastupdate from master_salesreturn where auto_number = '$delbillautonumber' and billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'DELETED'";
		$query19 = "select auto_number,lastupdate from master_salesreturnpharmacy where billnumber = '$delbillnumber' and companyanum = '$companyanum'";
		...
		while ($res19 = mysql_fetch_array($exec19))
		{
			...
			//$query15 = "update master_salesreturn set recordstatus = 'DELETED' where auto_number = '$res19anum' and companyanum = '$companyanum'";
			$query15 = "update master_salesreturnpharmacy set recordstatus = 'DELETED' where billnumber = '$delbillnumber' and companyanum = '$companyanum'";
			$exec15 = mysql_query($query15) or die ("Error in Query15".mysql_error());
		
			//$query16 = "update salesreturn_details set recordstatus = 'DELETED' where bill_autonumber = '$res19anum' and companyanum = '$companyanum'";
			$query16 = "update pharmacysalesreturn_details set recordstatus = 'DELETED' where billnumber = '$delbillnumber' and companyanum = '$companyanum'";
			$exec16 = mysql_query($query16) or die ("Error in Query16".mysql_error());
		
			//$query17 = "update salesreturn_tax set recordstatus = 'DELETED' where bill_autonumber = '$res19anum' and companyanum = '$companyanum'";
			$query17 = "update pharmacysalesreturn_tax set recordstatus = 'DELETED' where billnumber = '$delbillnumber' and companyanum = '$companyanum'";
			...
			$query18 = "update master_transactionpharmacy set recordstatus = 'DELETED' where billnumber = '$delbillnumber' and companyanum = '$companyanum'";
			$exec18 = mysql_query($query18) or die ("Error in Query18".mysql_error());
			
			$query20="update master_stock set recordstatus='DELETED' where transactionmodule = 'SALES RETURN' and billnumber = '$delbillnumber' and companyanum = '$companyanum'";
...
include ("salesreturn1include1.php"); //handles all the sales insert operations
...
if ($delbillst == 'billedit' && $delbillnumber != '')
{
	$query41 = "select * from master_salesreturnpharmacy where billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'deleted'";
...
<script type="text/javascript" src="js/autoitemsearch3pharmacy.js"></script> <!-- For mouse click event of item name drop down list. -->
<script type="text/javascript" src="js/salesreturnnovalidation1.js"></script>
...
function loadprintpage1(varPaperSizeCatch)
{
	...
	var varPrintHeader = "SALES RETURN";
...
function funcDefaultTax1() //Function to CST Taxes if required.
{
	...
	if (varDefaultTax != "")
	{
		window.location="salesreturn1pharmacy.php?defaulttax="+varDefaultTax+"";
	}
	else
	{
		window.location="salesreturn1pharmacy.php";
	}
	//return false;
}
...
<form name="frmsales" id="frmsales" method="post" action="salesreturn1pharmacy.php" onKeyDown="return disableEnterKey(event)">
    ...
    <td width="99%" valign="top"><table width="980" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="100%"><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
                <td bgcolor="#CCCCCC" class="bodytext3"><p><strong>Sales Return </strong></p>                  </td>
			  ...
			  <tr>
                ...
                <td width="6%" align="left" valign="middle" class="bodytext3"><strong>Doctor</strong></td>
                <td width="31%" align="left" valign="top" ><span class="bodytext3"><span class="style6"><span class="bodytext312"><a href="javascript:displayDatePicker('ADate1', false, 'ymd', '-');"></a></span></span></span>
                  <input name="deliveryaddress" type="hidden" id="deliveryaddress" style="border: 1px solid #001E6A" value="<?php echo $res41deliveryaddress; ?>" size="25">
				...
				?>
                  ...
                  <strong>
                  <input type="hidden" name="customertin" id="customertin" value="<?php echo $res41tinnumber; ?>" style="border: 1px solid #001E6A"  size="10" />
                  <strong>
                  <input type="hidden" name="customercst" id="customercst" value="<?php echo $res41cstnumber; ?>" style="border: 1px solid #001E6A"  size="10" />
		...
		<table id="newtable" style="BORDER-COLLAPSE: collapse" 
            ...
            <tbody id="tblrowinsert">
              <tr>
                ...
                bgcolor="#FFCC00" class="bodytext31"><strong><!--Rate-->MRP</strong></td>
                <td width="5%" align="left" valign="center"  
                bgcolor="#FFCC00" class="bodytext31"><strong>Qty </strong></td>
                <td width="5%" align="left" valign="center"  
                bgcolor="#FFCC00" class="style7">Batch</td>
                <td width="5%" align="left" valign="center"  
                ...
                <td width="7%" align="left" valign="center"  
                bgcolor="#FFCC00" class="bodytext31"><strong><!--ReverseTax--></strong></td>
              </tr>
				<?php
				//To populate items already in the bill if in edit mode.
				include ('salesreturn_edit1listing1.php');
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
            ...
            <tr>
			  ...
			  <input onKeyDown="return itemcodekeypress1(event)" name="itemcode" id="itemcode" style="border: 1px solid #001E6A; text-align:left;text-transform: uppercase;" value="" size="8" /></td>
			  ...
			  <input type="hidden" onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemmrp" value="0.00" id="itemmrp" style="border: 1px solid #001E6A; text-align:right" size="4" />
			  ...
			  <input type="hidden" onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemdiscountpercent" value="0.00" id="itemdiscountpercent" style="border: 1px solid #001E6A; text-align:right" size="2" />
			  <strong>
			  <input type="hidden" name="batchnumberdummy" id="batchnumberdummy" onBlur="return funcBatchNumberVerify1()" value="<?php //echo $batchnumber; ?>" style="border: 1px solid #001E6A"  size="5" />
			  <select name="batchnumber" id="batchnumber" onFocus="return funcBatchNumberPopulate1()" >
			  ...
			  <strong>
			  <input name="expirydate" id="expirydate" readonly="readonly" onFocus="return funcBatchNumberVerify1()" value="<?php //echo $batchnumber; ?>" style="border: 1px solid #001E6A"  size="5" />
              ...
              <input onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemtaxpercent" value="0.00" id="itemtaxpercent" readonly="readonly" style="border: 1px solid #001E6A; text-align:right" size="3" />
            ...
            <tr>
              ...
              <td align="left" valign="center"  bgcolor="#FFFFFF" class="bodytext31"><strong>
                <input type="hidden" name="itemdescription" id="itemdescription" style="border: 1px solid #001E6A; text-align:left" value="" size="60">
              </strong></td>
...
-->
                ...
                bgcolor="#F3F3F3" class="bodytext31"><span class="bodytext311">
                    ...
                    <td width="37%"><span class="bodytext312">
...
bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong>Cash Amount </strong></div></td>
              ...
              <tr id="cashamounttr2">
                <td colspan="7" align="left" valign="center"  
bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong>Enter Cash Returned To Patient </strong></div></td>
                <td align="left" valign="top" ><span class="bodytext31">

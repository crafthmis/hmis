...
$query91 = "select count(auto_number) as masterscount from settings_deliverychallan where companyanum = '$companyanum'";
...
if ($res91count == 0)
{
	header ("location:settingsdeliverychallan1.php?svccount=firstentry");
	exit;
}
...
$query88 = "select count(auto_number) as cntanum from master_dccustomer";// where lastupdate like '$thismonth%'";
...
if ($frm1submit1 == 'frm1submit1')
{
	...
	{
		//$query19 = "select auto_number,lastupdate from master_dccustomer where auto_number = '$delbillautonumber' and billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'DELETED'";
		$query19 = "select auto_number,lastupdate from master_dccustomer where billnumber = '$delbillnumber' and companyanum = '$companyanum'";
		...
		while ($res19 = mysql_fetch_array($exec19))
		{
			...
			//$query15 = "update master_dccustomer set recordstatus = 'DELETED' where auto_number = '$res19anum' and companyanum = '$companyanum'";
			$query15 = "update master_dccustomer set recordstatus = 'DELETED' where billnumber = '$delbillnumber' and companyanum = '$companyanum'";
			$exec15 = mysql_query($query15) or die ("Error in Query15".mysql_error());
		
			//$query16 = "update dccustomer_details set recordstatus = 'DELETED' where bill_autonumber = '$res19anum' and companyanum = '$companyanum'";
			$query16 = "update dccustomer_details set recordstatus = 'DELETED' where billnumber = '$delbillnumber' and companyanum = '$companyanum'";
			$exec16 = mysql_query($query16) or die ("Error in Query16".mysql_error());
		
			//$query17 = "update dccustomer_tax set recordstatus = 'DELETED' where bill_autonumber = '$res19anum' and companyanum = '$companyanum'";
			$query17 = "update dccustomer_tax set recordstatus = 'DELETED' where billnumber = '$delbillnumber' and companyanum = '$companyanum'";
			...
			*/
			$query20="update master_stock set recordstatus='DELETED' where transactionmodule = 'DC CUSTOMER' and billnumber = '$delbillnumber' and companyanum = '$companyanum'";
...
include ("deliverychallancustomer1include1.php"); //handles all the sales insert operations
...
if ($delbillst == 'billedit' && $delbillnumber != '')
{
	$query41 = "select * from master_dccustomer where billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'deleted'";
...
<script type="text/javascript" src="js/dccustomernovalidation1.js"></script>
...
function loadprintpage1(varPaperSizeCatch)
{
	...
	var varPrintHeader = "DELIVERY CHALLAN";
	...
	if (varPaperSize == "A4")
	{
		window.open("print_bill1_deliverychallancustomer1.php?printsource=billpage&&billautonumber="+varBillAutoNumber+"&&companyanum="+varBillCompanyAnum+"&&title1="+varTitleHeader+"&&copy1="+varPrintHeader+"&&billnumber="+varBillNumber+"","OriginalWindow<?php echo $banum; ?>",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
	}
	if (varPaperSize == "A5")
	{
		window.open("print_bill1_deliverychallancustomer1_a5.php?printsource=billpage&&billautonumber="+varBillAutoNumber+"&&companyanum="+varBillCompanyAnum+"&&title1="+varTitleHeader+"&&copy1="+varPrintHeader+"&&billnumber="+varBillNumber+"","OriginalWindow<?php echo $banum; ?>",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
	}
...
<form name="frmsales" id="frmsales" method="post" action="deliverychallancustomer1.php" onKeyDown="return disableEnterKey(event)">
  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="950" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="100%"><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
                <td bgcolor="#CCCCCC" class="bodytext3"><strong>DC Customer   </strong></td>
                ...
                <td width="9%" bgcolor="#CCCCCC" class="bodytext3"><strong>Bill Date </strong></td>
                <td width="13%" bgcolor="#CCCCCC" class="bodytext3"><span class="bodytext312">
	...
	//$delBillSt = $_REQUEST["delbillst"];
			  ...
			  <tr>
				...
				<input name="customer" id="customer" style="border: 1px solid #001E6A; text-transform:uppercase" value="<?php echo $res41customername; ?>" size="40" autocomplete="off"/>
                ...
                <td align="left" valign="top" ><span class="bodytext3">
                  <input name="customercode" id="customercode" style="border: 1px solid #001E6A" value="<?php echo $res41customercode; ?>" size="10" readonly="readonly" rsize="20" />
                </span></td>
                <td width="6%" align="left" valign="middle"  bgcolor="#E0E0E0"  class="bodytext3"><strong>Delivery</strong></td>
                <td width="23%" rowspan="3" align="left" valign="top" ><span class="bodytext3"><span class="style6"><span class="bodytext312"><a href="javascript:displayDatePicker('ADate1', false, 'ymd', '-');"></a></span></span></span>
			  ...
			  <tr>
			    ...
			    <td align="left" valign="top" >
				<input name="address1" id="address1" style="border: 1px solid #001E6A;text-transform: uppercase;" value="<?php echo $res41address1; ?>" size="30" />
			      <span class="style4">Area </span>
			      <input name="area" id="area" style="border: 1px solid #001E6A;text-transform: uppercase;" value="<?php echo $res41area; ?>"  size="10" /></td>
			    ...
			    <td align="left" valign="top" ><span class="bodytext3"><strong>
			      <input name="customertin" id="customertin" style="border: 1px solid #001E6A" value="<?php echo $res41tinnumber; ?>"  size="10" />
			    </strong></span></td>
			  ...
			  <tr>
			    ...
			    <td align="left" valign="top" ><input name="city1" id="city1" style="border: 1px solid #001E6A;text-transform: uppercase;" value="<?php echo $res41city; ?>"  size="10" />
			      <span class="bodytext3"><strong>Pincode</strong></span> <input name="pincode" id="pincode" style="border: 1px solid #001E6A;text-transform: uppercase;" value="<?php echo $res41pincode; ?>" size="10" /></td>
			    <td align="left" valign="top" ><span class="bodytext3"><strong>CST No.</strong></span></td>
			    <td align="left" valign="top" ><span class="bodytext3"><strong>
			      <input name="customercst" id="customercst" style="border: 1px solid #001E6A" value="<?php echo $res41cstnumber; ?>"  size="10" />
			    </strong></span></td>
		...
		<table id="newtable" style="BORDER-COLLAPSE: collapse" 
            ...
            <tbody id="tblrowinsert">
              <tr>
				...
				include ('deliverychallancustomer_edit1listing1.php');
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
            ...
            <tr>
              ...
              <td width="6%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
			  <input type="hidden" onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemdiscountpercent" value="0.00" id="itemdiscountpercent" style="border: 1px solid #001E6A; text-align:right" size="2" /></td>
              <td width="6%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
			  <input type="hidden" onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemdiscountrupees" value="0.00" id="itemdiscountrupees" style="border: 1px solid #001E6A; text-align:right" size="3" /></td>
              <td width="6%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><span class="bodytext311">
              <input type="hidden" onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemtaxpercent" value="0.00" id="itemtaxpercent" readonly="readonly" style="border: 1px solid #001E6A; text-align:right" size="2" />
            ...
            <tr>
              ...
              <td colspan="9" align="left" valign="center"  bgcolor="#FFFFFF" class="bodytext31"><strong>
                <textarea name="itemdescription" cols="60" rows="2" id="itemdescription" style="border: 1px solid #001E6A;"></textarea>
        ...
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            ...
            <tbody id="foo">
              ...
              <tr>
				...
				bgcolor="#F3F3F3" class="bodytext31"><div align="right"><span class="bodytext311"><strong><!--All Item Discount Percent Apply %--><strong></strong> </strong></span></div></td>
				...
				style="border: 1px solid #001E6A; text-align:right;" value="0.00" size="8" />
                ...
                bgcolor="#F3F3F3" class="bodytext31"><span class="bodytext311">
                    ...
                    <td width="25%"><span class="bodytext312">
                ...
                <td width="20%" rowspan="2" align="right" valign="center"  
              ...
              <tr>
                ...
                <td align="left" valign="top" ><span class="bodytext312">
                  ...
                  <span class="bodytext311">
                   <input type="hidden" name="packaging" id="packaging" value="0.00" onKeyDown="return funcResetPaymentInfo1()" onBlur="return funcbillamountcalc1()" style="border: 1px solid #001E6A; text-align:right" size="8"/>
                 <input type="hidden" name="delivery" id="delivery" value="0.00" onKeyDown="return funcResetPaymentInfo1()" onBlur="return funcbillamountcalc1()" style="border: 1px solid #001E6A; text-align:right" size="8"/>
                  </span></span></td>
              </tr>
              <tr>
                <td align="left" valign="center"  
...
bgcolor="#F3F3F3" class="bodytext31">&nbsp;</td>
				...
				<select name="billtype" id="billtype" onChange="return paymentinfo()">
					...
					<option value="DC">DC CUSTOMER</option>
                    <!--
...
bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong>Cash Amount </strong></div></td>
                <td align="left" valign="top" ><span class="bodytext31">
                  ...
                  <span class="bodytext311">
                  <input type="hidden" name="cashgivenbycustomer" id="cashgivenbycustomer" onBlur="return funcbillamountcalc1()" onFocus="return cashentryonfocus1()" tabindex="2" value="0.00" style="border: 1px solid #001E6A; text-align:right" size="8"  />
                  <input type="hidden" name="cashgiventocustomer" id="cashgiventocustomer" onBlur="return funcbillamountcalc1()" value="0.00" style="border: 1px solid #001E6A; text-align:right" size="8" readonly="readonly"  />
                  </span></span></td>
              </tr>
...
bgcolor="#F3F3F3" class="bodytext31"><span class="bodytext32"><strong><?php echo $f18;?></strong></span>
                  <input type="text" name="footerline1" id="footerline1" style="border: 1px solid #001E6A"  size="10" />                  
				  <span class="bodytext32"><strong><?php echo $f19;?></strong></span>                  
				  <input  type="text" name="footerline2" id="footerline2" style="border: 1px solid #001E6A"  size="10" /></td>
                <td colspan="2" align="left" valign="center"  
bgcolor="#F3F3F3" class="bodytext31"><div align="right"><strong>Nett Amount</strong></div></td>
              ...
              <tr>
                ...
                bgcolor="#CCCCCC" class="bodytext31"><div align="left"><span class="bodytext32"><strong><?php echo $f21;?></strong></span>
                  <input type="text" name="footerline3" id="footerline3" style="border: 1px solid #001E6A"  size="10" />
                  <span class="bodytext32"><strong><?php echo $f22;?></strong></span><span class="bodytext311">
                  <input type="text" name="footerline4" id="footerline4" style="border: 1px solid #001E6A"  size="10" />
            ...
            <tr>
              ...
              <td width="46%" align="left" valign="top" ><div align="right"><span class="bodytext31">
                ...
                <!--<input name="print4inch2" type="button" class="button" id="print4inch2" style="border: 1px solid #001E6A" 
				  onClick="return quickprintbill1dccustomer()" value="Print 40" accesskey="p"/>-->
				  ...
				  onClick="return quickprintbill2dccustomer()" value="View 40" accesskey="p"/>-->

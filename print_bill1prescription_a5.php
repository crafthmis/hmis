...
//{
	...
	if ($printsource == '')
	{
		//$query22 = "select * from master_salesprescription where auto_number = '$banum'";// and recordstatus <> 'DELETED' and companyanum = '$companyanum'";
		$query22 = "select * from master_salesprescription where auto_number = '$billautonumber' and companyanum = '$companyanum' and financialyear = '$financialyear'";
	}
	if ($printsource == 'billpage')
	{
		//$query22 = "select * from master_salesprescription where auto_number = '$banum'";// and recordstatus <> 'DELETED' and companyanum = '$companyanum'";
		$query22 = "select * from master_salesprescription where billnumber = ".$_REQUEST["billnumber"]." and recordstatus <> 'DELETED' and companyanum = '$companyanum' and financialyear = '$financialyear'";
	}
	else if ($printsource == 'printselectionpage')
	{
		//$query22 = "select * from master_salesprescription where billnumber = '$banum' and status <> 'CANCELLED' and companyanum = '$companyanum' and recordstatus <> 'DELETED'";
		$query22 = "select * from master_salesprescription where billnumber = ".$_REQUEST["billnumber"]." and recordstatus <> 'DELETED' and companyanum = '$companyanum' and financialyear = '$financialyear'";
	}
...
$query2 = "select * from settings_billprescription where companyanum = '$companyanum'";
...
//$query21 = "select auto_number from master_salesprescription where billnumber = '$banum' and companyanum = '$companyanum' and recordstatus <> 'DELETED'";
$query21 = "select auto_number from master_salesprescription where auto_number = '$res22anum' and financialyear = '$financialyear'";// and recordstatus <> 'DELETED' and companyanum = '$companyanum'";
$exec21 = mysql_query($query21) or die ("Error in Query21".mysql_error());
$res21 = mysql_fetch_array($exec21);
$res21anum = $res21["auto_number"];

$query3 = "select * from master_salesprescription where auto_number = '$res21anum' and companyanum = '$companyanum' and financialyear = '$financialyear'";
...
$discountexists = "";
$query4 = "select * from prescriptionsales_details where bill_autonumber = '$billautonumber' and companyanum = '$companyanum' and financialyear = '$financialyear'";
$exec4 = mysql_query($query4) or die ("Error in Query4".mysql_error());
  ...
  <tr>
	...
	?>
      <table width="99%" border="0" align="left" cellpadding="0" cellspacing="0">
        <tr>
		<?php include ("print_showlogo1prescription.php"); ?>
          ...
          <td valign="top" width="50%"><table width="97%" border="0" align="left" cellpadding="0" cellspacing="0">
              <tr>
                <td><div align="left" class="style27"><span class="style6"> <?php echo $f13; ?></span></div>
                    <div align="left" class="style27"><span class="style6"> <font> <?php echo $f14.' '.$customername; ?></font></span></div>
	...
	<table width="98%" border="1" align="left" cellpadding="0" cellspacing="0" frame="box" rules="groups" class="sample">
      ...
      <thead>
        <tr>
          ...
          <td width="44%"><div align="left" class="style27">&nbsp;Description&nbsp;</div></td>
          <td width="8%"><div align="right" class="style27">
              <div align="center">Quantity</div>
          </div></td>
          <td width="16%"><div align="right" class="style27">
              <div align="center">Morning</div>
          </div></td>
          <td width="14%"><div align="center">Noon</div></td>
          <td width="14%"><div align="right" class="style27">
		...
		$query9 = "select * from prescriptionsales_tax where  bill_autonumber = '$billautonumber' and itemanum = '$itemanum' and companyanum = '$companyanum' and financialyear = '$financialyear'";
        ...
        <td valign="top"><div align="left" class="style27">
          ...
          <div align="left"></div></td>
        <td valign="top"><div align="center"><span class="style27">&nbsp;<?php echo $quantity; ?>&nbsp;</span></div></td>
        <td valign="top"><div align="center"><span class="style27">&nbsp;<?php echo $morning; ?>&nbsp;</span></div></td>
        <td valign="top"><div align="center"><span class="style27">&nbsp;<?php echo $noon; ?>&nbsp;</span></div></td>
        <td valign="top"><div align="center"><span class="style27">&nbsp;<?php echo $night; ?>&nbsp;</span></div></td>
        </tr>
		<?php
		$discounttext = '';
		...
		$query5 = "select * from master_salesprescription where auto_number = '$res21anum' and recordstatus <> 'deleted' and financialyear = '$financialyear'";
		$exec5 = mysql_query($query5) or die ("Error in Query5".mysql_error());
		$res5 = mysql_fetch_array($exec5);

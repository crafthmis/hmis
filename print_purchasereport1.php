...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
  ...
  <tbody>
            ...
            <tr>
              <td colspan="17" align="left" valign="center" bordercolor="#f3f3f3" bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Purchase Report</strong></div></td>
            </tr>
            <tr>
			...
			*/
			...
			//$query2 = "select * from master_purchase where suppliername like '%$suppliername%' and billnumber like '%$cbbillnumber%' and recordstatus = '$billstatus' and billtype like '%$paymenttype%' and companyanum = '$companyanum' and lastupdate between '$transactiondatefrom' and '$transactiondateto' order by lastupdate desc";
			$query2 = "select * from master_purchase where suppliername like '%$suppliername%' and billnumber like '%$cbbillnumber%' and 
			$billstatusquery1 and billtype like '%$paymenttype%' and companyanum = '$companyanum' and 
			...
			from master_transaction where billnumber = '$res2billnumber' and customeranum = '0' and customername = '' and 

...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
  ...
  <tbody>
            ...
            <tr>
              <td colspan="18" align="left" valign="center" bordercolor="#f3f3f3" bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Proforma Invoice Report</strong></div></td>
            </tr>
            <tr>
			...
			*/
			...
			$query2 = "select * from master_proformainvoice where customername like '%$customername%' and billnumber like '%$cbbillnumber%' 
			...
			$query21 = "select sum(taxamount) as sumtaxamount from proformainvoice_tax where bill_autonumber = '$res2anum'  

...
if ($frmflag1 == 'frmflag1')
{
	...
	if ($length1<25 && $length2<255)
	{
		...
		if ($res2 == 0)
		{
			$query1 = "insert into master_itempharmacy (itemcode, itemname, categoryname, unitname_abbreviation, rateperunit, expiryperiod, taxanum, taxname, ipaddress, updatetime, description, purchaseprice, packageanum, packagename) 
			values ('$itemcode', '$itemname', '$categoryname', '$unitname_abbreviation', '$rateperunit', '$expiryperiod', '$taxanum', '$res4taxname', '$ipaddress', '$updatedatetime','$description', '$purchaseprice', '$packageanum', '$packagename')";
                  ...
                  <table width="900" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td align="left" valign="top"  bgcolor="#E0E0E0"><input type="text" name="purchaseprice" id="purchaseprice" style="border: 1px solid #001E6A" value="<?php echo $purchaseprice; ?>" size="20" /></td>
                      </tr>
                      <tr>
...
-->					  
                ...
                <table width="900" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="11" bgcolor="#CCCCCC" class="bodytext3"><span class="bodytext32"><strong>Pharmacy Item Master - Existing List - Latest 100 Pharmacy Items </strong></span></td>
                      </tr>
                      <tr bgcolor="#011E6A">
                      ...
                      <tr bgcolor="#011E6A">
                        ...
                        <td width="7%" bgcolor="#CCCCCC" class="bodytext3"><strong>Pack</strong></td>
	...
	$query1 = "select * from master_itempharmacy where status <> 'deleted' order by auto_number desc LIMIT 100";
		...
		?>
                ...
                <table width="900" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="9" bgcolor="#CCCCCC" class="bodytext3"><strong>Pharmacy Item Master - Deleted </strong></td>
                      </tr>
                      <tr bgcolor="#011E6A">
                      ...
                      <tr bgcolor="#011E6A">
                        ...
                        <td width="10%" bgcolor="#CCCCCC" class="bodytext3"><strong>Pack</strong></td>

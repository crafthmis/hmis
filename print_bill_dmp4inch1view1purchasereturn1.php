...
<tr>
<td colspan="5">
PURCHASE RETURN BILL NO: <?php echo $billnumberprefix.$billnumber.$billnumberpostfix; ?></td>
</tr>
<tr>
<td colspan="5">
...
?>
<?php
$query41 = "select *, sum(taxamount) as sumtaxamount from purchasereturn_tax  where bill_autonumber = '$billautonumber' and recordstatus <> 'deleted' and companyanum = '$companyanum' group by tax_autonumber, taxname order by auto_number";

...
//to redirect if there is no entry in masters category or item or customer or settings
$query91 = "select count(auto_number) as masterscount from settings_billprescription where companyanum = '$companyanum'";
$exec91 = mysql_query($query91) or die ("Error in Query91".mysql_error());
$res91 = mysql_fetch_array($exec91);
$res91count = $res91["masterscount"];
if ($res91count == 0)
{
	header ("location:settingsbill1prescription.php?svccount=firstentry");
	exit;
}
...
$query88 = "select count(auto_number) as cntanum from master_salesprescription";// where lastupdate like '$thismonth%'";
...
if ($frm1submit1 == 'frm1submit1')
{
	...
	{
		//$query19 = "select auto_number,lastupdate from master_salesprescription where auto_number = '$delbillautonumber' and billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'DELETED'";
		$query19 = "select auto_number,lastupdate from master_salesprescription where billnumber = '$delbillnumber' and companyanum = '$companyanum' and financialyear = '$financialyear'";
		...
		while ($res19 = mysql_fetch_array($exec19))
		{
			...
			//$query15 = "update master_salesprescription set recordstatus = 'DELETED' where auto_number = '$res19anum' and companyanum = '$companyanum'";
			$query15 = "update master_salesprescription set recordstatus = 'DELETED' where billnumber = '$delbillnumber' and companyanum = '$companyanum' and financialyear = '$financialyear'";
			$exec15 = mysql_query($query15) or die ("Error in Query15".mysql_error());
		
			//$query16 = "update prescriptionsales_details set recordstatus = 'DELETED' where bill_autonumber = '$res19anum' and companyanum = '$companyanum'";
			$query16 = "update prescriptionsales_details set recordstatus = 'DELETED' where billnumber = '$delbillnumber' and companyanum = '$companyanum' and financialyear = '$financialyear'";
			$exec16 = mysql_query($query16) or die ("Error in Query16".mysql_error());
		
			//$query17 = "update prescriptionsales_tax set recordstatus = 'DELETED' where bill_autonumber = '$res19anum' and companyanum = '$companyanum'";
			$query17 = "update prescriptionsales_tax set recordstatus = 'DELETED' where billnumber = '$delbillnumber' and companyanum = '$companyanum' and financialyear = '$financialyear'";
...
include ("sales1include1prescription.php"); //handles all the sales insert operations
...
if ($delbillst == 'billedit' && $delbillnumber != '')
{
	$query41 = "select * from master_salesprescription where billnumber = '$delbillnumber' and companyanum = '$companyanum' and financialyear = '$financialyear' and recordstatus <> 'deleted'";
...
<?php include ("js/sales1scripting1prescription.php"); ?>
<?php include ("js/dropdownlist1scripting1.php"); ?>

<script type="text/javascript" src="js/salesinsertitem1prescription.js"></script>
...
<script type="text/javascript" src="js/autoitemsearch3pharmacy.js"></script> <!-- For enter key selection and mouse click event of item name drop down list. -->
...
function funcDefaultTax1() //Function to CST Taxes if required.
{
	...
	if (varDefaultTax != "")
	{
		...
		{
		?>
		window.location="sales1prescription.php?defaulttax="+varDefaultTax+"&&delbillst=<?php echo $delBillSt; ?>&&delbillautonumber="+<?php echo $delBillAutonumber; ?>+"&&delbillnumber="+<?php echo $delBillNumber; ?>+"";
		<?php
		}
		else
		{
		?>
		window.location="sales1prescription.php?defaulttax="+varDefaultTax+"";
		<?php
		}
		?>
	}
	...
	{
		window.location="sales1prescription.php";
	}
	//return false;
}
...
<form name="frmsales" id="frmsales" method="post" action="sales1prescription.php" onKeyDown="return disableEnterKey(event)">
...
-->
  <tr>
    <td width="0%">&nbsp;</td>
    <td width="100%" valign="top"><table width="1299" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="1299"><table width="100%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td bgcolor="#CCCCCC" class="bodytext3"><strong>Prescription Entry </strong></td>
              ...
              <td width="5%" bgcolor="#CCCCCC" class="bodytext3"><strong> Date </strong></td>
              <td width="7%" bgcolor="#CCCCCC" class="bodytext3"><span class="bodytext312">
...
-->              </td>
            ...
            <?php
			  ...
			  ?>
            <tr>
              <td colspan="6" align="left" valign="middle"  bgcolor="#FFFF00" class="bodytext3"> * Success. Bill Saved. Click  Print Button To Print or View Previous Bill
	...
	//$delBillSt = $_REQUEST["delbillst"];
            ...
            <?php
			  ...
			  ?>
            <tr>
              <td width="6%" align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><strong>Patient  * </strong></td>
              <td width="34%" align="left" valign="top" ><input name="customer" id="customer" value="<?php echo $res41customername; ?>" style="border: 1px solid #001E6A;" size="40" autocomplete="off"/>
              ...
              <td align="left" valign="top" ><input name="customercode" id="customercode" value="<?php echo $res41customercode; ?>" style="border: 1px solid #001E6A" readonly="readonly" size="12" rsize="20" /></td>
              <td align="left" valign="middle"  bgcolor="#E0E0E0"  class="bodytext3">&nbsp;</td>
              <td align="left" valign="top" ><!--<textarea name="deliveryaddress" cols="25" rows="3" id="deliveryaddress" style="border: 1px solid #001E6A"><?php //echo $res41deliveryaddress; ?></textarea>--></td>
            </tr>
            <tr>
              <td align="left" valign="middle"  bgcolor="#E0E0E0" class="bodytext3"><span class="style4">Address 1 </span></td>
              <td align="left" valign="top" ><input name="address1" id="address1" value="<?php echo $res41address1; ?>" style="border: 1px solid #001E6A;text-transform: uppercase;" size="30" />
              ...
              <td align="left" valign="top" ><span class="bodytext3"><strong>Doctor</strong></span></td>
        ...
        <td><table id="newtable" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="tblrowinsert">
            <tr>
              ...
              <td width="4%" align="left" valign="center"  
                bgcolor="#FFCC00" class="bodytext311"><strong>Qty</strong></td>
              <td width="2%" align="left" valign="center"  
                bgcolor="#FFCC00" class="bodytext311">&nbsp;</td>
              <td width="6%" align="left" valign="center"  
                bgcolor="#FFCC00" class="bodytext311"><strong>Morning</strong></td>
              <td width="7%" align="left" valign="center"  
                bgcolor="#FFCC00" class="bodytext311"><strong>Noon</strong></td>
              <td width="6%" align="left" valign="center"  
                bgcolor="#FFCC00" class="bodytext311"><strong>Night</strong></td>
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
            <tr>
              ...
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">&nbsp;</td>
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">&nbsp;</td>
              <td width="3%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><span class="bodytext311"><strong>Qty</strong></span></td>
              <td width="3%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">&nbsp;</td>
              <td width="6%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><span class="bodytext311"><strong>Morning</strong></span></td>
              <td width="25%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><span class="bodytext311"><strong>Noon</strong></span></td>
              <td width="9%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><span class="bodytext311"><strong>Night</strong></span></td>
              <td width="2%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">&nbsp;</td>
              <td width="14%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">&nbsp;</td>
            </tr>
            <tr>
              ...
              <td width="27%" align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">
              ...
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><span class="bodytext311">
                <input onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemquantity" onFocus="javascript:this.select()" value="1" id="itemquantity" autocomplete="off" style="border: 1px solid #001E6A; text-align:right" size="4" />
              </span></td>
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">&nbsp;</td>
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><span class="bodytext311">
                <input name="morning" id="morning" value="" style="border: 1px solid #001E6A; text-align:left;" size="8"  />
                <input type="hidden" onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemmrp" onFocus="javascript:this.select()" value="0.00" id="itemmrp" style="border: 1px solid #001E6A; text-align:right" size="6" />
              </span></td>
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><span class="bodytext311">
                <input name="noon" id="noon" value="" style="border: 1px solid #001E6A; text-align:left;" size="8"  />
...
<input type="hidden" id="itemtaxname" name="itemtaxname" value="">
              ...
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><span class="bodytext311">
                <input name="night" id="night" value="" style="border: 1px solid #001E6A; text-align:left;" size="8"  />
              ...
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31">&nbsp;</td>
              <td align="left" valign="center"  bgcolor="#66CC00" class="bodytext31"><input name="Submit22222" type="button" value="Add" onClick="return insertitem1()" class="button" style="border: 1px solid #001E6A"/>			  <span class="bodytext311">
...
bgcolor="#F3F3F3" class="bodytext31"><div align="right"></div></td>
              ...
              <tr>
                ...
                bgcolor="#CCCCCC" class="bodytext31"><div align="right"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif"><font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
				  ...
				  <input name="Submit2223" type="button" onClick="return funcSaveBill1()" value="Save Prescription" accesskey="b" class="button" style="border: 1px solid #001E6A"/>
          ...
          <tbody>
            <tr>
              ...
              <td width="46%" align="left" valign="top" ><div align="right"><span class="bodytext31">
                <strong>Print Prescription No: </strong>

...
if ($frmflag1 == 'frmflag1')
{
	...
	if ($fileformat == 'txt') // || $fileformat == 'peg') // || $fileformat == 'gif')
	{
		...
		{
			header ("location:dataimport2lab2.php?upload=success");
		}
		else
		{
			header ("location:dataimport1lab1.php?upload=failed");
		}
...
function dataimport1lab1verify()
{
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form action="dataimport1lab1.php" method="post" enctype="multipart/form-data" name="form1" id="form1" onSubmit="return dataimport1lab1verify()">
                  <table width="800" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Lab Item  Data Import From TAB Delimited File </strong></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3">&nbsp;</td>
                        <td align="left" valign="top"  bgcolor="#FFFFFF"><span class="bodytext32"><strong>Please Make Sure You Have Category / Units / Taxes Already In Masters. </strong></span></td>
                      </tr>
                      <tr>

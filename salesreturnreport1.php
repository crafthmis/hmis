...
&nbsp;				<input value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" />
			...
			$query2 = "select * from master_salesreturnpharmacy where customername like '%$customername%' and 
			...
			$query21 = "select sum(taxamount) as sumtaxamount from pharmacysalesreturn_tax where bill_autonumber = '$res2anum' and 
			...
			from master_transactionpharmacy where billnumber = '$res2billnumber' and transactiontype = 'PAYMENT' and 
			transactiontype = 'PAYMENT' and companyanum = '$companyanum' and 
			transactionmodule = 'sales return' and 
			supplieranum = '0' and suppliername = '' and cstid='$custid' and cstname='$custname' and $billstatusquery1";
			...
			?>
			  ...
			  {
			  ?>
                  <a href="salesreturn1pharmacy.php?delbillst=billedit&&delbillautonumber=<?php echo $billautonumber; ?>&&delbillnumber=<?php echo $billnumber; ?>" class="bodytext3" target="_blank"><span class="bodytext3">Edit</span></a>
                  <?php
			  }
			  ?>
              </div></td>

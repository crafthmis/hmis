	...
	*/
	...
	for ($i=1;$i<=1000;$i++)
	{
		...
		if ($serialnumber != '')
		{
			...
			$query43 = "select * from master_itempharmacy where itemcode = '$itemcode' and packagename = ''";
			$exec43 = mysql_query($query43) or die ("Error in Query43".mysql_error());
			$rowcount43 = mysql_num_rows($exec43);
			if ($rowcount43 != 0)
			{
				$query44 = "update master_itempharmacy set packageanum = '$packageanum', packagename = '$packagename' 

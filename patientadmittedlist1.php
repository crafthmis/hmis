    ...
    <td width="99%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
            <tr>
              <td colspan="13" bgcolor="#cccccc" class="bodytext31"><div align="left"><strong>Patients Admitted List - In Patients</strong></div>                </td>
                </tr>
            <tr>
            ...
            <tr>
              <td class="bodytext31" valign="center"  align="left" 
                ...
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Admission Date </strong></div></td>
                  <td  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Admission Time </strong></div></td>
            ...
            <?php
			  ...
			  $query2 = "select * from master_patientadmission where dischargecompleted = '' order by auto_number desc";// where customername like '%$searchcustomer%' and customercode like '%$customercode%' and status like '%$status%' order by customername limit 0, 500";
            ...
            <tr <?php echo $colorcode; ?>>
              <td class="bodytext31" valign="center"  align="left"><?php echo $colorloopcount; ?></td>
                  <td  align="left" valign="center" class="bodytext31"><div align="left"><?php echo $admissiondate; ?></div></td>
                  <td  align="left" valign="center" class="bodytext31"><div align="left"><?php echo $admissiontime; ?></div></td>
                  <td class="bodytext31" valign="center"  align="left">
                  ...
                  <td  align="left" valign="center" class="bodytext31"><div align="center"> <a href="patienthistory1.php?customercode=<?php echo $patientcode; ?>" class="bodytext3"> <span class="bodytext3">History</span> </a> </div></td>
                  <td  align="left" valign="center" class="bodytext31"><div align="center"> <a href="patientdischarge2.php?customercode=<?php echo $patientcode; ?>" class="bodytext3"> <span class="bodytext3">Discharge</span> </a> </div></td>
                  <td class="bodytext31" valign="center"  align="left">
                  <div align="left"><?php echo $dischargecompleted; ?></div></td>
                </tr>
            <?php
			  }
			  //}

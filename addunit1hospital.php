...
if ($frmflag1 == 'frmflag1')
{
	...
	if ($len1<=25 && $len2<=10)
	{
	$query2 = "select * from master_unitshospital where unitname = '$unitname' and unitname_abbreviation = '$unitname_abbreviation'";
	$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
	$res2 = mysql_num_rows($exec2);
	if ($res2 == 0)
	{
		$query1 = "insert into master_unitshospital (unitname, ipaddress, updatetime, unitname_abbreviation) 
...
if ($st == 'del')
{
	$query3 = "update master_unitshospital set status = 'deleted' where auto_number = '$delanum'";
	$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
}
if ($st == 'activate')
{
	$query3 = "update master_unitshospital set status = '' where auto_number = '$delanum'";
	$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
}
...
function addunit1hospitalprocess1()
{
    ...
    <td width="97%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860"><table width="100%" border="0" cellspacing="0" cellpadding="0" class="tablebackgroundcolor1">
            <tr>
              <td><form name="form1" id="form1" method="post" action="addunit1hospital.php" onSubmit="return addunit1hospitalprocess1()">
                  <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Hospital Units Master - Add New </strong></td>
                      </tr>
                      <tr>
                ...
                <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="3" bgcolor="#CCCCCC" class="bodytext3"><strong>Hospital Units Master - Existing List </strong></td>
                      </tr>
                      <tr bgcolor="#011E6A">
        ...
        <tr <?php echo $colorcode; ?>>
						...
						<a href="addunit1hospital.php?st=del&&anum=<?php echo $auto_number; ?>"><img src="images/b_drop.png" width="16" height="16" border="0" /></a></div></td>
		...
		?>
                ...
                <table width="600" border="0" align="center" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
                    <tbody>
                      <tr bgcolor="#011E6A">
                        <td colspan="3" bgcolor="#CCCCCC" class="bodytext3"><strong>Hospital Units Master - Deleted </strong></td>
                      </tr>
                      <tr bgcolor="#011E6A">
        ...
        <tr <?php echo $colorcode; ?>>
						...
						<a href="addunit1hospital.php?st=activate&&anum=<?php echo $auto_number; ?>" class="bodytext3">

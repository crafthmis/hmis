          ...
          <tbody>
            ...
            <tr>
              ...
              <td  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Tax</strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
...
$query4 = "select * from master_tax where status <> 'deleted'";// where auto_number = '$taxtype'";
$exec4 = mysql_query($query4) or die ("Error in Query4".mysql_error());
while ($res4 = mysql_fetch_array($exec4)) //while1
{
	...
	bill_autonumber from pharmacysales_tax 
	...
	while ($res2 = mysql_fetch_array($exec2))
	{
		...
		$totaltaxamount = $res2['sumitemtaxamount'];
		 ...
		 $query3 = "select * from master_salespharmacy where auto_number = '$billautonumber' and 
		...
		if ($rowcount3 > 0) //if1
		{
			...
			<td  align="left" valign="center" class="bodytext31"><div align="left"> <?php echo number_format($res4taxpercent, 2, '.', '');; ?></div></td>

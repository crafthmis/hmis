    ...
    <td width="99%" valign="top"><table width="1498" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="1424">
              ...
              <form name="cbform1" method="get" action="invoicereport1pharmacydiscount.php">
...
-->	
			...
			*/
			...
			if (isset($_REQUEST["discountgiven"])) { $discountgiven = $_REQUEST["discountgiven"]; } else { $discountgiven = ""; }
			//echo '123'.$discountgiven = $_REQUEST['discountgiven'];
			if ($discountgiven == '') $discountgivensql = "subtotaldiscountpercentapply1 <> '0.00' and ";
			if ($discountgiven == 'SHOW ALL') $discountgivensql = "";

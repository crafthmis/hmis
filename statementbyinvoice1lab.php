    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="statementbyinvoice1lab.php">
		<table width="791" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Lab Statement By Invoice</strong></td>
          ...
          <tbody>
            <tr>
			  ...
			  <?php
				...
				$fp = fopen($foldername.'/StatementBySalesLab.xls', 'w+');
				...
				{
					window.location = "dbexcelfiles/StatementBySalesLab.xls"
				}
				</script>
...
&nbsp;				<input value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" />
			...
			$query2 = "select * from master_saleslab where customername like '%$customername%' and billdate between '$transactiondatefrom' and '$transactiondateto' and companyanum = '$companyanum' and recordstatus <> 'DELETED'";//  order by transactiondate desc";

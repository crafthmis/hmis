...
<table width="660" border="0" cellpadding="0" cellspacing="0">
  <tr>
	...
	<?php
	if ($tinnumber != '' || $cstnumber != '' || $footerline3 != '' || $footerline4 != '')
	{
	?>
	...
	<table width="98%" border="1" align="left" cellpadding="0" cellspacing="0" frame="box" rules="groups" class="sample">
      ...
      <thead>
        <tr>
          ...
          <td width="9%"><div align="right" class="style27">
              <div align="center">Quantity</div>
          </div></td>
          <td width="15%"><div align="right" class="style27">
		...
		$tablerowcount = "";
	  	...
	  	$query4 = "select * from prescriptionsales_details where auto_number = '$res21anum' and companyanum = '$companyanum' and financialyear = '$financialyear'";
		$exec4 = mysql_query($query4) or die ("Error in Query4".mysql_error());

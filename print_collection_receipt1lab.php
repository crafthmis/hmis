...
$query1 = "select * from master_transactionlab where transactiontype = 'COLLECTION' and transactionmodule = 'COLLECTION' and recordstatus <> 'DELETED' and companyanum = '$companyanum' order by auto_number desc";
...
if ($receiptanum != '')
{
	$query21 = "select * from master_transactionlab where auto_number = '$receiptanum'";
}
else
{
	...
	?>
      <table width="99%" border="0" align="left" cellpadding="0" cellspacing="0">
		...
		<?php include ("print_showlogo1lab.php"); ?>
		  ...
		  <div class="style27">
		    <div align="right"><span class="style6"><strong><?php echo 'Lab'; //$title1; ?></strong></span>&nbsp;&nbsp;</div>
		  </div>
		  </td>
        </tr>
      </table>

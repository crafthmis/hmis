...
if ($submit == 'Yes. Proceed.')
{
	...
	//Update To Show HOSPITAL_DOA_DOD_PRINT_SETTING On Hospital Printouts. Table master_settings
	$updateid = "UID00005";
	...
	if ($rowcount2 == 0)
	{
		$query3 = "INSERT INTO master_settings_primaryvalues (auto_number, companyanum, companycode, modulename, 
		submodulename, settingsname, settingsvalue, defaultvalue, status, ipaddress, username, updatetime) 
		VALUES (NULL, '1', 'CPY00000001', 'SETTINGS', 'HOSPITAL', 'HOSPITAL_DOA_DOD_PRINT_SETTING', 
		'SHOW DOA & DOD ON HOSPITAL PRINTOUT', '', '', '', '', CURRENT_TIMESTAMP)";		
		$exec3 = mysql_query($query3) or die ("Error in Query3".$updateid.mysql_error());
		...
		while ($res5 = mysql_fetch_array($exec5))
		{
			...
			$query3 = "INSERT INTO master_settings (auto_number, companyanum, companycode, modulename, 
			submodulename, settingsname, settingsvalue, defaultvalue, status, ipaddress, username, updatetime) 
			VALUES (NULL, '$companyanum', '$companycode', 'SETTINGS', 'HOSPITAL', 'HOSPITAL_DOA_DOD_PRINT_SETTING', 
			'SHOW DOA & DOD ON HOSPITAL PRINTOUT', '', '', '', '', CURRENT_TIMESTAMP)";		
			$exec3 = mysql_query($query3) or die ("Error in Query3".$updateid.mysql_error());
		}	
	...
	if ($rowcount2 == 0)
	{
		$query3 = "INSERT INTO master_settings_primaryvalues (auto_number, companyanum, companycode, modulename, 
		submodulename, settingsname, settingsvalue, defaultvalue, status, ipaddress, username, updatetime) 
		VALUES (NULL, '1', 'CPY00000001', 'SETTINGS', 'PHARMACY', 'DEFAULT_TAX_SETTING_PHARMACY', 
		'', '', '', '', '', CURRENT_TIMESTAMP)";		
		$exec3 = mysql_query($query3) or die ("Error in Query3".$updateid.mysql_error());
		...
		while ($res5 = mysql_fetch_array($exec5))
		{
			...
			$query3 = "INSERT INTO master_settings (auto_number, companyanum, companycode, modulename, 
			submodulename, settingsname, settingsvalue, defaultvalue, status, ipaddress, username, updatetime) 
			VALUES (NULL, '$companyanum', '$companycode', 'SETTINGS', 'PHARMACY', 'DEFAULT_TAX_SETTING_PHARMACY', 
			'', '', '', '', '', CURRENT_TIMESTAMP)";		
			$exec3 = mysql_query($query3) or die ("Error in Query3".$updateid.mysql_error());
		}	

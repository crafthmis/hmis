...
function funcPrintReceipt1(varRecAnum)
{
	...
	window.open("print_collection_receipt1pharmacy.php?receiptanum="+varRecAnum+"","OriginalWindow<?php //echo $banum; ?>",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
}
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="collectionreceived1pharmacy.php">
		<table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Pharmacy Collection Received Report</strong></td>
          ...
          <tbody>
            <tr>
              ...
              <?php
				...
				$filename1 = "print_collectionreceivedreport1pharmacy.php?$urlpath";
				$fileurl = $applocation1."/".$filename1;
				$filecontent1 = @file_get_contents($fileurl);
				
				$indiatimecheck = date('d-M-Y-H-i-s');
				$foldername = "dbexcelfiles";
				$fp = fopen($foldername.'/CollectionReceivedByPatientPharmacy.xls', 'w+');
              ...
              <script language="javascript">
				...
				{
					window.open("print_collectionreceivedreport1pharmacy.php?<?php echo $urlpath; ?>","Window1",'width=900,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
					//window.open("message_popup.php?anum="+anum,"Window1",'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,width=200,height=400,left=312,top=84');
				}
				function printbillreport2()
				{
					window.location = "dbexcelfiles/CollectionReceivedByPatientPharmacy.xls"
				}
				</script>
...
&nbsp;				<input value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" />
            ...
            <tr>
              ...
              <td width="4%" align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Paid Amount </strong></div></td>
              ...
              <td width="4%" align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="right"><strong>Adjustments</strong></div></td>
              <td width="5%" align="left" valign="center"  
		  ...
		  $query2 = "select * from master_transactionpharmacy where customername like '%$customername%' and recordstatus <> 'DELETED' and supplieranum = '0' and suppliername = '' and companyanum = '$companyanum' and transactiondate between '$paymentreceiveddatefrom' and '$paymentreceiveddateto' and transactiontype = 'COLLECTION' order by transactiondate desc";
           ...
           <tr <?php echo $colorcode; ?>>
			 ...
			 <a href="#" class="bodytext31" onClick="return funcPrintReceipt1('<?php echo $receiptanum; ?>')">Print</a></div>			 </td>
              ...
              <td class="bodytext31" valign="center"  align="left"><div align="center">&nbsp;
			   ...
			   {
			   ?>
			  <a href="collectiondelete1pharmacy.php?task=delete&&anum=<?php echo $receiptanum; ?>" onClick="return funcDeleteCollection1(<?php echo $snocount;?>)"> 

...
$query8 = "select * from master_settings where companycode = '$res6companycode' and modulename = 'SETTINGS' and submodulename = 'HOSPITAL' and 
settingsname = 'HOSPITAL_DOA_DOD_PRINT_SETTING'";
$exec8 = mysql_query($query8) or die ("Error in Query8".mysql_error());
$res8 = mysql_fetch_array($exec8);
$showhospitaldoadod = $res8["settingsvalue"];

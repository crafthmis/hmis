...
if ($frmflag1 == 'frmflag1')
{
	...
	if ($res2 == 0)
	{
		...
		status, lastupdate, lastupdateusername, lastupdateipaddress, reports_daterange_option, option_edit_delete) 
		values ('$employeecode','$employeename', '$username', '$password', 
		'$status', '$updatedatetime', '$sessionusername', '$ipaddress', '$reports_daterange_option', '$option_edit_delete')";
          ...
          <td width="860"><table width="900" height="250" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              ...
              <!--<tr>
                ...
                <td align="left" valign="middle" ><span class="bodytext3">Date Posted</span></td>
                <td align="left" valign="middle" ><input name="dateposted" id="dateposted" value="<?php echo $updatedatetime; ?>" onKeyDown="return process1backkeypress1()" style="border: 1px solid #001E6A"  size="20"  readonly="readonly" /></td>
				</tr>
              <tr>

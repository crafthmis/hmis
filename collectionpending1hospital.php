    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
              ...
              <form name="cbform1" method="post" action="collectionpending1hospital.php">
		<table width="500" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Hospital Collection Pending Report     - By Patient </strong></td>
          ...
          <tbody>
            <tr>
			  ...
			  <?php
				...
				$filename1 = "print_collectionpendingreport1hospital.php?$urlpath";
				$fileurl = $applocation1."/".$filename1;
				$filecontent1 = @file_get_contents($fileurl);
				
				$indiatimecheck = date('d-M-Y-H-i-s');
				$foldername = "dbexcelfiles";
				$fp = fopen($foldername.'/CollectionPendingByPatientHospital.xls', 'w+');
...
&nbsp;				<!--<input value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" />-->
			...
			*/
			...
			$query2 = "select * from master_transactionhospital where customername like '%$customername%' and supplieranum = '0' and suppliername = '' and recordstatus = '' and companyanum = '$companyanum' group by customeranum";//  order by transactiondate desc";
			...
			$query3 = "select * from master_transactionhospital where transactiontype = 'SALES' and customeranum = '$res2anum' and supplieranum = '0' and suppliername = '' and recordstatus = '' and companyanum = '$companyanum'";
			...
			$query3 = "select * from master_transactionhospital where transactiontype = 'COLLECTION' and customeranum = '$res2anum' and supplieranum = '0' and suppliername = '' and recordstatus = '' and companyanum = '$companyanum'";
			$exec3 = mysql_query($query3) or die ("Error in Query3".mysql_error());
			while ($res3 = mysql_fetch_array($exec3))
			{

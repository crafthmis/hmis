function insertitem1()
{
	...
	var varMorning = document.getElementById("morning").value;
	var varNoon = document.getElementById("noon").value;
	var varNight = document.getElementById("night").value;
	...
	var text6 = document.createElement ('input');
	text6.id = "morning"+k+"";
	text6.name = "morning"+k+"";
	text6.type = "text";
	text6.size = "4";
	text6.value = varMorning;
	text6.readOnly = "readonly";
	text6.style.backgroundColor = "#FFFFFF";
	text6.style.border = "0px solid #001E6A";
	text6.style.textAlign = "left";
	...
	text6.type = "text";
	text6.size = "4";
	text6.value = varNight;
	text6.readOnly = "readonly";
	text6.style.backgroundColor = "#FFFFFF";
	text6.style.border = "0px solid #001E6A";
	text6.style.textAlign = "left";
	td8.appendChild (text6);
	tr.appendChild (td8);

...
function itemsearch3(varItemCodeCatch)
{
	
	//alert("Meow...");
			//alert ("5");	
	var varItemCodeCatch = varItemCodeCatch;
...
function ajaxprocess()
{
	...
	var varCustomerCode1 = document.getElementById("customercode").value;
	//alert(itemcode);
	var url = "";
	var url="autoitemsearch2labtest.php?RandomKey="+Math.random()+"&&customercode="+varCustomerCode1+"&&itemcode="+itemcode;
    //alert(url);
...
{ 
	...
	//{
		...
		for (i=0;i<varNewRecordLength;i++)
		{
			...
			var varItemUnitName = varNewRecordValue[9];
			//alert (varItemStockCount);
			var varItemReferenceValue = varNewRecordValue[10];
			//alert (varItemStockCount);
			...
			document.getElementById("testunit").value = varItemUnitName;
			document.getElementById("referencevalue").value = varItemReferenceValue;

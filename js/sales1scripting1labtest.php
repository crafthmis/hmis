...
function btnDeleteClick(delID)
{
	...
	/*
	//Not able to set function return value. So getting value from button value field.
	var varClickedID = delID;
	//alert (varClickedID);
	var varDeleteID = varClickedID.substring(9) //Get Value After From Position Number.
	//alert (varDeleteID);
	*/
    ...
    var varDeleteSerialNumber = document.getElementById('serialnumber'+varDeleteID+'').value; // tbody name.
		
	var fRet3; 
	fRet3 = confirm('Are You Sure Want To Delete This Entry Number '+varDeleteSerialNumber+' ?'); 
	//alert(fRet); 
	if (fRet3 == false)
	{
...
function funcSaveBill1()
{
	...
	{
		alert ("Please Enter Patient Code To Proceed.");
		document.getElementById("customer").focus();
		return false;
	}
	...
	{
		alert ("Please Enter Sample ID To Proceed.");
	...
	if (document.getElementById("reporteddate").value == "")
	{
		alert ("Please Enter Reported Date To Proceed.");
		document.getElementById("reporteddate").focus();
		return false;
	}
	...
	for (z=1;z<=100;z++)
	{
		if (document.getElementById('resultvalue'+z) != null) 
		{
			//alert ("Control Found");
			if (document.getElementById('resultvalue'+z).value != "") 
			{
				var varValueFound = "Value Found";
				break;
			}
		}
	}
	if (varValueFound == "")
	{
		alert ("Please Enter Atleast On Test Value To Save Lab Test Report.");
		return false;
	}

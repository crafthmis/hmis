...
function funcSaveBill1()
{
	...
	if (document.getElementById("doctorcommission").value != "0.00")
	{
		if (document.getElementById("referredby").value == "")
		{
			alert ("Please Select Doctor Name To Proceed.");
...
function quickprintbill1sales()
{
	...
	window.open("print_bill_dmp4inch1lab.php?copy1=ORIGINAL&&billnumber="+varQuickPrintBillNumber,"OriginalWindow"+varQuickPrintBillNumber,'width=50,height=50,toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,left=25,top=25');
...
function quickprintbill2sales()
{
	...
	window.open("print_bill_dmp4inch1view1lab.php?copy1=ORIGINAL&&billnumber="+varQuickPrintBillNumber,"OriginalWindow"+varQuickPrintBillNumber,'width=600,height=500,toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,left=25,top=25');
	//window.open("print_bill_dmp4inch1.php?copy1=ORIGINAL&&billnumber="+varQuickPrintBillNumber,"OriginalWindow"+varQuickPrintBillNumber,'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');

...
function funcSubTotalCalc()
{
	...
	//Additional Coding For Advance Amount Changes. 24Mar2013
...
function funcResetPaymentInfo1()
{
	...
	document.getElementById("insuranceamount").value = "0.00";
	...
	document.getElementById("insuranceamount").readOnly = true;
	...
	document.getElementById("insuranceamounttr").style.display = 'none';
...
function paymentinfo()
{
	...
	if (document.getElementById("billtype").value == "INSURANCE")
	{
		document.getElementById("cashamounttr").style.display = 'none';
		document.getElementById("cashamounttr2").style.display = 'none';
		document.getElementById("cashamounttr3").style.display = 'none';
		document.getElementById("chequeamounttr").style.display = 'none';
		document.getElementById("creditamounttr").style.display = 'none';
		document.getElementById("insuranceamounttr").style.display = '';
		document.getElementById("cardamounttr").style.display = 'none';
		document.getElementById("onlineamounttr").style.display = 'none';
		//document.getElementById("nettamounttr").style.display = 'none';
		...
		document.getElementById("cashgiventocustomer").value = "0.00";
		document.getElementById("creditamount").value = "0.00"
		document.getElementById("insuranceamount").value = document.getElementById("totalamount").value
		document.getElementById("chequeamount").value = "0.00";
		document.getElementById("chequedate").value = "";
		document.getElementById("chequenumber").value = "";
		document.getElementById("chequebank").value = "";
		...
		document.getElementById("insuranceamount").focus();
	}
...
function funcSaveBill1()
{
	...
	{
		alert ("Please Enter Patient To Proceed.");
	...
	{
			alert ("For Credit Bill, Please Select Patient To Proceed. Without Patient Details Credit Bill Cannot Be Completed.");
			return false;
	}
	if (document.getElementById("billtype").value == "ISURANCE" && document.getElementById("customercode").value == "")
	{
			alert ("For Credit Bill, Please Select Patient To Proceed. Without Patient Details Credit Bill Cannot Be Completed.");
			return false;
	}
	...
	{
			alert ("For Split Bill With Credit Amount Please Select Patient. Without Patient Details Split Bill Cannot Be Completed.");
			return false;
	}
	if (document.getElementById("billtype").value == "CASH")
	{
		...
		{
			alert ("Please Enter Cash Given By Patient.");
			document.getElementById("cashamount").focus();
			return false;
		}
		//*/
	...
	if (document.getElementById("billtype").value == "INSURANCE")
	{
		if (document.getElementById("insuranceamount").value == "0.00")
		{
			alert ("Please Enter Insurance Amount.");
			document.getElementById("credit").focus();
			return false;
		}
		if (isNaN(document.getElementById("insuranceamount").value))
		{
			alert ("Credit Amount Can Only Be Numbers.");
			document.getElementById("insuranceamount").value = "0.00"
			document.getElementById("insuranceamount").focus();
...
*/
	...
	//For Advance Amount Entry Changes - 24Mar2013
	
	if (document.getElementById("advanceamountpaid").value != "0.00" && document.getElementById("billtype").value != "CREDIT")
	{
		alert ("For Advance Amount Paid Patients, Please Save Invoice As Credit Invoice. Then Enter Collection Amount At Collection Entry.");
		//alert ("Sorry, Invoice Not Saved.");
		document.getElementById("advanceamountpaid").focus();
		return false;
	}
	/*
	if (document.getElementById("advanceamountpaid").value != "0.00")
	{
		alert ("For Advance Amount Paid Patients, Please Save Invoice As Credit Invoice. Then Enter Collection Amount At Collection Entry.");
		//alert ("Sorry, Invoice Not Saved.");
		document.getElementById("advanceamountpaid").focus();
...
function funcPaymentInfoCalculation1()
{
	...
	{
		alert ("Cash Given By Patient Can Only Be Numbers.");
		document.getElementById("cashgivenbycustomer").value = "0.00"
		document.getElementById("cashgivenbycustomer").focus();
		return false;
	}
	...
	document.getElementById("insuranceamount").value = parseFloat(document.getElementById("insuranceamount").value).toFixed(2);
	...
	if (document.getElementById("billtype").value == "INSURANCE")
	{	
		document.getElementById("nettamount").value = document.getElementById("insuranceamount").value;
	}
	if (document.getElementById("billtype").value == "ONLINE")
	{	
	...
	{	
		...
		var varCreditAmount = document.getElementById("insuranceamount").value;
		...
		var varTotalNettAmount = parseFloat(varCashAmount) + parseFloat(varCreditAmount) + parseFloat(varInsuranceAmount) + parseFloat(varChequeAmount) + parseFloat(varCardAmount) + parseFloat(varOnlineAmount);
...
function quickprintbill1sales()
{
	...
	window.open("print_bill_dmp4inch1hospitalayush.php?copy1=ORIGINAL&&billnumber="+varQuickPrintBillNumber,"OriginalWindow"+varQuickPrintBillNumber,'width=50,height=50,toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,left=25,top=25');
...
function quickprintbill2sales()
{
	...
	window.open("print_bill_dmp4inch1view1hospital.php?copy1=ORIGINAL&&billnumber="+varQuickPrintBillNumber,"OriginalWindow"+varQuickPrintBillNumber,'width=600,height=500,toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,left=25,top=25');
	//window.open("print_bill_dmp4inch1.php?copy1=ORIGINAL&&billnumber="+varQuickPrintBillNumber,"OriginalWindow"+varQuickPrintBillNumber,'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');

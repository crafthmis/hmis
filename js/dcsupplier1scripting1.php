...
function funcNetAmountCalc1()
{
	...
	var varNetAmount = parseFloat(varTotalAfterTax) + parseFloat(varDeliveryAmount);
...
function paymentinfo()
{
	...
	if (document.getElementById("billtype").value == "PURCHASE REQUEST")
	{
		document.getElementById("cashamounttr").style.display = 'none';
		//document.getElementById("cashamounttr2").style.display = 'none';
		//document.getElementById("cashamounttr3").style.display = 'none';
...
function funcSaveBill1()
{
	...
	{
		alert ("Please Note That Total Amount Is Zero. If You Want To Proceed With Zero Total Amount, Please Click OK.");

...
AutoSuggestControl1.prototype.autosuggest = function (aSuggestions /*:Array*/,
	...
	//alert (aSuggestions); //Contains all the data to be listed on dropdown.
...
AutoSuggestControl1.prototype.createDropDown = function () {
    ...
    this.layer.onmouseover = function (oEvent) {
        ...
        if (oEvent.type == "mousedown") {
			...
			//alert ("Mouse Down."); 
			//alert ("1");
			categoryitemsearch3() //Function from autocomplete_itemsearch3.js and autoitemsearch3.js
			//alert ("4");
...
var oNode = this.textbox;
var snum = oNode.id;
var sernum = snum.substr(7,2); //Service Number
...
AutoSuggestControl1.prototype.handleKeyUp = function (oEvent /*:Event*/) {
    ...
    //make sure not to interfere with non-character keys
		...
		//alert ("Meow...");
		//var varCustomerName = document.getElementById("searchcustomername").value; BY Muruga on 10-02-2010
		//alert (varCustomerName);
		//var varCustomerName = varCustomerName.toUpperCase(); BY Muruga
		//alert (varCustomerName);
		//document.getElementById("searchcustomername").value = varCustomerName; BY Muruga
		//code end by prem.
...
//function funcItemNameLostFocus1(sernum)
function funcItemNameLostFocus1()
{
		//alert ("you pressed a key.");
		//var sernum = sernum; 
		//categoryitemsearch(sernum)
		categoryitemsearch() //Function from autocomplete_itemsearch1.js

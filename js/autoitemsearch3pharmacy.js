...
function ajaxprocess()
{
	...
	//alert(itemcode);
	var url = "";
	var url="autoitemsearch2pharmacy.php?RandomKey="+Math.random()+"&&customercode="+varCustomerCode1+"&&itemcode="+itemcode;
    //alert(url);
...
{ 
	...
	//{
		...
		for (i=0;i<varNewRecordLength;i++)
		{
			...
			document.getElementById("itemreversetax").value = varItemMRP;
			document.getElementById("itemreversetax").focus();
			document.getElementById("itemreversetax").select();

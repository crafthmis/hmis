function insertitem1()
{
	...
	{
		alert ("Select Item Batch Number To Continue.");
		...
		if (document.getElementById('itemcode'+m) != null) 
		{
			if (document.getElementById('itemcode'+m).value == document.getElementById("itemcode").value)
			{
				...
				else
				{
					...
					if (document.getElementById("pageidentificationcontrol").value == "pharmacysalesentry")
					{
	...
	{	
		var varItemBatchNumber = "";
		var varItemSalesPrice = "";
		var varItemExpiryDate = "";
	}

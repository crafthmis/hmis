...
function funcSaveBill1()
{
	...
	{
	if(document.getElementById("billcustomername").value == "")
	{
		alert ("Please Enter Bill customer To Proceed.");
		document.getElementById("customer").focus();
		return false;
	}
	}
...
function quickprintbill2sales()
{
	...
	window.open("print_bill_dmp4inch1view1.php?copy1=ORIGINAL&&billnumber="+varQuickPrintBillNumber,"OriginalWindow"+varQuickPrintBillNumber,'width=600,height=500,toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,left=25,top=25');
	//window.open("print_bill_dmp4inch1.php?copy1=ORIGINAL&&billnumber="+varQuickPrintBillNumber,"OriginalWindow"+varQuickPrintBillNumber,'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
...
function funcTaxReverseCalc2()
{
	...
	if (varItemCode != "")
	{
		...
		{
			alert ("MRP / Reverse Tax Amount Can Only Be Numbers.");
		...
		if (varItemReverseTaxTotalAmount > 0)
		{
			//alert ("Inside If");
			var varItemReverseTaxTotalAmount = parseFloat(varItemReverseTaxTotalAmount);
			...
			var varItemActualAmount = parseFloat(varItemReverseTaxTotalAmount) /  parseFloat(varItemActualAmount);
			var varItemActualAmount = parseFloat(varItemActualAmount);

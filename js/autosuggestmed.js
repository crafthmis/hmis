...
AutoSuggestControl.prototype.createDropDown = function () {
    ...
    this.layer.onmouseover = function (oEvent) {
        ...
        if (oEvent.type == "mousedown") {
			...
			//Code by Prem Kumar.
			//alert ("Mouse Down."); 
			customernamelostfocus4()
			document.cbform1.submit();//Function located at the bottom of this file.
...
function customernamelostfocus4()
{
	...
	var varSupplierName2 = arrSupplierName[0];
	var varSupplierCode = arrSupplierName[1];
	if (varSupplierCode != undefined)
	{
		//alert (varSupplierCode);
		document.getElementById("searchsuppliercode").value = varSupplierCode;

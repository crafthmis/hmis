...
function funcPrintReceipt1(varRecAnum)
{
	...
	window.open("print_collection_receipt1hospital.php?receiptanum="+varRecAnum+"","OriginalWindow<?php //echo $banum; ?>",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
}
    ...
    <td width="99%" valign="top"><table width="116%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="post" action="collectionreceived1hospital.php">
		<table width="600" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Hospital Collection Received Report     - Select Patient </strong></td>
              <!--<td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><?php echo $errmgs; ?>&nbsp;</td>-->
              <td bgcolor="#CCCCCC" class="bodytext3" colspan="2">&nbsp;</td>
            </tr>
            <tr>
              <td width="21%"  align="left" valign="middle"  bgcolor="#FFFFFF" class="bodytext3">Select Patient </td>
              <td colspan="3" align="left" valign="top"  bgcolor="#FFFFFF"><input value="<?php echo $cbcustomername; ?>" name="cbcustomername" type="text" id="cbcustomername" size="50" style="border: 1px solid #001E6A"></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <?php
				...
				if ($cbfrmflag1 == 'cbfrmflag1')
				{
					...
					if (isset($_REQUEST["cbcustomername"])) { $customername = $_REQUEST["cbcustomername"]; } else { $customername = ""; }
				...
				$filename1 = "print_collectionreceivedreport1hospital.php?$urlpath";
				$fileurl = $applocation1."/".$filename1;
				$filecontent1 = @file_get_contents($fileurl);
				
				$indiatimecheck = date('d-M-Y-H-i-s');
				$foldername = "dbexcelfiles";
				$fp = fopen($foldername.'/CollectionReceivedByPatientHospital.xls', 'w+');
              ...
              <script language="javascript">
				...
				{
					window.open("print_collectionreceivedreport1hospital.php?<?php echo $urlpath; ?>","Window1",'width=900,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
					//window.open("message_popup.php?anum="+anum,"Window1",'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,width=200,height=400,left=312,top=84');
				}
				function printbillreport2()
				{
					window.location = "dbexcelfiles/CollectionReceivedByPatientHospital.xls"
				}
				</script>
<!--				
...
-->
            ...
            <tr>
              ...
              <td  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Voucher</strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
		  ...
		  $query2 = "select * from master_transactionhospital where customername like '%$customername%' and recordstatus <> 'DELETED' and supplieranum = '0' and suppliername = '' and companyanum = '$companyanum' and transactiondate between '$paymentreceiveddatefrom' and '$paymentreceiveddateto' and transactiontype = 'COLLECTION' order by auto_number desc";// order by transactiondate desc";
		  ...
		  $insuranceamount = $res2['insuranceamount'];
		  ...
		  $vouchernumber = $res2['vouchernumber'];
		  ...
		  if ($insuranceamount != '0.00') { $paymentamount = $insuranceamount; }
		  ...
		  if ($writeoffamount != '0.00') { $paymentamount = $writeoffamount; }
           ...
           <tr <?php echo $colorcode; ?>>
			 ...
			 <a href="#" class="bodytext31" onClick="return funcPrintReceipt1('<?php echo $receiptanum; ?>')">Print</a></div>			 </td>
              ...
              <td class="bodytext31" valign="center"  align="left">
			    <div align="right"><?php echo $totalamount; ?></div></td>
              <td class="bodytext31" valign="center"  align="left">
			  <div align="right"><?php echo $paymentamount; ?></div></td>
              <td class="bodytext31" valign="center"  align="left">
			  <div align="right"><?php echo $cashamount; ?></div></td>
			  <td class="bodytext31" valign="center"  align="left">
			  <div align="right"><?php echo $insuranceamount; ?></div></td>
              <td class="bodytext31" valign="center"  align="left">
			  <div align="right"><?php echo $creditamount; ?></div></td>
              <td class="bodytext31" valign="center"  align="left">
			  <div align="right"><?php echo $cardamount; ?></div></td>
              <td class="bodytext31" valign="center"  align="left">	
			  <div align="right"><?php echo $onlineamount; ?></div></td>
              <td class="bodytext31" valign="center"  align="left">
			  <div align="right"><?php echo $chequeamount; ?></div></td>
              <td class="bodytext31" valign="center"  align="left">
			  <div align="right"><?php echo $writeoffamount; ?></div></td>
              <td class="bodytext31" valign="center"  align="left">
			  <div align="left"><?php echo $paymentdate; //substr($paymentdate, 0, 10); ?></a></div></td>
              <td class="bodytext31" valign="center"  align="left">
              ...
              <td  align="left" valign="center" class="bodytext31"><div align="left"><?php echo $vouchernumber; ?></div></td>
              <td class="bodytext31" valign="center"  align="left">
              ...
              <td class="bodytext31" valign="center"  align="left"><div align="center">&nbsp;
			   ...
			   if ($transactiontype == 'COLLECTION' && $transactionmodule == 'COLLECTION')
			   {
				...
				{
			   ?>
			  <a href="collectiondelete1.php?task=delete&&anum=<?php echo $receiptanum; ?>" onClick="return funcDeleteCollection1(<?php echo $snocount;?>)"> 
			...
			$looptotalinsuranceamount = $insuranceamount + $looptotalinsuranceamount;
			//echo $looptotalinsuranceamount;
			...
			$looptotalinsuranceamount = number_format($looptotalinsuranceamount, 2, '.', '');
            ...
            <tr>
			  ...
			  <td class="bodytext31" valign="center"  align="left" 
                bgcolor="#cccccc"><div align="right"><strong><?php echo $looptotalinsuranceamount; ?></strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 

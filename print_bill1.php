	...
	<table width="98%" border="1" align="left" cellpadding="0" cellspacing="0" frame="box" rules="groups" class="sample">
      ...
      <thead>
       ...
       <td valign="top"><div align="right"><span class="style27">&nbsp;<?php echo $quantity; ?>&nbsp;</span></div></td>
		...
		$query5 = "select * from master_sales where auto_number = '$res21anum' and recordstatus <> 'deleted' and financialyear = '$financialyear'";
		$exec5 = mysql_query($query5) or die ("Error in Query5".mysql_error());
		$res5 = mysql_fetch_array($exec5);
     ...
     <?php
		//$subtotalaftertax = $subtotalafterdiscountamount;
	  	...
	  	$query6 = "select *, sum(taxamount) as sumtaxamount from sales_tax where bill_autonumber = '$billautonumber' and financialyear = '$financialyear' and recordstatus <> 'DELETED' group by tax_autonumber, taxname order by auto_number";
		$exec6 = mysql_query($query6) or die ("Error in Query6".mysql_error());

    ...
    <td width="99%" valign="top"><table width="1700" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="860">
              ...
              <form name="cbform1" method="get" action="insurancereport2.php">
		<table width="600" border="1" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Insurance Report     - Select Date </strong></td>
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="945" 
            align="left" border="1">
          <tbody>
            <tr>
			...
			$query2 = "select * from master_insurance where dateposted between '$quotedatefrom' and '$quotedateto'  order by dateposted desc";
			$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
			while ($res2 = mysql_fetch_array($exec2))
			{
			$code=$res2['insurancecode'];
			$customername = $res2['insurancename'];
			$city = $res2['city'];
           ...
           <tr <? echo $colorcode; ?>>
			...
			?></div></td>
			  ...
			  <? echo $date1; ?></td>
			  <td class="bodytext31" valign="center" bordercolor="#f3f3f3" align="left">
			 <a href="editinsurance1.php?insurancecode=<? echo $code;?>"><font class="bodytext3">Edit</font></a></td>
            </tr>
			<?
			}
			?>

...
//{
	...
	if ($printsource == '')
	{
		...
		$query22 = "select * from master_purchaseorder where auto_number = '$billautonumber' and companyanum = '$companyanum' and financialyear = '$financialyear'";
	}
	if ($printsource == 'billpage')
	{
		//$query22 = "select * from master_purchaseorder where auto_number = '$banum'";// and recordstatus <> 'DELETED' and companyanum = '$companyanum'";
		$query22 = "select * from master_purchaseorder where billnumber = ".$_REQUEST['billnumber']." and recordstatus <> 'DELETED' and companyanum = '$companyanum' and financialyear = '$financialyear'";
	}
...
$query3 = "select * from master_purchaseorder where auto_number = '$res21anum' and companyanum = '$companyanum' and financialyear = '$financialyear'";
...
$discountexists = "";
$query4 = "select * from purchaseorder_print_dump where bill_autonumber = '$billautonumber' and companyanum = '$companyanum' and financialyear = '$financialyear'";
$exec4 = mysql_query($query4) or die ("Error in Query4".mysql_error());
...
<table width="660" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	<table width="98%" border="1" align="left" cellpadding="0" cellspacing="0" frame="box" rules="groups" class="style27">
      ...
      <thead>
		...
		$varStartRow = $varPagingLimit * 24;
		$varLimitRow = 24;

	  	$query4 = "select * from purchaseorder_print_dump where bill_autonumber = '$billautonumber' and companyanum = '$companyanum' and financialyear = '$financialyear' limit $varStartRow, $varLimitRow";
		$exec4 = mysql_query($query4) or die ("Error in Query4".mysql_error());
		while ($res4 = mysql_fetch_array($exec4))
		{
		//echo $res4['auto_number'];
		$sno = $sno + 1;
		...
		$query9 = "select * from purchaseorder_tax where  bill_autonumber = '$billautonumber' and itemanum = '$itemanum' and companyanum = '$companyanum' and financialyear = '$financialyear'";
		...
		*/
		...
		$query5 = "select * from master_purchaseorder where auto_number = '$res21anum' and financialyear = '$financialyear'";
     ...
     <tr>
      ...
      <?php
		//$subtotalaftertax = $subtotalafterdiscountamount;
	  	...
	  	$query6 = "select *, sum(taxamount) as sumtaxamount from purchaseorder_tax where bill_autonumber = '$billautonumber' and financialyear = '$financialyear' and recordstatus <> 'DELETED' group by tax_autonumber, taxname order by auto_number";
  ...
  <tr>
    <td><span class="style6"><?php echo 'Total Items : '.round($totalquantity, 4); ?></span></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    <td><span class="style6"><?php echo $f23; ?></span></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    ...
    <td width="301" valign="top"><table width="98%" border="0" align="left" cellpadding="0" cellspacing="0">
      <tr>
        <td><div align="right"><span class="style27">
            ...
            <table width="99%" border="0" align="left">
              <tr>
                ...
                <div align="right">
                <strong>For <?php echo $companyname; ?></strong>
                </div>
                </span>
                </td>
              </tr>

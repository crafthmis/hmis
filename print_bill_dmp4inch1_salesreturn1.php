...
<script type="text/javascript">
      ...
      function funcPrint() {
         ...
         if (applet != null) {
			...
			?>
            applet.append("SALES RETURN BILL NO: <?php echo $billnumberprefix.$billnumber.$billnumberpostfix; ?>\n");
			...
			*/
			...
			?>
			<?php
			$query41 = "select *, sum(taxamount) as sumtaxamount from pharmacysalesreturn_tax  where bill_autonumber = '$billautonumber' and recordstatus <> 'deleted' and companyanum = '$companyanum' group by tax_autonumber"; 

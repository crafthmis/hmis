  ...
  <tr>
    ...
    <td width="99%" valign="top"><table width="1775" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<form name="form1" id="form1" method="get" action="appointmentsmsreport.php" onSubmit="return process1()">
	  ...
	  <form action="appointmentsmsalertreport.php" method="post">
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="634" 
            align="left" border="0">
            <tbody>
              <tr>
              ...
              <tr>
                ...
                bgcolor="#ffffff" class="bodytext31"><strong>Select all</strong> 
			  ...
			  <td>
			<?php
			$checkbox1=mysql_query("select * from master_customer where auto_number = '$res2customeranum'");

...
if ($frmflag1 == 'frmflag1')
{
	...
	$tpaname = $_REQUEST[tpaname];
	$tpaname = strtoupper($tpaname);
	$tpaname = trim($tpaname);
	...
	$tpacode = $_REQUEST[tpacode];
	$dateposted = $updatedatetime;
	
	$query2 = "select * from master_tpa where tpacode = '$tpacode'"; //customername = '$customername'";
	$exec2 = mysql_query($query2) or die ("Error in Query2".mysql_error());
	$res2 = mysql_num_rows($exec2);
	if ($res2 == 0)
	{
		$query1 = "insert into master_tpa (tpaname, 
		...
		'$location', '$city', '$state', '$pincode', '$country','$dateposted', '$tpacode')";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
		
		$errmsg = "Success. New TPA Updated.";
	...
	$tpacode = $_REQUEST[tpacode];
	$dateposted = $updatedatetime;
	$query1 = "update master_tpa set tpaname='$tpaname', 
		phonenumber='$phonenumber',mobilenumber='$mobilenumber',address='$address', 
		location='$location', city='$city', state='$state',emailid='$emailid1',faxnumber='$faxnumber1', pincode='$pincode', country='$country',dateposted='$dateposted' where tpacode='$tpacode'";
		$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
		
		$errmsg = "Success.TPA Updated.";
...
function from1submit1()
{
	...
	else if (document.form1.tpacode.value == "")
	{
		alert ("TPA Code Cannot Be Empty.");
		document.form1.tpacode.focus();
		return false;
	}
...
<table width="103%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
    ...
    <td width="97%" valign="top">
      	  ...
      	  <form name="form1" id="form1" method="post" action="addtpa1.php" onSubmit="return from1submit1()">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="860"><table width="95%" height="282" border="1" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
                <td bgcolor="#CCCCCC" class="bodytext3" colspan="2"><strong>Patient - New </strong></td>
              ...
              <tr>
                <td width="20%" align="left" valign="middle" bordercolor="#F3F3F3" bgcolor="#FFFFFF" class="bodytext3">TPA    Name   *</td>
                <td colspan="3" align="left" valign="middle" bordercolor="#F3F3F3">
				<input name="tpaname" id="tpaname" value="<? echo $customername; ?>" style="border: 1px solid #001E6A" size="60"></td>
              </tr>
              <tr>
			...
			?>
			  ...
			  ?>
				...
				<input name="pincode" id="pincode" value="<? echo $pincode; ?>" style="border: 1px solid #001E6A"  size="20" /></td>
				 <td width="21%" align="left" valign="middle" bordercolor="#F3F3F3" bgcolor="#FFFFFF" class="bodytext3"> Emailid </td>
				 <td width="28%" align="left" valign="middle" bordercolor="#F3F3F3">
				<input name="emailid1" id="emailid1" value="<? echo $email; ?>" style="border: 1px solid #001E6A"  size="20"></td>

              </tr>
              <tr>
                <td align="left" valign="middle" bordercolor="#F3F3F3" bgcolor="#FFFFFF" class="bodytext3">Phone Number  </td>
                <td width="31%" align="left" valign="middle" bordercolor="#F3F3F3">
				...
				<input name="faxnumber" id="faxnumber" value="<? echo $phonenumber1; ?>" style="border: 1px solid #001E6A" size="20" />                </td>
				 <td align="left" valign="middle" bordercolor="#F3F3F3" bgcolor="#FFFFFF" class="bodytext3">TPA   Code * </td>
                 <td valign="middle" align="left" bordercolor="#F3F3F3"><input name="tpacode" id="tpacode" value="<? echo $customercode; ?>" style="border: 1px solid #001E6A"  size="20" /></td>
            ...
            <tbody>
              <tr>
				...
				<font color="#000000" size="1" face="Verdana, Arial, Helvetica, sans-serif">
                    ...
                    <input name="Submit222" type="submit"  value="Save TPA" class="button" style="border: 1px solid #001E6A"/>

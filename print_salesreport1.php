...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
  ...
  <tbody>
            ...
            <tr>
              <td colspan="21" align="left" valign="center" bordercolor="#f3f3f3" bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Sales Report</strong></div></td>
            </tr>
            <tr>
              <td colspan="21" align="left" valign="center" bordercolor="#f3f3f3" bgcolor="#ffffff" class="bodytext31"><div align="center"><strong><?php echo $companyname; ?></strong>&nbsp;</div></td>
            </tr>
            <tr>
              <td colspan="21" align="left" valign="center" bordercolor="#f3f3f3" bgcolor="#ffffff" class="bodytext31"><div align="center"><strong><?php echo 'Report Date From '.$transactiondatefrom.' To '.$transactiondateto; ?></strong></div></td>
            </tr>
            <tr>
              ...
              <td width="4%" align="left" valign="center" bordercolor="#f3f3f3" 
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>SubTotal1</strong></div></td>
              <td width="4%" align="left" valign="center" bordercolor="#f3f3f3" 
              ...
              <td width="4%" align="left" valign="center" bordercolor="#f3f3f3" 
                bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>FY</strong></div></td>
              <td width="7%" align="left" valign="center" bordercolor="#f3f3f3" 
			...
			*/
			...
			$query2 = "select * from master_sales where customername like '%$customername%' and billnumber like '%$cbbillnumber%' 
			and $billstatusquery1 and billtype like '%$paymenttype%' and companyanum = '$companyanum' and financialyear like '%$financialyear%' and 
			...
			$query21 = "select sum(taxamount) as sumtaxamount from sales_tax where bill_autonumber = '$res2anum'  
			and companyanum = '$companyanum' and financialyear = '$res2financialyear'";// and 
            ...
            <tr <?php //echo $colorcode; ?>>
              ...
              <td align="left" valign="center" bordercolor="#f3f3f3" bgcolor="#FFFFFF" class="bodytext31"><div align="left"> <?php echo $billnumber; ?></div></td>
			...
			?>
              ...
              <td align="left" valign="center" bordercolor="#f3f3f3" bgcolor="#FFFFFF" class="bodytext31"><div class="bodytext31"> <?php echo $customername; ?></div></td>
              ...
              <td align="left" valign="center" bordercolor="#f3f3f3" bgcolor="#FFFFFF" class="bodytext31"><div align="right"> <?php echo $subtotaldiscountamountonlyapply2percent; ?>&nbsp;</div></td>
              <td align="left" valign="center" bordercolor="#f3f3f3" bgcolor="#FFFFFF" class="bodytext31"><div align="right"> <?php echo $subtotaldiscountamountonlyapply1amount; ?>&nbsp;</div></td>
              <td align="left" valign="center" bordercolor="#f3f3f3" bgcolor="#FFFFFF" class="bodytext31"><div align="right"> <?php echo $subtotalaftercombinediscount; ?>&nbsp;</div></td>
              ...
              <td align="left" valign="center" bordercolor="#f3f3f3" bgcolor="#FFFFFF" class="bodytext31"><div align="right"> <?php echo $totalamount; ?>&nbsp;</div></td>
              <td align="left" valign="center" bordercolor="#f3f3f3" bgcolor="#FFFFFF" class="bodytext31"><div align="right"> <?php echo $res2financialyear; ?>&nbsp;</div></td>

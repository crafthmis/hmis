...
$transactiondateto = date('Y-m-d', strtotime('+1 day'));
...
function loadprintpage1(banum)
{
	var varbanum = banum;
	//alert (varqanum);
	window.open("print_bill1hospital.php?billautonumber="+varbanum+"","Window"+varbanum+"",'width=722,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
...
{
	window.location = "invoicereport1hospital.php";
}
...
<body>
<table width="1802" border="0" cellspacing="0" cellpadding="2">
  <tr>
  ...
  <tr>
    ...
    <td width="1%" valign="top"><?php //include ("includes/menu4.php"); ?>
      &nbsp;</td>
    <td width="99%" valign="top"><table width="1750" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="1424">
		
              <form name="cbform1" method="get" action="invoicereport1hospital.php">
		<table width="916" border="0" align="left" cellpadding="4" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
          <tbody>
            <tr bgcolor="#011E6A">
              <td colspan="2" bgcolor="#CCCCCC" class="bodytext3"><strong>Hospital Invoice Report     - Select Patient </strong></td>
...
-->			  
              ...
              <td align="left" valign="middle" ><span class="bodytext3">User Name </span></td>
              <td align="left" valign="top" >
			  <select name="searchusername" id="searchusername">
                <option value="" selected="selected">Show All</option>
                <?php
				$query1 = "select * from master_employee where status <> 'deleted' order by username";
				$exec1 = mysql_query($query1) or die ("Error in Query1".mysql_error());
				while ($res1 = mysql_fetch_array($exec1))
				{
				$res1username = $res1['username'];
				?>
                <option value="<?php echo $res1username; ?>"><?php echo strtoupper($res1username); ?></option>
                <?php
				}
				?>
              </select>
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
		  ...
		  ?>
            <tr>
              <td colspan="26" bgcolor="#FFFF00" class="bodytext31">&nbsp;<?php echo $errmsg1; ?></td>
              </tr>
			<?php
			}
			?>	
            ...
            <tr>
              ...
              <td colspan="18" align="left" valign="center"  
			  ...
			  <?php
				...
				$filename1 = "print_salesreport1hospital.php?$urlpath";
				$fileurl = $applocation1."/".$filename1;
				$filecontent1 = @file_get_contents($fileurl);
				
				$indiatimecheck = date('d-M-Y-H-i-s');
				$foldername = "dbexcelfiles";
				$fp = fopen($foldername.'/InvoiceReportHospital.xls', 'w+');
				...
				{
					window.open("print_salesreport1hospital.php?<?php echo $urlpath; ?>","Window1",'width=900,height=950,toolbar=0,scrollbars=1,location=0,statusbar=0,menubar=1,resizable=1,left=25,top=25');
					//window.open("message_popup.php?anum="+anum,"Window1",'toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=1,width=200,height=400,left=312,top=84');
				}
				function printbillreport2()
				{
					window.location = "dbexcelfiles/InvoiceReportHospital.xls"
				}
				</script>
				<?php
...
<input value="Export Excel" onClick="javascript:printbillreport2()" name="resetbutton22" type="button" id="resetbutton22"  style="border: 1px solid #001E6A" />
            ...
            <tr>
              ...
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="style1"><span class="bodytext31"><strong><?php echo $f29; ?></strong></span></td>
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="style1"><span class="bodytext31"><strong><?php echo $f30; ?></strong></span></td>
              <!--<td class="bodytext31" valign="center"  align="left" 
			...
			*/
			...
			?>
			  ...
			  if ($res2financialyear == $_SESSION['financialyear'])
			  {
				...
				{
			  ?>
                  <a href="sales1hospital.php?delbillst=billedit&&delbillautonumber=<?php echo $billautonumber; ?>&&delbillnumber=<?php echo $billnumber; ?>" class="bodytext3" target="_blank"><span class="bodytext3">Edit</span></a>
              <?php
			  }
			  }
			  }
             ...
             <?php
			  ...
			  ?>
			  <div align="center"> 
			  <a href="salesdelete1hospital.php?task=delete&&anum=<?php echo $billautonumber; ?>" 
			  ...
			  <?php echo $res2username; //echo $approvalstatus; ?></div></td>
              <td class="bodytext31" valign="center"  align="left"><div align="left"> 
			  <?php echo $remarks; ?></div></td>
			  <td class="bodytext31" valign="center"  align="left"><div align="left"> 
			  <?php echo $insurancecompany; ?></div></td>
			  <td class="bodytext31" valign="center"  align="left"><div align="left"> 
			  <?php echo $tpaname; ?></div></td>
              </tr>
				<?php
				}
				?>
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="left" 
				...
				<td class="bodytext31" valign="center"  align="left" 
                bgcolor="#cccccc"><div align="right"><strong><?php echo number_format($totalsuminsuranceamount1, 2, '.', '');; ?></strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 

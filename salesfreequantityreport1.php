    ...
    <td valign="top"><table width="98%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td>
			...
			<form name="stockinward" action="salesfreequantityreport1.php" method="post" onKeyDown="return disableEnterKey()">
	<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
            bordercolor="#666666" cellspacing="0" cellpadding="4" width="800" 
            align="left" border="0">
      <tbody id="foo">
        <tr>
          <td colspan="5" bgcolor="#cccccc" class="bodytext31"><strong>Stock - Report By Free Quantity Items</strong></td>
          </tr>
        <tr>
      ...
      <tr>
        <td><table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody>
			...
			$query3 = "select itemcode, sum(quantity) as sumquantity from pharmacysales_details where totalamount = '0.00' and recordstatus <> 'DELETED' and companyanum = '$companyanum' group by itemcode order by sumquantity $movingitemquery";// itemcode = '$itemcode' and";

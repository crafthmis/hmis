...
$titlestr = 'PROFORMA INVOICE';

include ("login1salesdataredirect1.php");

//to redirect if there is no entry in masters category or item or customer or settings
$query91 = "select count(auto_number) as masterscount from settings_proformainvoice where companyanum = '$companyanum'";
...
if ($res91count == 0)
{
	header ("location:settingsproformainvoice1.php?svccount=firstentry");
	exit;
}
...
$query88 = "select count(auto_number) as cntanum from master_proformainvoice";// where lastupdate like '$thismonth%'";
...
if ($frm1submit1 == 'frm1submit1')
{
	...
	{
		//$query19 = "select auto_number,lastupdate from master_proformainvoice where auto_number = '$delbillautonumber' and billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'DELETED'";
		$query19 = "select auto_number,lastupdate from master_proformainvoice where billnumber = '$delbillnumber' and companyanum = '$companyanum'";
		...
		while ($res19 = mysql_fetch_array($exec19))
		{
			...
			//$query15 = "update master_proformainvoice set recordstatus = 'DELETED' where auto_number = '$res19anum' and companyanum = '$companyanum'";
			$query15 = "update master_proformainvoice set recordstatus = 'DELETED' where billnumber = '$delbillnumber' and companyanum = '$companyanum'";
			$exec15 = mysql_query($query15) or die ("Error in Query15".mysql_error());
		
			//$query16 = "update proformainvoice_details set recordstatus = 'DELETED' where bill_autonumber = '$res19anum' and companyanum = '$companyanum'";
			$query16 = "update proformainvoice_details set recordstatus = 'DELETED' where billnumber = '$delbillnumber' and companyanum = '$companyanum'";
			$exec16 = mysql_query($query16) or die ("Error in Query16".mysql_error());
		
			//$query17 = "update proformainvoice_tax set recordstatus = 'DELETED' where bill_autonumber = '$res19anum' and companyanum = '$companyanum'";
			$query17 = "update proformainvoice_tax set recordstatus = 'DELETED' where billnumber = '$delbillnumber' and companyanum = '$companyanum'";
			$exec17 = mysql_query($query17) or die ("Error in Query17".mysql_error());
		}
	}
}

include ("proformainvoice1include1.php"); //handles all the proformainvoice insert operations
...
if ($delbillst == 'billedit' && $delbillnumber != '')
{
	$query41 = "select * from master_proformainvoice where billnumber = '$delbillnumber' and companyanum = '$companyanum' and recordstatus <> 'deleted'";
...
<script type="text/javascript" src="js/proformainvoicenovalidation1.js"></script>
...
function funcOnLoadBodyFunctionCall()
{
	...
	?>
		//quickprintbill1();
		quickprintbill1proformainvoice();
	<?php
	}
...
function funcDefaultTax1() //Function to CST Taxes if required.
{
	...
	if (varDefaultTax != "")
	{
		...
		{
		?>
		window.location="proformainvoice1.php?defaulttax="+varDefaultTax+"&&delbillst=<?php echo $delBillSt; ?>&&delbillautonumber="+<?php echo $delBillAutonumber; ?>+"&&delbillnumber="+<?php echo $delBillNumber; ?>+"";
		<?php
		}
		else
		{
		?>
		window.location="proformainvoice1.php?defaulttax="+varDefaultTax+"";
		<?php
		}
		?>
	}
	...
	{
		window.location="proformainvoice1.php";
	}
	//return false;
}
...
<form name="frmsales" id="frmsales" method="post" action="proformainvoice1.php" onKeyDown="return disableEnterKey(event)">
    ...
    <td width="99%" valign="top"><table width="950" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="100%"><table width="99%" border="0" align="left" cellpadding="2" cellspacing="0" bordercolor="#666666" id="AutoNumber3" style="border-collapse: collapse">
            <tbody>
              <tr bgcolor="#011E6A">
                <td bgcolor="#CCCCCC" class="bodytext3"><strong>Proforma </strong></td>
		...
		<table id="newtable" style="BORDER-COLLAPSE: collapse" 
            ...
            <tbody id="tblrowinsert">
              <tr>
				...
				include ('proformainvoice_edit1listing1.php');
		...
		<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
          ...
          <tbody id="foo">
            <tr>
			  ...
			  <input name="dummy1" id="dummy1" style="border: 0px solid #001E6A; background-color:#66CC00; text-align:right" value="" size="1" type="hidden" readonly="readonly" />
			  ...
			  <input onKeyDown="return itemcodekeypress1(event)" name="itemcode" id="itemcode" onFocus="javascript:this.select()" style="border: 1px solid #001E6A; text-align:left;text-transform: uppercase;" autocomplete="off" value="" size="10" /></td>
              ...
              <input onKeyDown="return itemquantitykeypress1(event)" onBlur="return itemtotalamountupdate1()" name="itemtaxpercent" onFocus="javascript:this.select()" value="0.00" id="itemtaxpercent" readonly="readonly" style="border: 1px solid #001E6A; text-align:right" size="2" />
...
-->
                ...
                bgcolor="#F3F3F3" class="bodytext31"><span class="bodytext311">
                    ...
                    <td width="41%"><span class="bodytext312">
...
bgcolor="#F3F3F3" class="bodytext31">&nbsp;</td>
				...
				<script language="javascript">
				function funcNetAmount1()
				{
					if (document.getElementById("billtype").value == 'PROFORMA')
					{
				...
				<select name="billtype" id="billtype" onChange="return funcNetAmount1()">
            ...
            <tr>
              ...
              <td width="46%" align="left" valign="top" ><div align="right"><span class="bodytext31">
                ...
                <!--<input name="print4inch2" type="button" class="button" id="print4inch2" style="border: 1px solid #001E6A" 
				  onClick="return quickprintbill1proformainvoice()" value="Print 40" accesskey="p"/>-->
				  ...
				  onClick="return quickprintbill2proformainvoice()" value="View 40" accesskey="p"/>-->

...
$query5 = "TRUNCATE TABLE purchaseorder_print_dump";
$exec5 = mysql_query($query5) or die ("Error in Query5".mysql_error());

$query3 = "select * from master_purchaseorder where billnumber = '$billnumber' and companyanum = '$companyanum' and recordstatus <> 'DELETED'";// and financialyear = '$financialyear'";
...
$query4 = "select * from purchaseorder_details where bill_autonumber = '$res3anum' and recordstatus <> 'DELETED' and companyanum = '$companyanum' order by auto_number";// and financialyear = '$financialyear'";
...
while ($res4 = mysql_fetch_array($exec4))
{
	...
	$query6 = "insert into purchaseorder_print_dump (serialnumber, bill_autonumber, companyanum, 
	...
	for ($i=0;$i<$itemdescriptionarraycount;$i++)
	{
		...
		//echo '<br><br>'.
		$query7 = "insert into purchaseorder_print_dump (bill_autonumber, companyanum, itemdescription, financialyear) 

  ...
  <tr>
    ...
    <tr>
	  ...
	  <table width="98%" border="0" cellspacing="0" cellpadding="0" class="sample">
        <tr>
          <td valign="top" width="64%"><table width="97%" border="0" align="left" cellpadding="0" cellspacing="0">
              <tr>
          ...
          <td width="36%" valign="top"><table width="97%" border="0" align="left" cellpadding="0" cellspacing="0">
              <tr>
                <td><?php
	...
	<table width="98%" border="1" align="left" cellpadding="0" cellspacing="0" frame="box" rules="groups" class="sample">
      ...
      <thead>
        <tr>
          ...
          <td width="20%"><div align="center">Reference&nbsp;</div></td>
        </tr>
		</thead>
		<?php
		$sno = "";
		...
		*/
		...
		$query9 = "select * from labtestsales_tax where  bill_autonumber = '$billautonumber' and itemanum = '$itemanum' and companyanum = '$companyanum' and financialyear = '$financialyear'";
        ...
        <td height="21" valign="top"><div align="left" class="style27">&nbsp;
          ...
          <div align="left"></div></td>
        <td valign="top"><div align="center"><span class="style27">&nbsp;<?php echo $resultvalue; ?>&nbsp;</span></div></td>
		<td valign="top"><div align="center"><span class="style27">&nbsp;<?php echo $testunit; ?>&nbsp;</span></div></td>
		...
		$query5 = "select * from master_saleslabtest where auto_number = '$res21anum' and recordstatus <> 'deleted' and financialyear = '$financialyear'";
		$exec5 = mysql_query($query5) or die ("Error in Query5".mysql_error());
		$res5 = mysql_fetch_array($exec5);

...
<table id="AutoNumber3" style="BORDER-COLLAPSE: collapse" 
  ...
  <tbody>
  <tr>
              <td colspan="26" align="left" valign="center" bordercolor="#f3f3f3" bgcolor="#ffffff" class="bodytext31"><div align="center"><strong>Hospital Invoice Report</strong></div></td>
            </tr>
            <tr>
              <td colspan="26" align="left" valign="center" bordercolor="#f3f3f3" bgcolor="#ffffff" class="bodytext31"><div align="center"><strong><?php echo $companyname; ?></strong>&nbsp;</div></td>
            </tr>
            <tr>
              <td colspan="26" align="left" valign="center" bordercolor="#f3f3f3" bgcolor="#ffffff" class="bodytext31"><div align="center"><strong><?php echo 'Report Date From '.$transactiondatefrom.' To '.$transactiondateto; ?></strong></div></td>
            </tr>
			<tr>
              ...
              <td  align="left" valign="center" 
                bgcolor="#ffffff" class="bodytext31"><strong> Patient ID </strong></td>
              <td class="bodytext31" valign="center"  align="left" 
              ...
              <td class="bodytext31" valign="center"  align="left" 
				...
				<td class="bodytext31" valign="center"  align="left" 
                bgcolor="#ffffff"><div align="left"><strong>Insurance</strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
              ...
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Disc%</strong></div></td>
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>DiscRs</strong></div></td>
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>SubTotal2</strong></div></td>
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><span class="bodytext31"><strong>Tax</strong></span></td>
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><span class="bodytext31"><strong>Packing Charge</strong></span></td>
              <td align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><span class="bodytext31"><strong>Delivery Charge</strong></span></td>
              <!--<td class="bodytext31" valign="center"  align="left" 
			  ...
			  <td width="16%" align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>Insurance Company</strong></div></td>
			  <td width="16%" align="left" valign="center"  
                bgcolor="#ffffff" class="bodytext31"><div align="left"><strong>TPA Name</strong></div></td>
              </tr>
			  <?php
			...
			if (isset($_REQUEST["financialyear"])) { $financialyear = $_REQUEST["financialyear"]; } else { $financialyear = ""; }
			//$financialyear = $_REQUEST['financialyear'];
			if (isset($_REQUEST["searchusername"])) { $searchusername = $_REQUEST["searchusername"]; } else { $searchusername = ""; }
			//$financialyear = $_REQUEST['financialyear'];
...
//			if ($financialyear == '') $financialyear = $_SESSION['financialyear'];
			...
			*/
			...
			//$query2 = "select * from master_saleshospital where customername like '%$customername%' and billnumber like '%$cbbillnumber%' and recordstatus = '$billstatus' and billtype like '%$paymenttype%' and companyanum = '$companyanum' and lastupdate between '$transactiondatefrom' and '$transactiondateto' order by lastupdate desc";
			$query2 = "select * from master_saleshospital where customername like '%$customername%' and billnumber like '%$cbbillnumber%' and 
			$billstatusquery1 and  billtype like '%$paymenttype%' and companyanum = '$companyanum' and financialyear like '%$financialyear%' and username like '%$searchusername%' and 
			...
			$query21 = "select sum(taxamount) as sumtaxamount from hospitalsales_tax where bill_autonumber = '$res2anum' and 
			...
			sum(creditamount) as sumcreditamount, sum(insuranceamount) as suminsuranceamount, sum(cardamount) as sumcardamount  
			from master_transactionhospital where billnumber = '$res2billnumber' and 
			...
			$suminsuranceamount = $res3['suminsuranceamount'];
            ...
            <tr <?php //echo $colorcode; ?>>
              ...
              <td class="bodytext31" valign="center"  align="left"><div align="left">
				...
				*/
				...
				//$totalsuminsuranceamount1  = $totalsuminsuranceamount1 + $suminsuranceamount;
			...
			?>
			  ...
			  <td class="bodytext31" valign="center"  align="left"><div align="right"> 
			  <?php echo $suminsuranceamount; ?>&nbsp;</div></td>
              <td class="bodytext31" valign="center"  align="left"><div align="right"> 
			  <?php echo $balancebillamount; ?>&nbsp;</div></td>
              <td class="bodytext31" valign="center"  align="left"><div align="right">
			  <?php echo $subtotal; ?>&nbsp;</div></td>
              <td class="bodytext31" valign="center"  align="left"><div align="right"> 
			  <?php echo $subtotaldiscountamountonlyapply2percent; ?>&nbsp;</div></td>
              <td class="bodytext31" valign="center"  align="left"><div align="right"> 
			  <?php echo $subtotaldiscountamountonlyapply1amount; ?>&nbsp;</div></td>
              <td class="bodytext31" valign="center"  align="left"><div align="right"> 
			  ...
			  if ($billstatus != 'DELETED')
			  {
			  if ($res2financialyear == $financialyear)
			  {
			  ...
			  ?>
              <?php echo $res2financialyear; //echo $approvalstatus; ?></div></td>
              <td class="bodytext31" valign="center"  align="left"> 
                <div align="center"><?php echo $res2username; //echo $approvalstatus; ?></div></td>
              
              <td  align="left" valign="center" class="bodytext31"><div align="center"><?php echo $remarks; ?></div></td>
              <td class="bodytext31" valign="center"  align="left"><div align="left"><?php echo $insurancecompany; ?></div></td>
			  <td class="bodytext31" valign="center"  align="left"><div align="left"><?php echo $tpaname; ?></div></td>
              </tr>
				<?php
				}
				?>
            <tr>
              ...
              <td class="bodytext31" valign="center"  align="left" 
                ><div align="right"><strong> <?php echo number_format($totalsumtotalamount1, 2, '.', '');; ?> </strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
                ><div align="right"><strong><?php echo number_format($totalsumcashamount1, 2, '.', '');; ?></strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
                ><div align="right"><strong><?php echo number_format($totalsumchequeamount1, 2, '.', '');; ?></strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
                ><div align="right"><strong><?php echo number_format($totalsumonlineamount1, 2, '.', '');; ?></strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
                ><div align="right"><strong><?php echo number_format($totalsumcardamount1, 2, '.', '');; ?></strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
                ><div align="right"><strong><?php echo number_format($totalsumcreditamount1, 2, '.', '');; ?></strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
                ><div align="right"><strong>
                <?php //echo number_format($totalsuminsuranceamount1, 2, '.', '');; ?>
              </strong></div></td>
				<td class="bodytext31" valign="center"  align="left" 
                ><div align="right"><strong><?php echo number_format($totalsumbalancebillamount1, 2, '.', '');; ?></strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
                ><div align="right"><strong><?php echo number_format($totalsumsubtotal1, 2, '.', '');; ?></strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
              ...
              <td class="bodytext31" valign="center"  align="left" 
                >&nbsp;</td>
              <td class="bodytext31" valign="center"  align="left" 
                ><strong><?php echo number_format($totalsumtotaltax1, 2, '.', '');; ?></strong></td>
              <td class="bodytext31" valign="center"  align="left" 
                ><div align="right"><strong><?php echo number_format($totalpackaging1, 2, '.', '');; ?></strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
                ><div align="right"><strong><?php echo number_format($totaldelivery1, 2, '.', '');; ?></strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
                ><div align="right"><strong><?php echo number_format($totalsumtotalamount1, 2, '.', '');; ?></strong></div></td>
              <td class="bodytext31" valign="center"  align="left" 
                ><div align="right"></div></td>
